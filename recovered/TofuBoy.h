// Recovered class model for `TofuBoy` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class TofuBoy : public MeatBoyCharactor {
public:
  virtual void ~TofuBoy();  // +0x10 @0x464ff0
  virtual void ~TofuBoy();  // +0x18 @0x465310
  ...
  virtual void Update();  // +0x50 @0x464f00
  ...
  void TofuBoy();  // @0x465a60
  void TofuBoy(MeatBoyCharactor*, int);  // @0x465aa0
};
