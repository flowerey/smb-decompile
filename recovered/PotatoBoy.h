// Recovered class model for `PotatoBoy` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class PotatoBoy : public MeatBoyCharactor {
public:
  virtual void ~PotatoBoy();  // +0x10 @0x464fe0
  virtual void ~PotatoBoy();  // +0x18 @0x4652d0
  ...
  virtual void Update();  // +0x50 @0x464ee0
  ...
  void PotatoBoy();  // @0x465b00
  void PotatoBoy(MeatBoyCharactor*, int);  // @0x465b40
};
