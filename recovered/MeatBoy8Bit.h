// Recovered class model for `MeatBoy8Bit` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class MeatBoy8Bit : public MeatBoyCharactor {
public:
  virtual void ~MeatBoy8Bit();  // +0x10 @0x465050
  virtual void ~MeatBoy8Bit();  // +0x18 @0x4652b0
  ...
  virtual void Update();  // +0x50 @0x464fc0
  ...
  void MeatBoy8Bit();  // @0x4656a0
  void MeatBoy8Bit(MeatBoyCharactor*, int);  // @0x4656e0
};
