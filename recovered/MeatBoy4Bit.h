// Recovered class model for `MeatBoy4Bit` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class MeatBoy4Bit : public MeatBoyCharactor {
public:
  virtual void ~MeatBoy4Bit();  // +0x10 @0x465040
  virtual void ~MeatBoy4Bit();  // +0x18 @0x465330
  ...
  virtual void Update();  // +0x50 @0x464fa0
  ...
  void MeatBoy4Bit();  // @0x465740
  void MeatBoy4Bit(MeatBoyCharactor*, int);  // @0x465780
};
