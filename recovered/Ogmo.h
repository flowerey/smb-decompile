// Recovered class model for `Ogmo` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xaa8 (factory)
#pragma once

class Ogmo : public MeatBoyCharactor {
public:
  virtual void ~Ogmo();  // +0x10 @0x4835a0
  virtual void ~Ogmo();  // +0x18 @0x483850
  ...
  virtual void RecordSpecial();  // +0x40 @0x483460
  virtual void ProcessSpecial();  // +0x48 @0x483600
  virtual void Update();  // +0x50 @0x483510
  virtual void Render();  // +0x58 @0x483690
  virtual void RenderClones();  // +0x60 @0x483710
  virtual void Initialize();  // +0x68 @0x473cd0  // via MeatBoyCharactor
  virtual void CreateClones();  // +0x70 @0x483570
  virtual void Reset();  // +0x78 @0x483500
  ...
  virtual void JumpPress(tagButtonProps const*, void*);  // +0x90 @0x483560
  ...
  virtual void Jump();  // +0xa8 @0x483640
  virtual void WallJump();  // +0xb0 @0x483530
  virtual bool CanJump();  // +0xb8 @0x483490
  ...
  virtual void WallHit(tagTileCollisionType);  // +0xd8 @0x483540
  virtual void GroundHit();  // +0xe0 @0x4834c0
  virtual void OffScreen();  // +0xe8 @0x473e80  // via MeatBoyCharactor
  virtual void Death();  // +0xf0 @0x4834e0
  virtual uint64_t CanDie();  // +0xf8 @0x473e50  // via MeatBoyCharactor
  // ---- non-virtual / static (from symtab) ----
  void Ogmo();  // @0x4838b0
  void Ogmo(MeatBoyCharactor*, int);  // @0x483910
};
