// Recovered class model for `BandageGirl` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class BandageGirl : public MeatBoyCharactor {
public:
  virtual void ~BandageGirl();  // +0x10 @0x465020
  virtual void ~BandageGirl();  // +0x18 @0x465370
  ...
  virtual void Update();  // +0x50 @0x464f60
  ...
  void BandageGirl();  // @0x465880
  void BandageGirl(MeatBoyCharactor*, int);  // @0x4658c0
};
