// Recovered class model for `MeatBoy4Color` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class MeatBoy4Color : public MeatBoyCharactor {
public:
  virtual void ~MeatBoy4Color();  // +0x10 @0x465030
  virtual void ~MeatBoy4Color();  // +0x18 @0x465350
  ...
  virtual void Update();  // +0x50 @0x464f80
  ...
  void MeatBoy4Color();  // @0x4657e0
  void MeatBoy4Color(MeatBoyCharactor*, int);  // @0x465820
};
