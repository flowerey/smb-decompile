// Recovered class model for `Brownie` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xa98 (factory)
#pragma once

class Brownie : public MeatBoyCharactor {
public:
  virtual void ~Brownie();  // +0x10 @0x465010
  virtual void ~Brownie();  // +0x18 @0x465390
  ...
  virtual void Update();  // +0x50 @0x464f40
  ...
  void Brownie();  // @0x465920
  void Brownie(MeatBoyCharactor*, int);  // @0x465960
};
