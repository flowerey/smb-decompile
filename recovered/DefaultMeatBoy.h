// Recovered class model for `DefaultMeatBoy` — from RTTI + vtable + symtab. NOT compiled.
// kind=si
#pragma once

class DefaultMeatBoy : public MeatBoyCharactor {
public:
  virtual void ~DefaultMeatBoy();  // +0x10 @0x4651c0
  virtual void ~DefaultMeatBoy();  // +0x18 @0x465430
  ...
  virtual void Update();  // +0x50 @0x4650c0
  virtual void Render();  // +0x58 @0x465120
  ...
  virtual void Death();  // +0xf0 @0x465270
  virtual uint64_t CanDie();  // +0xf8 @0x473e50  // via MeatBoyCharactor
  // ---- non-virtual / static (from symtab) ----
  void DefaultMeatBoy();  // @0x4654a0
  void DefaultMeatBoy(MeatBoyCharactor*, int);  // @0x465540
};
