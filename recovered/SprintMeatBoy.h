// Recovered class model for `SprintMeatBoy` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xaa0 (factory)
#pragma once

class SprintMeatBoy : public MeatBoyCharactor {
public:
  virtual void ~SprintMeatBoy();  // +0x10 @0x465150
  virtual void ~SprintMeatBoy();  // +0x18 @0x4653b0
  ...
  virtual void Update();  // +0x50 @0x465060
  virtual void Render();  // +0x58 @0x4650f0
  ...
  virtual void Death();  // +0xf0 @0x465230
  virtual uint64_t CanDie();  // +0xf8 @0x473e50  // via MeatBoyCharactor
  // ---- non-virtual / static (from symtab) ----
  void SprintMeatBoy();  // @0x4655a0
  void SprintMeatBoy(MeatBoyCharactor*, int);  // @0x465640
};
