// Recovered class model for `Naija` — from RTTI + vtable + symtab. NOT compiled.
// kind=si size=0xae0 (factory)
#pragma once

class Naija : public MeatBoyCharactor {
public:
  virtual void ~Naija();  // +0x10 @0x482ee0
  virtual void ~Naija();  // +0x18 @0x483180
  ...
  virtual void Update();  // +0x50 @0x482c20
  virtual void Render();  // +0x58 @0x483000
  virtual void RenderClones();  // +0x60 @0x4830c0
  virtual void Initialize();  // +0x68 @0x473cd0  // via MeatBoyCharactor
  virtual void CreateClones();  // +0x70 @0x482e90
  virtual void Reset();  // +0x78 @0x482ac0
  virtual void ForceAppear();  // +0x80 @0x474600  // via MeatBoyCharactor
  virtual void SpecialPress(tagButtonProps const*, void*);  // +0x88 @0x482f40
  virtual void JumpPress(tagButtonProps const*, void*);  // +0x90 @0x482e80
  ...
  virtual void Jump();  // +0xa8 @0x482bf0
  virtual void WallJump();  // +0xb0 @0x482e60
  virtual bool CanJump();  // +0xb8 @0x482c10
  ...
  virtual void WallHit(tagTileCollisionType);  // +0xd8 @0x482e70
  virtual void GroundHit();  // +0xe0 @0x482c00
  virtual void OffScreen();  // +0xe8 @0x473e80  // via MeatBoyCharactor
  virtual void Death();  // +0xf0 @0x482b50
  virtual uint64_t CanDie();  // +0xf8 @0x473e50  // via MeatBoyCharactor
  // ---- non-virtual / static (from symtab) ----
  void Naija();  // @0x4831e0
  void Naija(MeatBoyCharactor*, int);  // @0x483350
};
