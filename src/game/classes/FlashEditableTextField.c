...
void __thiscall
FlashEditableTextField__FlashEditableTextField__00571b20(FlashEditableTextField *self)
...
void __thiscall FlashEditableTextField__Render(FlashEditableTextField *self, float arg1,
                                               ColorTemplate *arg2, ColorTemplate *arg3,
...

{
  ...
  if (*(int *)(self + 0x48) != 0) {
    ...
    FlashTimeline__Render(arg1, (ColorTemplate *)(self + 0x18), arg2, (FlashLibraryInstance *)arg3);
...
void __thiscall
FlashEditableTextField__FlashEditableTextField__00576550(FlashEditableTextField *self)
