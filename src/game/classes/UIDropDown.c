...

{
  ...
  local_68 = 0;
  local_64 = (*(float *)(*(long *)(self + 0x58) + 0x2c) - *(float *)(self + 0x2c)) * DAT_005be6e4 /* R:0.5f */;
...

{
  ...
  *(UIButton **)(self + lVar1 + 0x68) = this_00;
  ...
  local_48 = 0.0;
  local_44 = DAT_005dd9f0 /* R:-2.0f */ * _DEFAULT_UI_FONT_SIZE * (float)(*(int *)(self + 0x51c) + -1);
  (**(code **)(**(long **)(self + lVar1 + 0x68) + 0x58))(*(long **)(self + lVar1 + 0x68),local_58);
  local_48 = DAT_005be6e4 /* R:0.5f */ * local_50 + local_48;
  Vector2__operator_assign((Vector2 *)(*(long *)(self + lVar1 + 0x68) + 0x20),(Vector2 *)&local_48);
  ...
  *(code **)(*(long *)(self + lVar1 + 0x68) + 0x40) = UIDROPDOWN_MakeSelection;
  UIForm__AddFormElement
            (*(UIForm **)(*(long *)(self + 0x58) + 0x40),*(UIFormElement **)(self + lVar1 + 0x68));
  if (*(int *)(self + 0x51c) == 1) {
    *(UIDropDown **)(self + 0x528) = self + 0x68;
    UILabel__setText(*(UILabel **)(self + 0x60),
                       *(wchar_t **)
                        (*(long *)(*(long *)(*(long *)(self + 0x68) + 0x50) + 0x40) + 0x28));
  }
  return;
}
...

{
  *(UIDropDown **)(self + 0x528) = self + (long)arg1 * 0x18 + 0x68;
  UILabel__setText(*(UILabel **)(self + 0x60),
                     *(wchar_t **)
                      (*(long *)(*(long *)(*(long *)(self + (long)arg1 * 0x18 + 0x68) + 0x50) +
                                0x40) + 0x28));
  return;
}
