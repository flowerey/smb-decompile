...

{
  ...
  if ((*(int *)(self + 0xa40) == 0) && (((byte)self[0x7d9] & 1) != 0)) {
    uStack_50 =
        (Runman *)(CONCAT17((char)SMBCurrLevelData._4_4_, (uint7) * (uint *)(SMBHUD + 0x418)) &
                   0x1ffffffffffffff);
    ...
    uStack_50 =
        (Runman *)CONCAT35(CONCAT21(uStack_50._6_2_, (char)*(uint32_t *)(self + 0x7f8) + '\x01'),
