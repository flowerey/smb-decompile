...

{
  ...
  *(uint64_t *)(self + 0x88) = 0;
  ...
  TResourceCreator__RemoveResourceCreationFunction((TResourceCreator *)ResourceCreator,
                                                   ResetSMBGraphicsDependentFactors, (void *)0x0);
...

{
  ...
  if (pLevelPalette == (SMBPalette *)0x0) {
    ...
    if (iVar1 == 1) {
      BaseResource__Release((BaseResource *)pLevelPalette, 0);
    LAB_00515035:
      pLevelPalette = (SMBPalette *)SMBPaletteBackgroundLoader__GetPalette(
          (SMBPaletteBackgroundLoader *)(self + 0x3b0));
  ...
  *(TileLevel **)(self + 0x40) = arg1;
  ...
  if (arg1 == (TileLevel *)0x0) {
    ...
    *(uint64_t *)(*(long *)(self + 0x40) + 0x48) = *(uint64_t *)(self + 0x38);
    ...
    TileLevel__AddLevelLayers(*(TileLevel **)(self + 0x40), *(RenderLayer **)(self + 0x88),
    ...
    RenderLayer__InsertObjectBefore(pRVar4, (RenderLayerObject *)(self + 0x50),
                                    *(RenderLayerObject **)(pRVar4 + 8));
    ...
    TileLevelLightMap__GenerateFacesFromLevel(*(TileLevelLightMap **)(self + 0x390),
                                              *(TileLevel **)(self + 0x40));
...
joined_r0x00516386:
  if (uVar1 < 0xe) {
    ...
    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_005c9200 /* R:7.474795058013725e-39f */ +
                 (ulong) * (uint *)(self + 0x2c) * 8))();
    return;
  }
  switch (arg2) {
  case 0:
...

{
  ...
  if ((bProcessProfileSignOut == 1) &&
    ...
    if (bJustPurchased < 2) {
      ...
      if ((iVar2 == 2) || (iVar2 == 0)) {
        ...
        *(uint64_t *)(self + 0x40) = 0;
        SetTilePalette((char *)self);
        GSMBCharactor__DestroyCharactor__0049cbf0(SMBCharactor,
                                                  *(MeatBoyCharactor **)(self + 0x48));
        TileLevelLightMap__DestroyLightsAndMaps(*(TileLevelLightMap **)(self + 0x390));
        *(uint64_t *)(self + 0x48) = 0;
        iVar2 = *(int *)(self + 0x2c);
      }
  ...
  if (iVar2 != 8) {
    ...
    if (((1 < iVar2 - 9U) && (iVar2 != 0xc)) && (iVar2 != 0xd))
      goto LAB_005169c2;
    GSMBMenu__Update(SMBMenu);
  }
  GMeatHUD__Update(SMBHUD);
...

{
  ...
  Joystick__BackupCallbacks(this_00, (InputCallback **)&pPrePauseButtonCallbacks,
                            (InputCallback **)&pPrePausePOVCallbacks);
  if (Keyboard != (TKeyboard *)0x0) {
