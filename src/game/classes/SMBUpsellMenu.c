...

{
  ...
  *(FlashAnimationLibrary **)(self + 8) = pFVar4;
  ...
  uVar5 =
      FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8), "in");
  *(uint64_t *)(self + 0x58) = uVar5;
  uVar5 =
      FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8), "out");
  *(uint64_t *)(self + 0x60) = uVar5;
  uVar5 =
      FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8), "idle");
  ...
  *(FlashAnimationLibrary **)(self + 0x98) = pFVar4;
  ...
  uVar5 =
      FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 0x98), 0);
...

{
  ...
  if (*(short *)(self + 0xb0) == 0) {
    ...
    pwVar3 = (wchar_t *)FlashAnimationLibrary__GetTextField(*(FlashAnimationLibrary **)(self + 8),
                                                            "trial");
  ...
  pwVar3 =
      (wchar_t *)FlashAnimationLibrary__GetTextField(*(FlashAnimationLibrary **)(self + 8), "pop2");
  if (pwVar3 != (wchar_t *)0x0) {
    FlashTextField__SetText(pwVar3, uVar2);
  }
