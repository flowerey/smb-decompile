...

{
  ...
  *(uint64_t *)(self + 0x2a8) = 0;
  ...
  TResourceCreator__AddResourceCreationFunction
            ((TResourceCreator *)ResourceCreator,CreateTileLightMapResources,self);
  TResourceCreator__AddResourceDestroyFunction
            ((TResourceCreator *)ResourceCreator,DestroyTileLightMapResources,self);
  return;
}
...
TileLevelLightMap * __thiscall
TileLevelLightMap__CreateLight(TileLevelLightMap *self,Light *arg1)
...
void __thiscall
TileLevelLightMap__GenerateFacesFromLevel(TileLevelLightMap *self,TileLevel *arg1)
...
void __thiscall
TileLevelLightMap__GenerateShadowMap
          (TileLevelLightMap *self,Light *arg1,tagPos2ColorVertex *arg2,int *arg3)
          ...
          if (iVar5 != 0) {
            ...
            if (((byte)pSVar6[2] & 0xc) == 0) {
              ...
              if ((uVar10 & 2) != 0) {
                ...
                iVar5 = ExtendFaceFromLight((LightFace2D *)local_a88,(Vector2 *)local_a58,local_48,
                                            arg2);
              ...
              fVar11 = DAT_005be6e4 /* R:0.5f */ * (float)((uint)fVar13 ^ DAT_005be6f0 /* R:u32=2147483648 */);
              fVar13 = fVar11;
              if ((uVar10 & 8) == 0) {
LAB_004700b5:
                fVar2 = fVar13;
              ...
              *(uint32_t *)(arg2 + lVar7 * 0xc + 4) = local_844;
              ...
              local_acc = (float)((uint)TileLevel__fLevelGridWH ^ DAT_005be6f0 /* R:u32=2147483648 */) * DAT_005be6e4 /* R:0.5f */;
              local_aa8 = local_ab4;
              local_aa4 = local_ab4;
              local_aa0 = local_acc;
              if (iVar5 == 2) {
                ...
                if (iVar5 == 3) {
                  ...
                  local_aa8 = 0.0;
                  local_824 = (float)((uint)(local_ab4 * DAT_005be6e4 /* R:0.5f */) ^ DAT_005be6f0 /* R:u32=2147483648 */);
              ...
              *(uint32_t *)(arg2 + lVar7 * 0xc + 4) = local_5a4;
              ...
              if ((GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::vTriNorm == '\0')
                 && (iVar5 = __cxa_guard_acquire(&GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)
                                                  ::vTriNorm), iVar5 != 0)) {
                GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::vTriNorm = 0x3f3504f3
                ;
                DAT_00818f1c /* R:1.2856983475103413e-39f */ = 0x3f3504f3;
                __cxa_guard_release(&GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                                     vTriNorm);
                __cxa_atexit(Vector2__Vector2,
                             &GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                              vTriNorm,&__dso_handle);
              }
              uVar12 = DAT_005be6f0 /* R:u32=2147483648 */;
              iVar5 = (int)(uint)(uVar1 >> 6) >> 8;
              fVar13 = TileLevel__fLevelGridWH * DAT_005be6e4 /* R:0.5f */;
              local_ac8 = ZEXT416(DAT_005be6f0 /* R:u32=2147483648 */);
              local_acc = DAT_005be6e4 /* R:0.5f */ * (float)((uint)TileLevel__fLevelGridWH ^ DAT_005be6f0 /* R:u32=2147483648 */);
              local_aa8 = fVar13;
              local_aa0 = local_acc;
              if (iVar5 == 1) {
                local_aa4 = fVar13;
                if ((uVar10 & 10) != 0) {
                  ...
                  local_548 = GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                              vTriNorm ^ uVar12;
                ...
                *(uint32_t *)(arg2 + lVar7 * 0xc + 4) = local_444;
                ...
                if ((uVar10 & 6) != 0) {
                  ...
                  local_3f8 = GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                              vTriNorm;
                ...
                *(uint32_t *)(arg2 + lVar7 * 0xc + 4) = local_2f4;
                ...
                if ((uVar10 & 9) != 0) {
                  ...
                  local_2a8 = GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                              vTriNorm ^ uVar12;
                ...
                *(uint32_t *)(arg2 + lVar7 * 0xc + 4) = local_1a4;
                ...
                if ((uVar10 & 5) != 0) {
                  ...
                  local_158 = GenerateShadowMap(Light_const*,CGR__tagPos2ColorVertex,int&)::
                              vTriNorm;
...

{
  ...
  uVar2 = (uint)*(ushort *)(*(long *)(self + 0x288) + 0x38) *
          (uint)*(ushort *)(*(long *)(self + 0x288) + 0x3a) * 0x120;
  *(uint *)(self + 0x290) = uVar2;
  if (*(long *)(self + 0x30) != 0) {
    pVVar1 = *(VertexBuffer **)(*(long *)(self + 0x30) + 0x20);
    if (*(ulong *)(pVVar1 + 0x10) < (ulong)uVar2) {
...
LAB_00472e20:
    ...
    Matrix4x4__Transformation3D
              (pMVar3,(FPUVector *)&local_68,(TQuaternion *)0x0,(FPUVector *)&local_58);
    ...
    if (*(int *)(pLVar4 + 0x28) != 0) {
      *(float *)(pLVar4 + 0x24) = DAT_005c01d0 /* R:0.0010000000474974513f */ + *(float *)(pLVar4 + 0x24);
    }
    local_48 = *(uint32_t *)(pLVar4 + 0x20);
    local_44 = local_48;
    pMVar3 = (Matrix4x4 *)TGraphics__GetMatrix(Graphics,0);
    Matrix4x4__Transformation2DRot
              (pMVar3,(Vector2 *)&local_48,(float *)(pLVar4 + 0x24),(Vector2 *)pLVar4);
