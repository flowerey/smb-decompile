...
void __thiscall MeatBoyCharFoundation__Initialize(MeatBoyCharFoundation *self,
                                                  MeatBoyCharFoundationCreate *arg1)

{
  ...
  *(FlashAnimationLibrary **)self = this_00;
  ...
  do {
    ...
    if (__s != (char *)0x0) {
      ...
      if (lVar7 == 0) {
        ...
        if (*(int *)(self + lVar2 + 0x50) == -0x5eef3582) {
          ...
          *(uint32_t *)(self + lVar2 + 0x38) = 0;
          ...
          if (pvVar8 != (void *)0x0) {
            puVar15 = (uint64_t *)((uVar10 - ((long)pvVar8 + 0x10U) % uVar10) % uVar10 +
                                   (long)pvVar8 + 0x10U);
            puVar15[-2] = 0x28;
            puVar15[-1] = pvVar8;
          }
      ...
      LAB_0047539f:
        if ((*(int *)(self + lVar2 + 0x38) == 1) && (*(short *)(self + lVar2 + 0x32) != 0)) {
          ...
          while (uVar14 != 0xffff) {
            puVar11 = puVar11 + 1;
            if (sVar6 == *(short *)(self + lVar2 + 0x32))
              goto LAB_004753ab;
            sVar6 = sVar6 + 1;
            uVar14 = *puVar11;
          }
      ...
      LAB_004753ab:
        ...
        *(short *)(self + lVar2 + 0x30) = *(short *)(self + lVar2 + 0x30) + 1;
        ...
        while (true) {
          ...
          lVar7 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)self,
                                                                (char *)local_c8);
          if (lVar7 == 0)
            break;
          if (*(int *)(self + lVar2 + 0x50) == -0x5eef3582) {
            uVar5 = *(ushort *)(self + lVar2 + 0x30);
            if (uVar5 < *(ushort *)(self + lVar2 + 0x32))
              goto LAB_004754b1;
            uVar5 = *(ushort *)(self + lVar2 + 0x32) + *(short *)(self + lVar2 + 0x3c);
            uVar13 = (ulong)(byte)self[lVar2 + 0x34];
            pvVar12 = *(void **)(self + lVar2 + 0x40);
            ...
            *(uint32_t *)(self + lVar2 + 0x38) = 0;
            ...
            puVar15 = (uint64_t *)0x0;
            if (pvVar8 != (void *)0x0) {
              puVar15 = (uint64_t *)((long)pvVar8 + 0x10U +
    ...
    lVar16 = lVar16 + 1;
    if (lVar16 == 0x18) {
      lVar16 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)self,
                                                             "land splat");
      ...
      *(long *)(self + 0x878) = lVar16;
      ...
      lVar16 =
          FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)self, "splat");
...
void __thiscall MeatBoyCharFoundation__Render(MeatBoyCharFoundation *self, MeatBoyCharactor *arg1,
...

{
  ...
  if (arg2 == (FlashLibraryInstance *)0x0) {
    ...
    if (*(uint *)(arg1 + 0xa4c) == 0xffffffff) {
      this_00 = *(FlashLibraryInstance **)(*(long *)(self + lVar2 + 0x40) +
                                           (ulong) * (ushort *)(self + lVar2 + 0x58) * 8);
    } else {
      this_00 = *(FlashLibraryInstance **)(*(long *)(self + lVar2 + 0x40) +
                                           (ulong)(*(uint *)(arg1 + 0xa4c) & 0xffff) * 8);
    }
    bVar3 = true;
    bVar4 = true;
  ...
  if (((((byte)arg1[0x7d9] & 2) == 0) || (iVar5 == 0x15)) || (iVar5 == 0x14)) {
    *(uint32_t *)(arg1 + 0xd8) = 0;
    Vector2__operator_mul_assign__005be220((Vector2 *)&local_58,
                                           (Vector2 *)(arg1 + (long)iVar5 * 8 + 0x8d4));
  } else if ((*(ushort *)(arg1 + 0x7da) & 0x7ff) == 0) {
    Matrix4x4__ConvertToRotationMatrix(local_98, DAT_005c07ac /* R:0.7853981852531433f */);
    Matrix4x4__TransformVector2((Vector2 *)&local_58,
                                (Vector2 *)(arg1 + (long)*(int *)(arg1 + 0x7d4) * 8 + 0x8d4),
                                local_98, 1);
