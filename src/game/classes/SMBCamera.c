...

{
  ...
  if ((iVar3 != 1) || (iVar16 != 0)) {
    if (iVar16 == 3) {
      ...
      local_58 = CONCAT44(_DAT_005c0074 /* R:30.0f */ + local_58._4_4_,(int)*(uint64_t *)(lVar18 + 0xa0));
...
LAB_0048e980:
      if (pfVar17 != (float *)0x0) goto LAB_0048e2ac;
      local_134 = 0.0;
      local_138 = 0.0;
      local_148 = 0.0;
      local_144 = 0.0;
...
LAB_0048e2ac:
  ...
  if (fVar23 + fVar23 <=
      (float)((uint)(*(float *)(lVar18 + 0x22bc) - *(float *)(lVar18 + 0x22b4)) & DAT_005be880 /* R:u32=2147483647 */)) {
    ...
    fVar19 = (float)((uint)(fVar19 - fVar21) & DAT_005be880 /* R:u32=2147483647 */) * DAT_005be6e4 /* R:0.5f */ + fVar21;
  }
  if (fVar22 + fVar22 <=
      (float)((uint)(*(float *)(lVar18 + 0x22c0) - *(float *)(lVar18 + 0x22b8)) & DAT_005be880 /* R:u32=2147483647 */)) {
    ...
    fVar21 = (float)((uint)(fVar1 - fVar2) & DAT_005be880 /* R:u32=2147483647 */) * DAT_005be6e4 /* R:0.5f */ + fVar2;
  }
...

{
  ...
  AutoLockSection__AutoLockSection(aAStack_28,(CriticalSection *)cameraUpdateSection);
  if (arg1 == (SMBCameraWayPoint *)0x0) goto LAB_0048ecd0;
  if (*(long *)(arg1 + 0x18) == 0) {
    *(uint64_t *)(self + 0x1188) = *(uint64_t *)(arg1 + 0x20);
    lVar1 = *(long *)(arg1 + 0x20);
    if (lVar1 == 0) goto LAB_0048ecf8;
LAB_0048ecb8:
