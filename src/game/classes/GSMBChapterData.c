  ...
  if (iVar4 == 0) {
    ...
    *puVar5 = uVar1;
    ...
    if (arg1 == 1) {
      ...
      local_30 = puVar5;
      hSMBChapterSaveHandle =
          (THREADHANDLESTRUCT *)CreateWorkerThread((tagThreadCreate *)&local_38);
      if (hSMBChapterSaveHandle == (THREADHANDLESTRUCT *)0x0) {
...
uint64_t __thiscall GSMBChapterData__GetLevelDataByID(GSMBChapterData *self, int arg1,
                                                      SMBLevelData **arg2)
      ...
      if (*(short *)(lVar10 + 0x90) != 0) {
        ...
        while (true) {
          ...
          *(GSMBChapterData **)(lVar11 + uVar7 * 8) =
          ...
          lVar10 = lVar12 + *(long *)(lVar1 + 0x278);
          if ((int)(uint) * (ushort *)(lVar10 + 0x90) <= (int)uVar6)
            break;
          lVar11 = *(long *)(self + 0x38);
...

{
  ...
  fVar6 = (float)(int)((((((((((((((((uint)(byte)self[0x1cfc] + (uint)(byte)self[0x1cfd] +
                           ...
                           (uint)(byte)self[0x1d3b] + (uint)(byte)self[0x1d3a]) -
                          (uint)((uVar1 & 4) == 0)) -
                         (uint)((uVar1 & 8) == 0)) +
                        (uint)(byte)self[0x1d44] + (uint)(byte)self[0x1d45] +
                        (uint)(byte)self[0x1d47] + (uint)(byte)self[0x1d46] + 8) -
                       (uint)((*(ushort *)(self + 0x1d48) & 4) == 0)) *
  ...
  if (0x19 < (int)(((((((uVar2 - ((*(ushort *)(self + 0x1d18) & 0x20) == 0)) -
                      ...
                      (uint)((uVar1 & 0x20) == 0)) +
                     5) -
                    (uint)((*(ushort *)(self + 0x1d48) & 0x20) == 0)) +
                   (int)lVar4)) {
...

{
  ...
  fVar1 =
      (float)(byte)self[(long)arg2 * 0xc + 0x1cf1] + (float)(byte)self[(long)arg2 * 0xc + 0x1cf0] +
      (float)(byte)self[(long)arg2 * 0xc + 0x1cf2] + (float)(byte)self[(long)arg2 * 0xc + 0x1cf3];
...

{
  ...
  *(ushort *)(self + (long)arg2 * 0xc + 0x1cf4) = *(ushort *)(self + (long)arg2 * 0xc + 0x1cf4) | 4;
  return;
}
...
{
  GSMBMenu__ShowBossDefeat();
  *(ushort *)(self + (long)arg2 * 0xc + 0x1cf4) = *(ushort *)(self + (long)arg2 * 0xc + 0x1cf4) | 8;
  return;
}
...
void __thiscall GSMBChapterData__CalculateOverallScore(GSMBChapterData *self, uint *arg1,
                                                       uint *arg2, uint *arg3)
...
void __thiscall GSMBChapterData__CalculateInternetsScore(GSMBChapterData *self, uint *arg1,
                                                         uint *arg2, uint *arg3)
...
void __thiscall GSMBChapterData__GetBossTileNumbers(GSMBChapterData *self, int *arg1, int *arg2,
                                                    int arg3)
...

{
  ...
  fVar6 = (float)(int)((((((((((((((((uint)(byte)self[0x1cfd] + (uint)(byte)self[0x1cfc] +
                         ...
                         (uint)((uVar1 & 8) == 0)) +
                        (uint)(byte)self[0x1d44] + (uint)(byte)self[0x1d45] +
                        (uint)(byte)self[0x1d47] + (uint)(byte)self[0x1d46]) -
                       (uint)((*(ushort *)(self + 0x1d48) & 4) == 0)) *
          _DAT_005c2068 /* R:0.23980815708637238f */;
  uVar2 = (ulong)fVar6;
...

{
  ...
  iVar2 = (uint)(byte)self[0x1d45] + (uint)(byte)self[0x1cf1] + (uint)(byte)self[0x1cfd] +
          (uint)(byte)self[0x1d09] + (uint)(byte)self[0x1d15] + (uint)(byte)self[0x1d21] +
          (uint)(byte)self[0x1d2d] + (uint)(byte)self[0x1d39];
  lVar1 = 0;
  if (iVar2 != 0) {
...

{
  ...
  iVar2 = (uint)(byte)self[0x1d44] + (uint)(byte)self[0x1cf0] + (uint)(byte)self[0x1cfc] +
          (uint)(byte)self[0x1d08] + (uint)(byte)self[0x1d14] + (uint)(byte)self[0x1d20] +
          (uint)(byte)self[0x1d2c] + (uint)(byte)self[0x1d38];
  lVar1 = 0;
  if (iVar2 != 0) {
    fVar3 = (float)iVar2 * _DAT_005c207c /* R:0.800000011920929f */;
    lVar1 = (long)fVar3;
...
void __thiscall GSMBChapterData__ChapterAchievementCheck(GSMBChapterData *self, SMBLevelData *arg1)

{
  ...
  if (iVar6 == ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes) {
    ...
    iVar7 = 4;
    if (iVar6 != DAT_00815ed0 /* R:7.006492321624085e-45f */)
      goto LAB_00498105;
  }
  lVar4 = (long)iVar7;
  fVar9 = 0.0;
...
LAB_00498105:
  ...
  uVar2 = (uint)(byte)self[0x1d53] + (uint)(byte)self[0x1cf3] + (uint)(byte)self[0x1cff] +
          (uint)(byte)self[0x1d0b] + (uint)(byte)self[0x1d17] + (uint)(byte)self[0x1d23] +
          (uint)(byte)self[0x1d2f] + (uint)(byte)self[0x1d3b] + (uint)(byte)self[0x1d47] +
          (uint)(byte)self[0x1d5f];
  if (uVar2 == 0xf) {
    local_24 = 0xf;
  } else if (uVar2 == 0x1e) {
    local_24 = 0x10;
...

{
  ...
  if ((iVar4 == 1) &&
    ...
    if ((iVar4 == 0) &&
        ((iVar4 = System_IsTrialMode(),
          iVar4 == 0 && (pFVar8 = fopen(local_98[0], "rb"), pFVar8 != (FILE *)0x0)))) {
      fseek(pFVar8, 0, 2);
      uVar9 = ftell(pFVar8);
      fseek(pFVar8, 0, 0);
  ...
  if ((((iVar4 == 1) &&
        (lVar7 = TPlayer__GetProfile((TPlayer *)Players__Player), *(int *)(lVar7 + 0xc) == 1)) &&
       (iVar4 = access(local_98[0], 0), iVar4 == -1)) &&
  ...
  if ((iVar4 == 1) &&
      ...
      *(uint *)(self + 0x1d6c) = *(uint *)(self + 0x1d6c) | 0x101;
      ...
      do {
        ...
        LAB_00499c3c:
          ...
          if (fVar22 <= 0.0)
            goto LAB_00499ee8;
          if (DAT_005c17f0 /* R:100000000.0f */ <= fVar22)
            goto LAB_00499ee8;
      ...
      LAB_0049a7ca:
        ...
        if ((float)(&DAT_00815e8c /* R:245.0f */)[lVar7 * 5] <= fVar22)
          goto LAB_0049a0d0;
        local_c4 = (&DAT_00815e90 /* R:5.74532370373175e-44f */)[lVar7 * 5];
        local_c8 = 1;
        pUVar12 = (UserProfile *)TPlayer__GetProfile((TPlayer *)Players__Player);
        Achievements__AwardAchievement(pUVar12, (AchievementAward *)&local_c8);
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes != 2)
          goto LAB_0049a0dd;
      LAB_0049a84c:
        iVar4 = 0;
      LAB_0049a430:
        ...
        pUVar12 = (UserProfile *)TPlayer__GetProfile((TPlayer *)Players__Player);
        Achievements__AwardAchievement(pUVar12, (AchievementAward *)&local_c8);
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes == 3)
          goto LAB_0049a4ac;
      LAB_0049a123:
        ...
        iVar4 = 4;
        if (DAT_00815ed0 /* R:7.006492321624085e-45f */ == 3)
          goto LAB_0049a4ae;
      LAB_0049a15c:
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes == 4)
          goto LAB_0049a52c;
      LAB_0049a169:
        ...
        iVar4 = 4;
        if (DAT_00815ed0 /* R:7.006492321624085e-45f */ == 4)
          goto LAB_0049a52e;
      LAB_0049a1a2:
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes == 5)
          goto LAB_0049a5ac;
      LAB_0049a1af:
        ...
        iVar4 = 4;
        if (DAT_00815ed0 /* R:7.006492321624085e-45f */ == 5)
          goto LAB_0049a5ae;
      LAB_0049a1e8:
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes == 7)
          goto LAB_0049a62c;
      LAB_0049a1f5:
        if (DAT_00815e94 /* R:2.802596928649634e-45f */ == 7) {
          ...
          iVar4 = 4;
          if (DAT_00815ed0 /* R:7.006492321624085e-45f */ != 7)
            goto LAB_0049a22e;
        }
      } else {
        ...
        iVar4 = 4;
        if (DAT_00815ed0 /* R:7.006492321624085e-45f */ == 1)
          goto LAB_0049a7ca;
      LAB_0049a0d0:
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes == 2)
          goto LAB_0049a84c;
      LAB_0049a0dd:
        ...
        iVar4 = 4;
        if (DAT_00815ed0 /* R:7.006492321624085e-45f */ == 2)
          goto LAB_0049a430;
      LAB_0049a116:
        if (ChapterLowestAchievementTime(tagChapterName)::pLowAchTimes != 3)
          goto LAB_0049a123;
    ...
    LAB_0049a22e:
      ...
      pGVar18 = self;
      do {
        iVar4 = ((uint)(byte)pGVar18[0x1cfe] + (uint)(byte)pGVar18[0x1cfd] + iVar4 +
                 (uint)(byte)pGVar18[0x1cfc] + (uint)(byte)pGVar18[0x1cff] + 1) -
                (uint)((*(ushort *)(pGVar18 + 0x1d00) & 4) == 0);
        if (iVar16 == 7) {
      ...
      do {
        if (*(int *)(self + 0x48) == -0x5eef3582) {
          ...
          *(uint32_t *)(self + 0x30) = 0;
          ...
          if (pvVar7 != (void *)0x0) {
            puVar19 = (uint64_t *)((long)pvVar7 + 0x10U +
                                   (uVar9 - ((long)pvVar7 + 0x10U) % uVar9) % uVar9);
            puVar19[-2] = 0x28;
            puVar19[-1] = pvVar7;
          }
  ...
  if ((fVar15 < DAT_005c17f0 /* R:100000000.0f */) && (((byte)pSVar11[4] & 2) == 0)) {
    if (uVar5 == 1) {
      if (*(int *)(self + 0x1ce0) == 6) {
        ...
        if ((0x54 < (uint)(byte)self[0x1d45] + (uint)(byte)self[0x1d21] + (uint)(byte)self[0x1d15] +
                        (uint)(byte)self[0x1cfd] + (uint)(byte)self[0x1cf1] +
                        (uint)(byte)self[0x1d09] + (uint)(byte)self[0x1d2d] +
                        (uint)(byte)self[0x1d39] + (uint)(byte)self[0x1d51]) &&
      ...
      if ((((*(int *)(self + 0x1ce0) != 6) ||
            ((uint)(byte)self[0x1d45] + (uint)(byte)self[0x1cf1] + (uint)(byte)self[0x1cfd] +
                 (uint)(byte)self[0x1d09] + (uint)(byte)self[0x1d15] + (uint)(byte)self[0x1d21] +
...
LAB_0049b6cd:
  if ((bVar14) && (iVar4 = System_IsTrialMode(), iVar4 == 0)) {
    ...
    fVar16 = (float)(int)(((uint)(byte)self[0x1d46] + (uint)(byte)self[0x1d47] +
                           ((((uint)(byte)self[0x1d3a] + (uint)(byte)self[0x1d3b] +
                              (((uint)(byte)self[0x1d2e] + (uint)(byte)self[0x1d2f] +
                                (((uint)(byte)self[0x1d22] + (uint)(byte)self[0x1d23] +
                                  (((uint)(byte)self[0x1d16] + (uint)(byte)self[0x1d17] +
                                    (((uint)(byte)self[0x1d0a] + (uint)(byte)self[0x1d0b] +
