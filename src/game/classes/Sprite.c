...

{
  ...
  if (((byte)SVar1 & 1) != 0) {
    ...
    Matrix4x4__ConvertToOrthoMatrix
              (pMVar4,DAT_005be894 /* R:1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */)
    ;
...

{
  ...
  *(uint8_t ***)(self + 0x20) = &PTR__Sprite_005dd5b8;
  ...
  if ((*(TexturePackage **)(arg1 + 8) == (TexturePackage *)0x0) ||
     (*(int *)(arg1 + 0x10) == -1)) {
    plVar1 = *(long **)arg1;
    *(long **)(self + 0x118) = plVar1;
    ...
    uVar2 = TexturePackage__CreateTexture
                      (*(TexturePackage **)(arg1 + 8),*(int *)(arg1 + 0x10));
