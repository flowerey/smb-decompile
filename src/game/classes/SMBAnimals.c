    ...
    do {
      ...
      if (lVar8 != 0) {
        ...
        do {
          ...
          Sprint("%s%s",local_88,lVar8,(&InitializeAnimals(char_const*)::strAnimations)[lVar17]);
                ...
                *(void **)(self + lVar4 + 0x38) = pvVar9;
                if (pvVar3 != (void *)0x0) {
                  ...
                  *(void **)(self + lVar4 + 0x40) = pvVar9;
                  if (uVar13 <= uVar5) goto LAB_0048b168;
                  while( true ) {
                    uVar11 = (ulong)uVar5;
                    uVar5 = uVar5 + 1;
...
LAB_0048b168:
            if ((*(int *)(self + lVar4 + 0x30) == 1) && (*(short *)(self + lVar4 + 0x2a) != 0)) {
              ...
              while (uVar13 != 0xffff) {
                puVar15 = puVar15 + 1;
                if (sVar6 == *(short *)(self + lVar4 + 0x2a)) goto LAB_0048b172;
                sVar6 = sVar6 + 1;
                uVar13 = *puVar15;
              }
              *puVar15 = uVar5;
...
LAB_0048b172:
            ...
            *(short *)(self + lVar4 + 0x28) = *(short *)(self + lVar4 + 0x28) + 1;
            ...
            while( true ) {
              ...
              if (*(int *)(self + lVar4 + 0x48) == -0x5eef3582) {
                uVar5 = *(ushort *)(self + lVar4 + 0x28);
                if (uVar5 < *(ushort *)(self + lVar4 + 0x2a)) goto LAB_0048b261;
                uVar5 = *(ushort *)(self + lVar4 + 0x2a) + *(short *)(self + lVar4 + 0x34);
                uVar12 = (ulong)(byte)self[lVar4 + 0x2c];
                pvVar9 = (void *)0x0;
                pvVar3 = *(void **)(self + lVar4 + 0x38);
                ...
                *(void **)(self + lVar4 + 0x38) = pvVar9;
                if (pvVar3 != (void *)0x0) {
                  ...
                  uVar5 = *(ushort *)(self + lVar4 + 0x28);
                  *(void **)(self + lVar4 + 0x40) = pvVar9;
                  if (uVar13 <= uVar5) goto LAB_0048b261;
                  while( true ) {
                    uVar11 = (ulong)uVar5;
                    uVar5 = uVar5 + 1;
                    *(uint16_t *)((long)pvVar9 + uVar11 * 2) = 0xffff;
...
LAB_0048b261:
              ...
              if ((iVar2 == 1) && (*(short *)(self + lVar4 + 0x2a) != 0)) {
                ...
                while (uVar13 != 0xffff) {
                  puVar15 = puVar15 + 1;
                  if (sVar6 == *(short *)(self + lVar4 + 0x2a)) goto LAB_0048b26b;
                  sVar6 = sVar6 + 1;
                  uVar13 = *puVar15;
                }
                *puVar15 = uVar5;
      ...
      *(void **)(self + 0x38) = pvVar3;
      if (pvVar1 != (void *)0x0) {
        ...
        *(void **)(self + 0x40) = pvVar3;
        if (uVar8 <= uVar2) goto LAB_0048b96c;
        while( true ) {
          uVar6 = (ulong)uVar2;
          uVar2 = uVar2 + 1;
...
LAB_0048b96c:
  if ((*(int *)(self + 0x30) == 1) && (*(short *)(self + 0x2a) != 0)) {
    ...
    while (uVar8 != 0xffff) {
      puVar4 = puVar4 + 1;
      sVar7 = sVar7 + 1;
      if (sVar7 == *(short *)(self + 0x2a)) goto LAB_0048b972;
      uVar8 = *puVar4;
    }
    *puVar4 = uVar2;
    uVar2 = *(ushort *)(self + 0x28);
...

{
  ...
  if (*(int *)(arg1 + 0x50) != 0) {
    ...
    if (*(short *)(self + (long)*(int *)(arg1 + 0x218) * 0x58 +
      ...
      lVar1 = (long)*(int *)(arg1 + 0x218) * 0x58 +
              (long)*(int *)(arg1 + 0x214) * 0x370 + 0x50;
      if (*(uint *)(arg1 + 0x21c) == 0xffffffff) {
        this_00 = *(FlashLibraryInstance **)
                   (*(long *)(self + lVar1 + 0x38) + (ulong)*(ushort *)(self + lVar1 + 0x50) * 8);
      }
      else {
        this_00 = *(FlashLibraryInstance **)
                   (*(long *)(self + lVar1 + 0x38) +
...

{
  ...
  if (uVar6 != 0) {
    ...
    if ((SMBAnimal *)*plVar9 == arg1) {
      ...
      do {
        uVar11 = uVar11 + 1;
        if (uVar11 == uVar6) goto joined_r0x0048bee4;
        plVar7 = plVar7 + 1;
      ...
      do {
        while( true ) {
          ...
          *puVar2 = 0xffff;
          ...
          uVar6 = uVar6 + 1;
          if (uVar11 <= uVar6) goto LAB_0048bfca;
        }
...
uint64_t __thiscall
SMBAnimals__AnimalCollision(SMBAnimals *self,SceneObject2D *arg1,Bounds *arg2)
  ...
  if (uVar5 != 0) {
    ...
    do {
      ...
      if ((*(int *)(lVar8 + 0x218) != 5) &&
         ((((iVar2 = *(int *)(lVar8 + 0x214), iVar2 - 8U < 8 || (iVar2 == 0x12)) || (iVar2 == 0x13))
          || (iVar2 == 0x11)))) {
        ...
        if (iVar3 == 1) {
          if (iVar2 == 0x12) {
            ...
            if (*(int *)(lVar1 + 0x218) != 9) {
              ...
              *(uint32_t *)(lVar1 + 0x220) = 0;
              uVar4 = *(uint32_t *)
                       ((long)*(int *)(lVar1 + 0x214) * 0x370 + *(long *)(lVar1 + 0x230) + 0x3b8);
          ...
          if (iVar2 == 0x11) {
            ...
            if (*(int *)(lVar1 + 0x218) != 5) {
              ...
              *(uint32_t *)(lVar1 + 0x220) = 0;
              uVar4 = *(uint32_t *)
                       ((long)*(int *)(lVar1 + 0x214) * 0x370 + *(long *)(lVar1 + 0x230) + 600);
