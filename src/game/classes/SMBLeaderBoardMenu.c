...

{
  ...
  *(FlashAnimationLibrary **)(self + 8) = this_00;
  ...
  uVar3 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),
                                                        "leaderboard");
  ...
  *(uint64_t *)(self + 0x18) = uVar3;
  uVar3 =
      FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8), "page");
...

{
  ...
  *(uint32_t *)(*(long *)(*(uint32_t **)(self + 0x58) + 4) + 0x20) = **(uint32_t **)(self + 0x58);
...

{
    ...
    *(uint32_t *)(self + 0x43c) = 0;
    ...
    do {
      ...
      if (*(int *)(lVar8 + 0x18) == 0) {
        ...
        FlashTextField__SetText(*(wchar_t **)(pSVar7 + 0x170),
                                &DAT_005c5d74 /* R:6.305843089461677e-44f */);
        FlashTextField__SetText(*(wchar_t **)(pSVar7 + 0x120),
                                &DAT_005c5d70 /* R:6.305843089461677e-44f */);
        FlashTextField__SetText(*(wchar_t **)(pSVar7 + 0x1c0),
                                &DAT_005c5d70 /* R:6.305843089461677e-44f */);
        ...
        FlashTextField__SetText(
            *(wchar_t **)(pSVar7 + 0x120),
            (double)((float)*(
                         int *)(*(long *)(*(long *)(*(long *)(self + 0x2a0) + 8) + 0x28 + lVar6) +
                                0x20) *
        ...
        FlashTextField__SetText(
            *(wchar_t **)(pSVar7 + 0x1c0), &DAT_005c6660 /* R:5.184804318001823e-44f */,
            (ulong) *
                (uint *)(*(long *)(*(long *)(*(long *)(self + 0x2a0) + 8) + 0x28 + lVar6) + 0x20));
        FlashLibraryInstance__GotoAndStop(*(FlashLibraryInstance **)(pSVar7 + 0x240), 0x31);
      }
      puVar4 = *(uint **)(self + 0x2a0);
      uVar9 = iVar10 + 1;
      *(uint64_t *)(pSVar7 + 0x80) = *(uint64_t *)(*(long *)(puVar4 + 2) + lVar6);
      if ((puVar4[4] <= uVar9) || (9 < uVar9))
        break;
      iVar10 = iVar10 + 1;
      pSVar7 = pSVar7 + 8;
  ...
  puVar4 = *(uint **)(self + 0x2a0);
LAB_004c5620:
  FlashTextField__SetText(*(char **)(self + 0x238), &DAT_005c8bf9 /* R:u32=1996515621 */,
                          (ulong)*puVar4);
  ...
  if (*(int *)(self + 0x68) == 6) {
    ...
    *(uint32_t *)(*(long *)(*(long *)(self + 0x58) + 0x110) + 0x20) =
    ...
    FlashLibraryInstance__GotoAndStop(*(FlashLibraryInstance **)(*(long *)(self + 0x58) + 0x110),
                                      1);
  } else {
  ...
  if (*(int *)(self + 0x68) == 7) {
    ...
    *(uint32_t *)(*(long *)(*(long *)(self + 0x58) + 0x138) + 0x20) =
    ...
    FlashLibraryInstance__GotoAndStop(*(FlashLibraryInstance **)(*(long *)(self + 0x58) + 0x138),
                                      1);
  } else {
  ...
  if (*(int *)(self + 0x68) == 8) {
    ...
    *(uint32_t *)(*(long *)(*(long *)(self + 0x58) + 0x160) + 0x20) =
    ...
    FlashLibraryInstance__GotoAndStop(*(FlashLibraryInstance **)(*(long *)(self + 0x58) + 0x160),
                                      1);
  } else {
