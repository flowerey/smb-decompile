...
void __thiscall TileTexture__TileTexture__005a0be0(TileTexture *self,Texture *arg1,int arg2,int arg3)
...
uint32_t __thiscall
TileTexture__SetTexture(TileTexture *self,uchar arg1,int arg2,float *arg3)

{
  ...
  local_48 = 0xbf000000;
  local_44 = 0xbf000000;
  _local_58 = CONCAT44(fStack_54 - _DAT_005bfd00 /* R:10.0f */ / (float)*(ushort *)(*(long *)self + 0x10),
...
void __thiscall
TileTexture__GetTextureCoords(TileTexture *self,int arg1,float *arg2,Vector2 *arg3)
