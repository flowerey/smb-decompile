...

{
  ...
  *(code **)(pUVar3 + 0x58) = SMB_SAVE_LEVEL_Activate;
  ...
  local_b54 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
  ...
  local_b24 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
              _DAT_005bfd00 /* R:10.0f */;
  ...
  local_af4 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
              _DAT_005bfd00 /* R:10.0f */;
  ...
  *(code **)(SMB_NEW_LEVEL + 0x50) = SMB_NEW_LEVEL_Submit;
  ...
  local_a54 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
              _DAT_005bfd00 /* R:10.0f */;
  ...
  local_a24 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
              _DAT_005bfd00 /* R:10.0f */;
  ...
  local_9f4 = ((*(float *)(pUVar4 + 0x24) - DAT_005be6e4 /* R:0.5f */ * local_bdc) -
               DAT_005be6e4 /* R:0.5f */ * local_bec) -
              _DAT_005bfd00 /* R:10.0f */;
  ...
  *(code **)(pUVar5 + 0x40) = DeactivateForm;
  ...
  local_894 = (float)*(ushort *)(Window + 10) * _DAT_005c5b50 /* R:-0.4399999976158142f */ +
              _DAT_005bfd00 /* R:10.0f */;
  local_898 =
      (float)*(ushort *)(Window + 8) * DAT_005be6e4 /* R:0.5f */ - _DAT_005bff44 /* R:5.0f */;
  ...
  (**(code **)(*(long *)pSMBPLAYERPROPWallJumpFriction + 0x58))(pSMBPLAYERPROPWallJumpFriction,
                                                                local_be8);
  local_734 = *(uint32_t *)(pUVar4 + 0x24);
  local_738 = Initialize()::fPlayerFieldPos;
  Vector2__operator_assign((Vector2 *)(pSMBPLAYERPROPWallJumpFriction + 0x20),
                           (Vector2 *)&local_738);
  ...
  *(float *)(pAnimFieldStyle + 5) = fVar15;
  ...
  do {
    ...
    UILabel__setAlign(pUVar4, 1);
    local_598 =
        Initialize()::fPlayerFieldPos - _DAT_005bff44 /* R:5.0f */ * *(float *)(local_bd8[0] + 3);
    local_594 = local_c8c;
    ...
    UILabel__setAlign(pUVar4, 1);
    local_568 =
        _DAT_005bff44 /* R:5.0f */ * *(float *)(local_bd8[0] + 3) + Initialize()::fPlayerFieldPos;
    local_564 = local_c8c;
    ...
    *plVar12 = (long)pUVar6;
    ...
    local_548 =
        _DAT_005bfd00 /* R:10.0f */ * *(float *)(local_bd8[0] + 3) + Initialize()::fPlayerFieldPos;
  ...
  *(code **)(pUVar3 + 0x60) = DeactivateAnimProps;
  ...
  do {
    ...
    UILabel__setAlign(pUVar4, 1);
    local_4b8 =
        _DAT_005bf840 /* R:15.0f */ * *(float *)(local_bd8[0] + 3) + Initialize()::fPlayerFieldPos;
    local_4b4 = local_c8c;
    ...
    *plVar12 = (long)pUVar6;
    ...
    local_498 =
        DAT_005c13fc /* R:20.0f */ * *(float *)(local_bd8[0] + 3) + Initialize()::fPlayerFieldPos;
  ...
  (**(code **)(*(long *)pSMBPLAYEREFFECTRunFastDelay + 0x58))(pSMBPLAYEREFFECTRunFastDelay,
                                                              local_be8);
...

{
  ...
  if ((((((*(int *)(SMB_LOAD_LEVEL + 0x90) != 1) && (*(int *)(SMB_SAVE_LEVEL + 0x90) != 1)) &&
       ...
       ((*(int *)(SMB_LEVEL_PROPS + 0x90) != 1 &&
         ((*(int *)(SMB_LIGHT_PROPS + 0x90) != 1 &&
           (*(int *)(SMB_WAYPOINT_PROPS + 0x90) != 1)))))) &&
