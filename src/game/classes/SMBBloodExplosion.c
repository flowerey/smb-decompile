...

{
  ...
  *(uint32_t *)(self + 0x660) = 0x40a00000;
  ...
  TResourceCreator__AddResourceDestroyFunction((TResourceCreator *)ResourceCreator,
                                               SMBBloodExplosionDestroyResources, self);
  return;
}
...

{
  ...
  if (((*(float *)(self + 0x660) <= _DAT_005bff44 /* R:5.0f */) &&
       (*(int *)(SuperMeatBoy + 0x294) < 2)) &&
  ...
  LAB_0048d060:
    do {
      if (*(int *)pSVar12 == 1) {
        ...
        local_d4 =
            *(float *)(self + 0x660) * *(float *)(self + 0x660) * _DAT_005c17f8 /* R:-550.0f */ +
            local_d4;
        ...
        pGVar5 = (GRIDBLOCK *)TileLevel__GetGridBlockFromPos(*(TileLevel **)(SuperMeatBoy + 0x40),
                                                             &local_c8, 0);
        local_14c = 1;
        ...
        if (*pGVar5 == (GRIDBLOCK)0x0) {
          ...
          if (DAT_005c17f4 /* R:2.5f */ < *(float *)(pSVar12 + 4)) {
            ...
            iVar4 = SMBPalette__ObstacleCollision(GSuperMeatBoy__pLevelPalette,
                                                  (SceneObject2D *)local_1e8, local_e8);
            if (iVar4 != 0) {
              *(int *)pSVar12 = 0;
              goto LAB_0048d050;
            }
        ...
        *(int *)pSVar12 = 0;
        ...
        TileLevel__SnapPositionToCenter(*(TileLevel **)(SuperMeatBoy + 0x40), local_b8,
                                        DAT_005be894 /* R:1.0f */);
        uVar3 = GetTriangleOrientation(pGVar5, local_b8);
        local_88 = local_c8 - TileLevel__fLevelGridWH;
        local_84 = fStack_c4;
        piVar7 = (int *)TileLevel__GetGridBlockFromPos(*(TileLevel **)(SuperMeatBoy + 0x40),
                                                       &local_88, 0);
        local_78 = TileLevel__fLevelGridWH + local_c8;
        local_74 = fStack_c4;
        piVar8 = (int *)TileLevel__GetGridBlockFromPos(*(TileLevel **)(SuperMeatBoy + 0x40),
                                                       &local_78, 0);
        ...
        local_58 = local_c8;
        piVar9 = (int *)TileLevel__GetGridBlockFromPos(*(TileLevel **)(SuperMeatBoy + 0x40),
                                                       &local_58, 0);
        piVar10 = (int *)TileLevel__GetGridBlockFromPos(*(TileLevel **)(SuperMeatBoy + 0x40),
                                                        local_98, 0);
        pGVar1 = SuperMeatBoy;
        iVar4 = *piVar10;
        uVar2 = 8;
        ...
        if ((uVar2 & *(ushort *)(pGVar5 + 2) >> 6) != 0) {
          ...
          BloodyTiles__AddBloodyTile((BloodyTiles *)(pGVar1 + 0x50), pGVar5, uVar2, local_b8, uVar3,
                                     uVar11);
        }
      }
    LAB_0048d050:
