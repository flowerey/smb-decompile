...

{
  ...
  if (_DAT_0081c778 /* R:8.499491757454318e-39f */ == 1) {
    if (ScreenFlash <= 0.0) {
      DAT_0081c774 /* R:1.2856983475103413e-39f */ = DAT_0081c774 /* R:1.2856983475103413e-39f */ - fOneFrameTimeStep / _DAT_0081c764 /* R:0.0f */;
      if (DAT_0081c774 /* R:1.2856983475103413e-39f */ <= 0.0) goto LAB_0051831e;
    }
    else {
    ...
    TGraphics__ResetTexCoordGen(Graphics);
    TGraphics__ResetPixelStages(Graphics);
    if (DAT_005be894 /* R:1.0f */ <= DAT_0081c774 /* R:1.2856983475103413e-39f */) goto LAB_0051831e;
    self = *(Camera **)(SuperMeatBoy + 0x38);
    DAT_0081c774 /* R:1.2856983475103413e-39f */ = fOneFrameTimeStep / _DAT_0081c764 /* R:0.0f */ + DAT_0081c774 /* R:1.2856983475103413e-39f */;
  }
  Camera__SetOrthoProjection
            (self,DAT_005be894 /* R:1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */);
...
LAB_0051831e:
  ...
  if (((*(int *)(SuperMeatBoy + 0x2c) == 1) && (bVar2)) &&
    ...
    SMBPalette__ObstacleCollision
              (GSuperMeatBoy__pLevelPalette,*(SceneObject2D **)(SuperMeatBoy + 0x48),(Bounds *)0x0);
