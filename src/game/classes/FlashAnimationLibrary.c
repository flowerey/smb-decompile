...
void __thiscall FlashAnimationLibrary__GetDotIndex(FlashAnimationLibrary *self, char *arg1,
                                                   int *arg2)
          ...
          *arg2 = -1;
          if ((((0 < *(int *)(lVar2 + 0x2c)) && (0 < **(int **)(lVar2 + 0x30))) &&
              ...
              (lVar2 = *(long *)(*(long *)(self + 0x48) +
                                 (ulong) * (ushort *)(*(long *)(lVar2 + 0x20) + 0x20) * 8),
               lVar2 != 0)) {
            *arg2 = *(int *)(lVar2 + 0x1c);
          }
...
uint32_t __thiscall FlashAnimationLibrary__SetSymbolTexture(FlashAnimationLibrary *self, int arg1)
...
uint64_t *__thiscall FlashAnimationLibrary__GetMovieClip__005731d0(FlashAnimationLibrary *self,
                                                                   char *arg1)
...
uint64_t __thiscall FlashAnimationLibrary__GetClipNameByIndex(FlashAnimationLibrary *self, int arg1)
...
uint64_t __thiscall FlashAnimationLibrary__GetLibraryEntry(FlashAnimationLibrary *self, int arg1)
...
uint64_t __thiscall FlashAnimationLibrary__GetUITextField(FlashAnimationLibrary *self, uint arg1)
...
uint64_t __thiscall FlashAnimationLibrary__GetEditablTextFieldText(FlashAnimationLibrary *self,
                                                                   uint arg1, wstring **arg2)
...
void __thiscall FlashAnimationLibrary__FlashAnimationLibrary__00576680(FlashAnimationLibrary *self,
                                                                       char *arg1)

{
  ...
  *(void **)(self + 0x78) = pvVar9;
  ...
  if (iVar31 < 1) {
    ...
    do {
      lVar32 = (long)iVar36;
      std__string_string((string *)&local_2d8, (char *)(lVar32 + *(long *)(self + 0x70)),
                         &local_3f);
        ...
        *(FlashAnimationLibrary **)(this_01 + 0x38) = self;
        if (*(int *)(self + 0x58) == -0x5eef3582) {
          ...
          *(uint32_t *)(self + 0x40) = 0;
          ...
          if (pvVar9 != (void *)0x0) {
            puVar21 = (uint64_t *)((uVar17 - ((long)pvVar9 + 0x10U) % uVar17) % uVar17 +
                                   (long)pvVar9 + 0x10U);
            puVar21[-1] = pvVar9;
            puVar21[-2] = 0x28;
          }
      ...
      *(char **)(*(long *)(self + 0x78) + (long)(iVar31 + iVar38) * 8) = (char *)(lVar32 + lVar10);
      ...
      if (*(int *)(self + 0x58) == -0x5eef3582) {
        ...
        *(uint32_t *)(self + 0x40) = 0;
        ...
        if (pvVar9 != (void *)0x0) {
          puVar22 = (uint64_t *)((uVar17 - ((long)pvVar9 + 0x10U) % uVar17) % uVar17 +
                                 (long)pvVar9 + 0x10U);
          puVar22[-1] = pvVar9;
          puVar22[-2] = 0x28;
        }
              ...
              *(long **)(pfVar37 + 8) = plVar12;
              if (0 < (int)local_78[0]) {
                ...
                do {
                  ...
                  *(float *)(lVar28 + 100) =
                      (float)(ushort)local_2d8 * DAT_005c4890 /* R:0.003921568859368563f */;
