...
uint64_t * __thiscall
GSetPieceWayPoints__CreateNewWayPointGroup
          (GSetPieceWayPoints *self,TileLevelSetPiece *arg1,int arg2)
  ...
  if (*(int *)(self + 0x48) == -0x5eef3582) {
    ...
    if (*(ushort *)(self + 0x2a) <= uVar12) {
      ...
      *(ushort *)(self + 0x2a) = uVar12;
      ...
      if (pvVar9 != (void *)0x0) {
        pvVar8 = (void *)((long)pvVar9 + 0x10U + (uVar10 - ((long)pvVar9 + 0x10U) % uVar10) % uVar10
                         );
      ...
      if (pvVar6 != (void *)0x0) {
        ...
        if (pvVar9 != (void *)0x0) {
          pvVar8 = (void *)((long)pvVar9 + 0x10U +
                           (uVar10 - ((long)pvVar9 + 0x10U) % uVar10) % uVar10);
          *(ulong *)((long)pvVar8 + -0x10) = uVar15;
          *(void **)((long)pvVar8 + -8) = pvVar9;
          uVar10 = *(ulong *)((long)pvVar6 + -0x10);
          if (uVar15 <= *(ulong *)((long)pvVar6 + -0x10)) {
        ...
        *(void **)(self + 0x40) = pvVar8;
        if (uVar11 <= uVar12) goto LAB_0059d4d6;
        while( true ) {
          uVar15 = (ulong)uVar12;
          uVar12 = uVar12 + 1;
    ...
    *(uint32_t *)(self + 0x30) = 0;
    ...
    if (pvVar8 != (void *)0x0) {
      puVar16 = (uint64_t *)
                ((long)pvVar8 + 0x10U + (uVar15 - ((long)pvVar8 + 0x10U) % uVar15) % uVar15);
      puVar16[-2] = 0x230;
      puVar16[-1] = pvVar8;
    }
...
LAB_0059d4d6:
  if ((*(int *)(self + 0x30) == 1) && (*(short *)(self + 0x2a) != 0)) {
    ...
    while (uVar11 != 0xffff) {
      puVar13 = puVar13 + 1;
      if (sVar7 == *(short *)(self + 0x2a)) goto LAB_0059d4e0;
      sVar7 = sVar7 + 1;
      uVar11 = *puVar13;
    }
    *puVar13 = uVar12;
    ...
    if (*(ushort *)((long)puVar16 + 0x3a) <= uVar12) {
      ...
      *(ushort *)((long)puVar16 + 0x3a) = uVar12;
      ...
      if (pvVar6 != (void *)0x0) {
        ...
        puVar16[10] = pvVar8;
        if (uVar11 <= uVar12) goto LAB_0059d91f;
        while( true ) {
          uVar15 = (ulong)uVar12;
          uVar12 = uVar12 + 1;
          *(uint16_t *)((long)pvVar8 + uVar15 * 2) = 0xffff;
...
LAB_0059d91f:
  if ((*(int *)(puVar16 + 8) == 1) && (*(short *)((long)puVar16 + 0x3a) != 0)) {
    ...
    while (uVar11 != 0xffff) {
      puVar13 = puVar13 + 1;
      if (sVar7 == *(short *)((long)puVar16 + 0x3a)) goto LAB_0059d929;
      sVar7 = sVar7 + 1;
      uVar11 = *puVar13;
    }
    *puVar13 = uVar12;
...
long * __thiscall
GSetPieceWayPoints__GetWayPointGroup(GSetPieceWayPoints *self,TileLevelSetPiece *arg1)
...
void __thiscall
GSetPieceWayPoints__RenderGroup(GSetPieceWayPoints *self,SetPieceWayPointGroup *arg1)
...
void __thiscall
GSetPieceWayPoints__EditorRender(GSetPieceWayPoints *self,SetPieceWayPointGroup *arg1)
...
void __thiscall
GSetPieceWayPoints__ClearWayPointGroup(GSetPieceWayPoints *self,TileLevelSetPiece *arg1)
    ...
    do {
      ...
      if ((TileLevelSetPiece *)*plVar10 == arg1) {
        ...
        *plVar10 = 0;
        ...
        if ((uVar8 + 1 < uVar12) && (lVar14 = lVar13, uVar6 = uVar8, (int)uVar8 < (int)(uVar12 - 1))
           ) {
          do {
          ...
          do {
            while( true ) {
              ...
              *puVar2 = 0xffff;
              uVar11 = *(ushort *)(self + 0x2a);
              uVar5 = uVar5 + 1;
              if (uVar11 <= uVar5) goto LAB_0059df34;
            }
      ...
      do {
        while( true ) {
          ...
          *puVar1 = 0xffff;
          ...
          uVar5 = uVar5 + 1;
          if (uVar7 <= uVar5) goto LAB_0059e181;
        }
        uVar4 = *puVar1 - 1;
        if (uVar4 < 0xfffe) {
          *puVar1 = uVar4;
...

{
  ...
  if (*(short *)(self + 0x28) != 0) {
    ...
    do {
      ...
      uVar1 = (int)uVar2 + 1;
      uVar2 = (ulong)uVar1;
      SetPieceWayPointGroup__Reset((SetPieceWayPointGroup *)(uVar3 * 0x70 + *(long *)(self + 0x38)))
      ;
    } while ((int)uVar1 < (int)(uint)*(ushort *)(self + 0x28));
  }
  return;
...
uint64_t __thiscall
GSetPieceWayPoints__LoadWayPointData(GSetPieceWayPoints *self,File *arg1,TileLevel *arg2)
      ...
      if (arg2 != (TileLevel *)0x0) {
        ...
        if (*(int *)(self + 0x48) == -0x5eef3582) {
            ...
            *(void **)(self + 0x38) = pvVar12;
            ...
            if (pvVar10 != (void *)0x0) {
              ...
              *(void **)(self + 0x40) = pvVar13;
              if (uVar15 <= uVar19) goto LAB_0059e44d;
              while( true ) {
                uVar20 = (ulong)uVar19;
                uVar19 = uVar19 + 1;
          ...
          *(uint32_t *)(self + 0x30) = 0;
          ...
          if (pvVar10 != (void *)0x0) {
            puVar16 = (uint64_t *)
                      ((uVar20 - ((long)pvVar10 + 0x10U) % uVar20) % uVar20 + (long)pvVar10 + 0x10U)
            ;
            puVar16[-2] = 0x230;
            puVar16[-1] = pvVar10;
          }
...
LAB_0059e44d:
        if ((*(int *)(self + 0x30) == 1) && (*(short *)(self + 0x2a) != 0)) {
          ...
          while (uVar15 != 0xffff) {
            puVar17 = puVar17 + 1;
            if (sVar8 == *(short *)(self + 0x2a)) goto LAB_0059e458;
            sVar8 = sVar8 + 1;
            uVar15 = *puVar17;
          }
          *puVar17 = uVar19;
          ...
          if (arg2 != (TileLevel *)0x0) {
            ...
            if (uVar19 < 10) {
              if ((int)plVar18[0xb] == -0x5eef3582) {
                if (uVar19 < *(ushort *)((long)plVar18 + 0x3a)) goto LAB_0059e738;
                ...
                *(ushort *)((long)plVar18 + 0x3a) = uVar19;
                ...
                if (pvVar13 != (void *)0x0) {
                  ...
                  if (uVar15 <= uVar19) goto LAB_0059e738;
                  while( true ) {
                    uVar20 = (ulong)uVar19;
                    uVar19 = uVar19 + 1;
                ...
                *(uint32_t *)(plVar18 + 8) = 0;
                ...
                if (pvVar10 != (void *)0x0) {
                  puVar16 = (uint64_t *)
                            ((uVar20 - ((long)pvVar10 + 0x10U) % uVar20) % uVar20 +
                            (long)pvVar10 + 0x10U);
                  puVar16[-2] = 0xa0;
                  puVar16[-1] = pvVar10;
                }
...
LAB_0059e738:
              ...
              if ((iVar1 == 1) && (*(short *)((long)plVar18 + 0x3a) != 0)) {
                ...
                while (uVar15 != 0xffff) {
                  puVar17 = puVar17 + 1;
                  sVar8 = sVar8 + 1;
                  if (sVar8 == *(short *)((long)plVar18 + 0x3a)) goto LAB_0059e742;
                  uVar15 = *puVar17;
                }
                *puVar17 = uVar19;
                uVar19 = *(ushort *)(plVar18 + 7);
...
void __thiscall
GSetPieceWayPoints__SaveWayPointData(GSetPieceWayPoints *self,File *arg1,TileLevel *arg2)
...
LAB_0059ee60:
      piVar4 = piVar4 + 1;
      if (piVar4 == local_68 + 8) goto code_r0x0059ee6f;
    }
    while (lVar8 != lVar2) {
      lVar2 = *(long *)(lVar2 + 8);
      iVar7 = iVar7 + 1;
      if (lVar2 == 0) goto LAB_0059ee60;
    }
    local_68[8] = iVar7;
...

{
  ...
  TResourceCreator__RemoveResourceCreationFunction
            ((TResourceCreator *)ResourceCreator,CreateSetPieceWayPointResources,self);
  TResourceCreator__RemoveResourceDestroyFunction
            ((TResourceCreator *)ResourceCreator,DestroySetPieceWayPointResources,self);
  if (*(int *)(self + 0x48) != -0x5eef3582) {
