...
LAB_005a717b:
        ...
        while( true ) {
          ...
          if (local_38[0] == 0x61746164) break;
          uVar9 = uVar9 + 2;
  ...
  if (iVar5 == 1) {
    ...
    local_38[0] = 0;
    iVar5 = stb_vorbis_decode_memory
                      (pvVar7,*(uint32_t *)(*(long *)(self + 0x150) + 4),local_38,&local_58,
                       &local_60);
    ...
    *(uint *)(self + 0x30) = uVar9 & 0xfffffffe;
    TAudio__DecodeConsoleADPCMData
              (this_00,self,(uchar **)(self + 8),(TWAVEFORMATEX *)(self + 0x14),
               (uint *)(self + 0x34),(uint *)(self + 0x10));
LAB_005a70d5:
...

{
  ...
  if ((((byte)self[0x30] & 0x10) != 0) && (pFVar1 = *(File **)(self + 0x150), pFVar1 != (File *)0x0)
     ) {
    File__File__005b7a70(pFVar1);
    operator_delete(pFVar1);
  }
