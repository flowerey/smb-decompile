...
void __thiscall SetPieceWayPointGroup__AddWayPoint__0059c660(SetPieceWayPointGroup *self,
                                                             FPUVector *arg1, Vector2 *arg2,
...

{
  ...
  if (*(int *)(self + 0x58) == -0x5eef3582) {
    ...
    *(uint32_t *)(self + 0x40) = 0;
    ...
    if (pvVar6 != (void *)0x0) {
      puVar13 =
          (uint64_t *)((long)pvVar6 + 0x10U + (uVar12 - ((long)pvVar6 + 0x10U) % uVar12) % uVar12);
      puVar13[-2] = 0xa0;
      puVar13[-1] = pvVar6;
    }
    ...
    if (*(ushort *)(self + 0x3a) <= uVar11) {
      ...
      *(void **)(self + 0x48) = pvVar2;
      if (pvVar1 != (void *)0x0) {
        ...
        if (pvVar3 != (void *)0x0) {
          pvVar2 =
              (void *)((long)pvVar3 + 0x10U + (uVar4 - ((long)pvVar3 + 0x10U) % uVar4) % uVar4);
          *(void **)((long)pvVar2 + -8) = pvVar3;
          *(ulong *)((long)pvVar2 + -0x10) = uVar8;
          uVar4 = *(ulong *)((long)pvVar1 + -0x10);
          if (uVar8 <= *(ulong *)((long)pvVar1 + -0x10)) {
...
void __thiscall SetPieceWayPointGroup__RemoveWayPoint__0059cad0(SetPieceWayPointGroup *self,
                                                                int arg1)
  ...
  if (lVar10 != 0) {
    ...
    if (uVar6 != 0) {
      ...
      do {
        ...
        *(uint32_t *)(*(long *)self + 0x3c) = *(uint32_t *)(*(long *)(self + 0x48) + 0x18 + lVar9);
        (**(code **)(**(long **)self + 0x10))();
        lVar10 = *(long *)self;
...
void __thiscall SetPieceWayPointGroup__SetParentPiece(SetPieceWayPointGroup *self,
...

{
  ...
  if (lVar1 != 0) {
    ...
    *puVar2 = *(uint32_t *)(lVar1 + 0x24);
    ...
    Vector2__operator_assign((Vector2 *)(*(long *)(self + 0x48) + 0x10),
                             (Vector2 *)(*(long *)self + 0x34));
...

{
  ...
  if (lVar3 != 0) {
    ...
    *(ulong *)(lVar7 + 0x2c) = CONCAT44(fVar1 * fVar11 + fVar13, fVar2 * fVar11 + fVar10);
    ...
    if (iVar5 == 1) {
      *(float *)(*(long *)self + 0x3c) = fVar9 * *(float *)(*(long *)(self + 0x48) + 0x18 +
                                                            (ulong) * (ushort *)(self + 8) * 0x20) +
...

{
  ...
  if (1 < *(ushort *)(self + 0x38)) {
    ...
    do {
      ...
      if ((((local_48 < fVar1) && (local_44 < fVar7)) && (fVar1 < local_38)) &&
          (fVar7 < local_34)) {
