...
GSMBCharactor__CreateCharactor__0049c600(GSMBCharactor *self,uint32_t arg2,byte arg3)
      ...
      *(void **)(self + 0x38) = pvVar3;
      if (pvVar1 != (void *)0x0) {
        ...
        *(void **)(self + 0x40) = pvVar3;
        if (uVar8 <= uVar2) goto LAB_0049c0ee;
        while( true ) {
          uVar6 = (ulong)uVar2;
          uVar2 = uVar2 + 1;
...
LAB_0049c0ee:
  if ((*(int *)(self + 0x30) == 1) && (*(short *)(self + 0x2a) != 0)) {
    ...
    while (uVar8 != 0xffff) {
      puVar4 = puVar4 + 1;
      sVar7 = sVar7 + 1;
      if (sVar7 == *(short *)(self + 0x2a)) goto LAB_0049c0f4;
      uVar8 = *puVar4;
    }
    *puVar4 = uVar2;
    uVar2 = *(ushort *)(self + 0x28);
...
void __thiscall GSMBCharactor__DestroyCharactor__0049cbf0(GSMBCharactor *self,MeatBoyCharactor *arg1)
    ...
    if (uVar10 != 0) {
      ...
      if ((uVar8 < uVar6) && ((int)uVar5 < (int)(uVar6 - 1))) {
        ...
        while( true ) {
          ...
          *puVar1 = *(uint64_t *)((long)plVar7 + lVar9);
          uVar10 = *(ushort *)(self + 0x28);
          if ((int)(uVar10 - 1) <= (int)uVar6) break;
          plVar7 = *(long **)(self + 0x38);
        }
      }
