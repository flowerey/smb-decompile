...

{
  ...
  Matrix4x4__ConvertToOrthoMatrix
            (pMVar1,_DAT_005c0c9c /* R:240.0f */,DAT_005c0c98 /* R:-240.0f */,DAT_005dd444 /* R:-320.0f */,DAT_005dd440 /* R:320.0f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */);
  TGraphics__SetPixelColorConstant(Graphics,0,::cGreen);
  TGraphics__Draw(Graphics,__pMarginStream,(IndexBuffer *)0x0);
  pMVar1 = (Matrix4x4 *)TGraphics__GetMatrix(Graphics,3);
  Matrix4x4__ConvertToOrthoMatrix
            (pMVar1,_DAT_005c0c9c /* R:240.0f */,DAT_005c0c98 /* R:-240.0f */,DAT_005c0c94 /* R:-426.5f */,DAT_005c0c90 /* R:426.5f */,DAT_005c07a4 /* R:-1.0f */,DAT_005be894 /* R:1.0f */);
  TGraphics__SetPixelColorConstant(Graphics,0,::cGreen);
  TGraphics__Draw(Graphics,__pMarginStream,(IndexBuffer *)0x0);
  local_18 = 0x43900000;
  local_14 = 0x43580000;
