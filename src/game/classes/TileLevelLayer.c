...

{
  ...
  if (*(int *)(lVar2 + 0x22b0) == 0) {
    if (*(Camera **)(lVar2 + 0x48) == (Camera *)0x0) {
      ...
      local_90 = 0;
      local_8c = 0;
      Camera__ScreenToWorld(*(Camera **)(lVar2 + 0x48), (FPUVector *)&local_98,
                            (Vector2 *)&local_78, 0.0);
      TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(self + 0x418), (Vector2 *)&local_98,
                                        local_88, (int *)local_48, local_3c);
      local_68 = 0x3f800000;
      local_64 = 0x3f800000;
      Camera__ScreenToWorld(*(Camera **)(*(long *)(self + 0x418) + 0x48), (FPUVector *)&local_98,
                            (Vector2 *)&local_68, 0.0);
      TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(self + 0x418), (Vector2 *)&local_98,
                                        local_88, (int *)local_44, (int *)&local_40);
      local_9e = local_44[0];
        ...
        do {
          while (true) {
            ...
            pcVar1 = (char *)(*(long *)(self + 0x430) +
                              (long)(int)((uint)uVar3 * (uint) * (ushort *)(lVar2 + 0x38) +
                                          (uint)uVar6) *
                                  4);
            if (*pcVar1 == '\0')
              break;
            ...
            (**(code **)(**(long **)(lVar2 + 0x40) + 0x10))(*(long **)(lVar2 + 0x40), pcVar1,
                                                            &local_58);
    ...
    (**(code **)(**(long **)(lVar2 + 0x40) + 0x18))(*(long **)(lVar2 + 0x40),
                                                    *(uint64_t *)(self + 0x438));
  }
LAB_0058d212:
