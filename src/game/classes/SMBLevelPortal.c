...

{
  ...
  Sprint((double)(_DAT_005c0f60 /* R:1.100000023841858f */ * *(float *)(SMBHUD + 0x418)),
         "INSERT INTO smb_editor_levelinfo VALUES (\'\', \'%llu\', \'%s\', 1, 0, 1, 2.5, %.02f, "
         "%i, %i, NOW())",
         strPortalUploadQuery, uVar6, *(uint64_t *)(arg1 + 8), uVar3, *(uint32_t *)(lVar4 + 0xa54));
  local_a8 = 0;
  local_98 = 0;
  local_90 = 0;
  local_8c = 0;
...
void __thiscall SMBLevelPortal__UpdateLevelStats(SMBLevelPortal *self, PortalLevelStatsUpdate *arg1)

{
  ...
  Sprint((double)*(float *)(self + 0x10),
         "UPDATE smb_editor_levelinfo SET num_fun_ratings = num_fun_ratings + %i, "
         "\t\t\t\t\t\t\t\t\t\t  raw_fun_ratings = raw_fun_ratings + %.02f, times_died = times_died "
         "+ %i, \t\t\t\t\t\t\t\t\t\t  times_played = times_played + 1 WHERE level_id = %i",
...
void __thiscall SMBLevelPortal__GetPortalLevel(SMBLevelPortal *self, int arg1,
                                               SMBPortalLevel **arg2)

{
  ...
  Sprint("SELECT smb_editor_levelinfo.*, smb_editor_leveldata.level_data,  times_died / "
         "times_played AS difficulty FROM \t\t\t\t\t\t\t\t\t   smb_editor_levelinfo, "
         "smb_editor_leveldata WHERE \t\t\t\t\t\t\t\t\t   smb_editor_levelinfo.level_id = %i AND "
         "smb_editor_leveldata.level_id = %i",
  ...
  *(int *)(pSVar3 + 0x70) = local_28[0];
  ...
  SQLResultSet__GetFLOAT(local_c8, (SQLFieldName *)&local_48, (float *)(pSVar3 + 0x74),
                         (uint *)0x0);
  free(local_38);
  *arg2 = pSVar3;
LAB_00506ee3:
...
void __thiscall SMBLevelPortal__GetPortalChapter(SMBLevelPortal *self, int arg1,
                                                 SMBPortalChapter **arg2)
  ...
  *(uint64_t *)(self + 0x68) = 0xffffffffffffffff;
  ...
  if (iVar1 == 1) {
    ...
    *(uint32_t *)(pSVar3 + 0xa8) = 0xffffffff;
    ...
    SQLResultSet__GetString(local_e8, (SQLFieldName *)&local_78, (char **)(pSVar3 + 0xa0),
                            (uint *)0x0);
...
void __thiscall SMBLevelPortal__LoadSelectedLevel(SMBLevelPortal *self, uchar **arg1, uint *arg2)
...

{
  ...
  if (((iVar12 == 1) || (iVar12 == 0)) || (iVar12 == 2)) {
    ...
    SMBChapter__LoadInternetsChapterMusic((SMBChapter *)(SuperMeatBoy + 0x90),
                                          *(int *)(LoadedPortalChapter + 0x15));
    plVar10 = *(long **)(self + 8);
  } else if (iVar12 == 4) {
    local_50 = 0;
    ...
    *(uint64_t *)(pSVar4 + 0x18) = 0;
    if ((GetEnterTheUnknownChapter(SMBPortalChapter **)::iEnterUnknownLength == '\0') &&
        (iVar12 = __cxa_guard_acquire(
             &GetEnterTheUnknownChapter(SMBPortalChapter **)::iEnterUnknownLength),
         iVar12 != 0)) {
    ...
    Sprint((double)*(float *)(self + 0x1c),
           "SELECT level_id, times_died / times_played AS difficulty \t\t\t\t\t\t\t\t\t\t   FROM "
           "smb_editor_levelinfo WHERE raw_fun_ratings / num_fun_ratings >= 3.0 AND "
           "\t\t\t\t\t\t\t\t\t\t   times_died / times_played <= %.02f AND times_played > 10 ORDER "
           "BY RAND() LIMIT 20",
  ...
  LAB_00507b86:
    ...
    std__introsort_loop_SMBPortalLevel, long,
        bool (*)(SMBPortalLevel *, SMBPortalLevel *) > (ppSVar3, ppSVar3 + 0x13, 8, p_Var7);
    std__insertion_sort_SMBPortalLevel,
        bool (*)(SMBPortalLevel *, SMBPortalLevel *) > (ppSVar3, ppSVar11, extraout_RDX);
...
void __thiscall SMBLevelPortal__GetEnterTheUnknownChapter(SMBLevelPortal *self,
                                                          SMBPortalChapter **arg1)

{
  ...
  *(uint64_t *)(pSVar4 + 0x18) = 0;
  ...
  Sprint((double)*(float *)(self + 0x1c),
         "SELECT level_id, times_died / times_played AS difficulty \t\t\t\t\t\t\t\t\t\t   FROM "
         "smb_editor_levelinfo WHERE raw_fun_ratings / num_fun_ratings >= 3.0 AND "
         "\t\t\t\t\t\t\t\t\t\t   times_died / times_played <= %.02f AND times_played > 10 ORDER BY "
         "RAND() LIMIT 20",
         strPortalUploadQuery);
  local_98 = 0;
  local_88 = (SQLResultSet *)0x0;
...
uint64_t __thiscall SMBLevelPortal__GetUserLibrary(SMBLevelPortal *self, SQLQuery *arg1, char *arg2,
                                                   int arg3)

{
  ...
  *(uint16_t *)(arg1 + 0x20) = 1;
  Sprint("SELECT smb_editor_levelinfo.* FROM smb_editor_levelinfo WHERE author_id = \'%llu\' AND "
         "(levelname LIKE \'%%%s%%\' OR level_id = \'%s\') LIMIT %i, 10",
...

{
  ...
  Sprint("INSERT INTO smb_editor_chapterinfo VALUES (\'\', \'%llu\', \'%s\', %i, %i, %i, NOW())",
         strPortalUploadQuery, uVar3, arg1, *(uint32_t *)(arg1 + 0x20), *(uint32_t *)(arg1 + 0x24),
         *(uint32_t *)(arg1 + 0x28));
...

{
  ...
  *(uint8_t **)(self + 0x70) = &DAT_008184c8 /* R:0.00016803004837129265f */;
  ...
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "featuredtitle",
                                          "Featured Chapters");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "featuredtitle2",
                                          "Featured Levels");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "chapter", "Tile Set");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "chapterportal",
                                          "Chapters");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "char",
                                          &DAT_005c7aae /* R:"Char" */);
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "difficulty",
                                          "Difficulty");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "funfactor",
                                          "Fun Factor");
  ...
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "unknowntxt",
                                          "The Unknown");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "num",
                                          &DAT_005c7af1 /* R:u32=1869021219 */);
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "go",
                                          &DAT_005c31dc /* R:134673520.0f */);
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "utext1",
                                          "Select your difficulty");
  FlashAnimationLibrary__SetTextFieldText((char *)PortalInterfaceLibrary, "entertheunknown",
                                          "Enter The Unknown");
