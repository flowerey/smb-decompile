...
int __thiscall
TileLevel__GetGridIndex__0058dd90(TileLevel *self,Vector2 *arg1,Vector2 *arg2,int *arg3,int *arg4)
...

{
  ...
  *(uint32_t *)(self + 0x22c4) = 0;
  ...
  TResourceCreator__AddResourceCreationFunction
            ((TResourceCreator *)ResourceCreator,CreateTileLevelResources,self);
  TResourceCreator__AddResourceDestroyFunction
            ((TResourceCreator *)ResourceCreator,DestroyTileLevelResources,self);
  return;
}
...

{
  ...
  bVar1 = false;
  if (((-1 < (int)lVar2) && ((int)lVar2 < (int)(uint)*(ushort *)(self + 0x38))) && (-1 < (int)lVar3)
     ) {
...

{
  ...
  *(float *)arg3 = ((float)arg1 + DAT_005be6e4 /* R:0.5f */) * fLevelGridWH + *(float *)(self + 0x30);
...

{
  ...
  *(float *)(arg1 + 4) =
       arg2 * fLevelGridWH * ((float)iVar2 + fVar1) + *(float *)(self + 0x34);
  return;
}
...
void __thiscall
TileLevel__GetGridCoordsFromBlock(TileLevel *self,GRIDBLOCK *arg1,int *arg2,int *arg3)

{
  ...
  *arg2 = iVar5;
  iVar3 = (int)((long)((ulong)uVar4 << 0x20 | uVar6 & 0xffffffff) /
               (long)(int)(uint)*(ushort *)(self + 0x38));
  iVar5 = 0;
  if (-1 < iVar3) {
    iVar5 = iVar3;
  }
...
uint __thiscall
TileLevel__TileCollisionResponse
          (TileLevel *self,SceneObject2D *arg1,Vector2 *arg2,TileCollisionInfo *arg3)
  ...
  *(uint32_t *)(arg3 + 0x20) = 0;
  ...
  if (*(float *)(arg1 + 0xc0) <= 0.0) {
    if (0.0 <= *(float *)(arg1 + 0xc0)) {
      ...
      iVar7 = (**(code **)(**(long **)(self + 0x40) + 0x40))
                        (*(long **)(self + 0x40),lVar4,&local_208,arg2,local_1e8,arg1,
...
LAB_0058e85e:
        iVar7 = (**(code **)(**(long **)(self + 0x40) + 0x40))
                          (*(long **)(self + 0x40),lVar4,local_280,arg2,local_278,arg1,
        ...
        do {
          if (plVar9 == plVar1) goto LAB_0058e85e;
          plVar9 = plVar9 + 1;
        } while (lVar4 != *plVar9);
      }
...
LAB_0058e946:
        ...
        if (lVar4 != local_248[0]) {
          ...
          plVar1 = plVar9 + (uVar10 - 1);
          do {
            if (plVar9 == plVar1) goto LAB_0058e946;
            plVar9 = plVar9 + 1;
          } while (lVar4 != *plVar9);
        }
      }
...
LAB_0058e59b:
      ...
      plVar1 = plVar9 + (uVar10 - 1);
      do {
        if (plVar9 == plVar1) goto LAB_0058e59b;
        plVar9 = plVar9 + 1;
      } while (lVar4 != *plVar9);
    }
...
LAB_0058e681:
      ...
      if (lVar4 != local_248[0]) {
        ...
        plVar1 = plVar9 + (uVar10 - 1);
        do {
          if (plVar9 == plVar1) goto LAB_0058e681;
          plVar9 = plVar9 + 1;
        } while (lVar4 != *plVar9);
      }
    }
...
uint64_t __thiscall
TileLevel__TileLineOfSight(TileLevel *self,Vector2 *arg1,Vector2 *arg2,Vector2 *arg3)
...
void __thiscall
TileLevel__TileCollision(TileLevel *self,SceneObject2D *arg1,TileCollisionInfo *arg2)
...
void __thiscall
TileLevel__PlaceTile(TileLevel *self,int arg1,int arg2,uint32_t *arg3,int arg5)

{
  if (arg5 == 1) {
    *(uint32_t *)
     (*(long *)(self + 8) + (long)(int)((uint)*(ushort *)(self + 0x38) * arg2 + arg1) * 4) =
         *arg3;
    return;
  }
  if (arg5 != 2) {
    *(uint32_t *)
     (*(long *)self + (long)(int)(arg1 + arg2 * (uint)*(ushort *)(self + 0x38)) * 4) =
         *arg3;
    return;
  }
  *(uint32_t *)
   (*(long *)(self + 0x10) + (long)(int)((uint)*(ushort *)(self + 0x38) * arg2 + arg1) * 4) =
       *arg3;
  return;
}
            ...
            while( true ) {
              ...
              (**(code **)(**(long **)(self + 0x40) + 0x48))
                        (*(long **)(self + 0x40),(void *)(uVar7 * 0x10 + (long)local_48),
                         lVar2 + (long)(int)(uVar4 * uVar5 + local_d4) * 4,local_68,&local_40,
                         local_3c,fVar11);
              uVar3 = *(ushort *)(self + 0x3a);
  ...
  *puVar7 = uVar21;
  ...
  if (lVar18 != -1) {
    ...
    if (uVar10 != 0) {
      ...
      if (uVar21 == uVar10) goto LAB_00591490;
    }
    ...
    if (uVar13 != 0) {
      ...
      if (uVar21 - uVar10 == uVar13 * 4) goto LAB_00591490;
    }
    lVar15 = 0;
    do {
              ...
              do {
                if ((uVar6 < (ushort)((ushort)uVar4 + sVar3)) && ((ushort)uVar4 <= uVar6)) {
                  *(uint32_t *)(lVar15 + (long)(int)(uVar12 * uVar16 + uVar9) * 4) =
                       *(uint32_t *)
                        (*(long *)((long)local_88 + lVar18) +
                        (long)(int)((uVar12 - (uVar4 & 0xffff)) * (uint)*(ushort *)(self + 0x38) +
                                   (uVar9 - uVar5)) * 4);
                }
                else {
