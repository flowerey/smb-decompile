...
uint64_t __thiscall GameRegistry__GetVariable(GameRegistry *self, char *arg1,
                                              GameRegistryEntry **arg2)
  ...
  if (((*(int *)(self + 0x14) != -1) && (*(long *)self != 0)) && (*(long *)(self + 8) != 0)) {
    ...
    if (local_58[0] != -1) {
      ...
      if (*(int *)(self + 0x10) != 0) {
        ...
        do {
          while (true) {
            File__Write((File *)local_58, (void *)(*(long *)(self + 8) + (ulong)uVar3 * 0x18 + 8),
                        4);
