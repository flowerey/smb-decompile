...
void __thiscall SMBLevelPortalInterface__SMBLevelPortalInterface__005061b0(SMBLevelPortalInterface *self)
...
void __thiscall SMBLevelPortalInterface__SMBLevelPortalInterface__005084f0(SMBLevelPortalInterface *self)
...

{
  ...
  if (*(int *)(self + 0x376c) == 3) {
    Sprint("SELECT smb_editor_levelinfo.* FROM smb_editor_levelinfo JOIN smb_editor_author \t\t\t\t\t\t\t\t\t\t\t  ON author_name LIKE \'%%%s%%\' WHERE smb_editor_levelinfo.author_id = smb_editor_author.author_id \t\t\t\t\t\t\t\t\t\t\t  UNION SELECT smb_editor_levelinfo.* FROM smb_editor_levelinfo WHERE levelname LIKE \'%%%s%%\' OR level_id = \'%s\'"
...

{
  ...
  if (((iVar1 == 3) || (iVar1 == 1)) || (iVar1 == 2)) {
    ...
    if (*(int *)(self + 0x120) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x130),*(int *)(self + 0x3b0));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x130));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1d0),*(int *)(self + 0x3b4) + 1);
    ...
    if (*(int *)(self + 0x3c8) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x3d8),*(int *)(self + 0x658));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x3d8));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x478),*(int *)(self + 0x65c) + 1);
    ...
    if (*(int *)(self + 0x670) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x680),*(int *)(self + 0x900));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x680));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x720),*(int *)(self + 0x904) + 1);
    ...
    if (*(int *)(self + 0x918) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x928),*(int *)(self + 0xba8));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x928));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x9c8),*(int *)(self + 0xbac) + 1);
    ...
    if (*(int *)(self + 0xbc0) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0xbd0),*(int *)(self + 0xe50));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0xbd0));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0xc70),*(int *)(self + 0xe54) + 1);
    ...
    if (*(int *)(self + 0xe68) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0xe78),*(int *)(self + 0x10f8));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0xe78));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0xf18),*(int *)(self + 0x10fc) + 1);
    ...
    if (*(int *)(self + 0x1110) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1120),*(int *)(self + 0x13a0));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x1120));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x11c0),*(int *)(self + 0x13a4) + 1);
    ...
    if (*(int *)(self + 0x13b8) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x13c8),*(int *)(self + 0x1648));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x13c8));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1468),*(int *)(self + 0x164c) + 1);
    ...
    if (*(int *)(self + 0x1660) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1670),*(int *)(self + 0x18f0));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x1670));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1710),*(int *)(self + 0x18f4) + 1);
    ...
    if (*(int *)(self + 0x1908) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x1918),*(int *)(self + 0x1b98));
      FlashLibraryInstance__Render((FlashLibraryInstance *)(self + 0x1918));
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x19b8),*(int *)(self + 0x1b9c) + 1);
    ...
    if (*(int *)(self + 0x2900) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x29b0),*(int *)(self + 0x2b94) + 1);
    ...
    if (*(int *)(self + 0x2ba8) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x2c58),*(int *)(self + 0x2e3c) + 1);
    ...
    if (*(int *)(self + 0x2e50) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x2f00),*(int *)(self + 0x30e4) + 1);
    ...
    if (*(int *)(self + 0x30f8) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x31a8),*(int *)(self + 0x338c) + 1);
    ...
    if (*(int *)(self + 0x33a0) != -1) {
      FlashLibraryInstance__GotoAndStop
                ((FlashLibraryInstance *)(self + 0x3450),*(int *)(self + 0x3634) + 1);
...
void __thiscall
SMBLevelPortalInterface__SetSelectedLine
          (SMBLevelPortalInterface *self,PortalInterfaceElement *arg1)
    ...
    if (sqlQuery._16_8_ != 0) {
      ...
      if (iVar2 == 1) {
        ...
        FillPortalInterfaceElement
                  ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x120),
                   *(FlashTextField **)(self + 0xd0),(uint)(*(int *)(self + 0x376c) == 3),0);
        iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
        if (iVar2 == 1) {
          iVar3 = 2;
          FillPortalInterfaceElement
                    ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x3c8),
                     *(FlashTextField **)(self + 0xd8),(uint)(*(int *)(self + 0x376c) == 3),0);
          iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
          if (iVar2 == 1) {
            iVar3 = 3;
            FillPortalInterfaceElement
              ...
              if (iVar2 == 1) {
                ...
                if (iVar2 == 1) {
                  ...
                  FillPortalInterfaceElement
                             ...
                             *(FlashTextField **)(self + 0xf8),(uint)(*(int *)(self + 0x376c) == 3),
                             0);
                  iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
                  if (iVar2 == 1) {
                    iVar3 = 7;
                    FillPortalInterfaceElement
                              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x1110),
                    ...
                    if (iVar2 == 1) {
                      iVar3 = 8;
                      FillPortalInterfaceElement
                                ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x13b8),
                      ...
                      if (iVar2 == 1) {
                        iVar3 = 9;
                        FillPortalInterfaceElement
                                  ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x1660),
                                   *(FlashTextField **)(self + 0x110),
                                   (uint)(*(int *)(self + 0x376c) == 3),0);
                        iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
                        if (iVar2 == 1) {
                          FillPortalInterfaceElement
                                    ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x1908),
...
LAB_0050aaf0:
    ...
    iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
    iVar3 = 0;
    if (iVar2 != 1) goto LAB_0050aaf0;
    iVar3 = 1;
    FillPortalInterfaceElement
              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x2900),
    ...
    iVar3 = 2;
    FillPortalInterfaceElement
              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x2ba8),
    ...
    iVar3 = 3;
    FillPortalInterfaceElement
              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x2e50),
    ...
    iVar3 = 4;
    FillPortalInterfaceElement
              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x30f8),
               *(FlashTextField **)(self + 0x110),1,0);
    SetAuthorText(*(FlashAnimationLibrary **)(self + 8),9,(SQLQuery *)sqlQuery);
    iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery._16_8_);
    if (iVar2 != 1) goto LAB_0050aaf0;
    FillPortalInterfaceElement
              ((SQLQuery *)sqlQuery,(PortalInterfaceElement *)(self + 0x33a0),
  ...
  if (sqlQuery2._16_8_ != 0) {
    ...
    if (iVar2 == 1) {
      iVar3 = 1;
      FillPortalInterfaceElement
                ((SQLQuery *)sqlQuery2,(PortalInterfaceElement *)(self + 0x1bb8),
      ...
      if (iVar2 == 1) {
        iVar3 = 2;
        FillPortalInterfaceElement
                  ((SQLQuery *)sqlQuery2,(PortalInterfaceElement *)(self + 0x1e60),
        ...
        if (iVar2 == 1) {
          iVar3 = 3;
          FillPortalInterfaceElement
                    ((SQLQuery *)sqlQuery2,(PortalInterfaceElement *)(self + 0x2108),
          ...
          if (iVar2 == 1) {
            iVar3 = 4;
            FillPortalInterfaceElement
                      ((SQLQuery *)sqlQuery2,(PortalInterfaceElement *)(self + 0x23b0),
                       *(FlashTextField **)(self + 0xe8),0,0);
            SetAuthorText(*(FlashAnimationLibrary **)(self + 8),4,(SQLQuery *)sqlQuery2);
            iVar2 = SQLResultSet__NextRow((SQLResultSet *)sqlQuery2._16_8_);
            if (iVar2 == 1) {
              FillPortalInterfaceElement
                        ((SQLQuery *)sqlQuery2,(PortalInterfaceElement *)(self + 0x2658),
...

{
  if (*(int *)(self + 0x376c) != 3) {
    return *(uint64_t *)
            (GetOrderingParam()::strOrderingParamString + (long)*(int *)(self + 0x3704) * 8);
  }
  return *(uint64_t *)
          (GetOrderingParam()::strOrderingParamString + (long)*(int *)(self + 0x3704) * 8);
}
...

{
  ...
  *(uint32_t *)(self + 0x1908) = 0xffffffff;
  ...
  if (*(long *)(*plVar2 + -0x18) == 0) {
    iVar1 = *(int *)(self + 0x376c);
    if (iVar1 == 3) {
      Sprint("SELECT *, times_died / times_played AS difficulty, raw_fun_ratings / num_fun_ratings AS fun_rating FROM smb_editor_levelinfo ORDER BY %s %s LIMIT %i, 10"
             ,strPortalUploadQuery,
             *(uint64_t *)
              (GetOrderingParam()::strOrderingParamString + (long)*(int *)(self + 0x3704) * 8),
             *(uint64_t *)
              (GetOrderingOrder()::strOrderingString + (long)*(int *)(self + 0x3700) * 8),
             *(uint32_t *)(self + 0x3768));
    }
    else if (iVar1 == 1) {
      Sprint("SELECT * FROM smb_editor_chapterinfo ORDER BY %s %s LIMIT %i, 10",strPortalUploadQuery
             ,*(uint64_t *)
               (GetOrderingParam()::strOrderingParamString + (long)*(int *)(self + 0x3704) * 8),
             *(uint64_t *)
              (GetOrderingOrder()::strOrderingString + (long)*(int *)(self + 0x3700) * 8),
      ...
      Sprint("SELECT smb_editor_chapterinfo.* FROM smb_editor_chapterinfo INNER JOIN smb_editor_recommendedchapters ON\t\t\t\t\t\t\t\t\t   smb_editor_recommendedchapters.chapter_id = smb_editor_chapterinfo.chapter_id ORDER BY RAND() LIMIT %i, 10"
...

{
  ...
  *(uint64_t *)(self + 0x3730) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"unknown");
  *(uint64_t *)(self + 0x3740) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"featured");
  ...
  *(uint64_t *)(self + 0x20) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"loadin");
  *(uint64_t *)(self + 0x10) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"loadout");
  *(uint64_t *)(self + 0x18) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"loading");
  *(uint64_t *)(self + 0x3748) = uVar2;
  uVar2 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"cursor");
  ...
  *(uint64_t *)(self + 200) = uVar2;
  ...
  plVar5 = (long *)FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"fun");
  iVar1 = 0;
  local_a8 = self;
  do {
    iVar15 = iVar1 + 1;
    ...
    *(EditorButton **)(local_a8 + 0x128) = pEVar6;
    EditorButton__SetButtonProps
              (pEVar6,SMBLevelPortalLevelPress,self + lVar14 + 0x120,(_func_void_void_ptr *)0x0,
               (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
    pFVar7 = (FlashLibraryInstance *)
             FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),local_48);
    pFVar8 = (FlashMovieClip *)
             FlashAnimationLibrary__GetLibraryEntry
                       (*(FlashAnimationLibrary **)(self + 8),*(int *)(pFVar7 + 0x20));
    AddPostLineRenderItem
              ("icon2",pFVar7,pFVar8,pFVar3,*(FlashAnimationLibrary **)(self + 8),
               (FlashLibraryInstance *)(self + lVar14 + 0x130));
    AddPostLineRenderItem
              ("icon1",pFVar7,pFVar8,pFVar3,*(FlashAnimationLibrary **)(self + 8),
               (FlashLibraryInstance *)(self + lVar14 + 0x1d0));
    AddPostLineRenderItem
              ("difficultybar",pFVar7,pFVar8,pFVar3,*(FlashAnimationLibrary **)(self + 8),
               (FlashLibraryInstance *)(self + lVar14 + 0x310));
    iVar1 = 0;
    AddPostLineRenderItem
              ("fun",pFVar7,pFVar8,pFVar3,*(FlashAnimationLibrary **)(self + 8),
  ...
  *(uint64_t *)(self + 0x3658) = uVar2;
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3650),SMBLevelPortalBigLevelButtonPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3658),SMBLevelPortalUnknownPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3648),SMBLevelPortalFeaturedPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"levelportal");
  *(EditorButton **)(self + 0x3690) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalLevelButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"chapterportal");
  *(EditorButton **)(self + 0x3698) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalChapterButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  ...
  *(EditorButton **)(self + 0x36a0) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalRecommendedButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  ...
  *(EditorButton **)(self + 14000) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBEditorButtonOrderSwitch,(void *)0x1,(_func_void_void_ptr *)0x0,(void *)0x0,
  ...
  *(EditorButton **)(self + 0x36b8) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBEditorButtonOrderSwitch,(void *)0x3,(_func_void_void_ptr *)0x0,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0);
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"funfactor");
  *(EditorButton **)(self + 0x36c0) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBEditorButtonOrderSwitch,(void *)0x2,(_func_void_void_ptr *)0x0,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0);
  ...
  *(EditorButton **)(self + 0x36d8) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalPrevButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0
             ,(_func_void_void_ptr *)0x0,(void *)0x0);
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"arrowright");
  *(EditorButton **)(self + 0x36e0) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalNextButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0
             ,(_func_void_void_ptr *)0x0,(void *)0x0);
  FlashAnimationLibrary__SetTextFieldText(*(char **)(self + 8),"next",&DAT_005c7bfc /* R:"Next" */);
  FlashAnimationLibrary__SetTextFieldText(*(char **)(self + 8),"previous","Previous");
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),&DAT_005c7af3 /* R:u32=1392537447 */);
  *(EditorButton **)(self + 0x36e8) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalSearchPress,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0);
  uVar2 = AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"textfield1");
  *(uint64_t *)(self + 0x36f0) = uVar2;
  pFVar11 = (FlashEditableTextField *)
            FlashAnimationLibrary__GetUITextField(*(FlashAnimationLibrary **)(self + 8),1);
  EditorTextField__SetTextField(*(EditorTextField **)(self + 0x36f0),pFVar11);
  pFVar3 = (FlashMovieClip *)
           FlashAnimationLibrary__GetLibraryEntry
                     (*(FlashAnimationLibrary **)(self + 8),
                      *(int *)(*(long *)(self + 0x3738) + 0x20));
  uVar2 = *(uint64_t *)(self + 8);
  uVar10 = AddEditorButton(pFVar3,uVar2,"featuredbutton");
  ...
  *(uint64_t *)(self + 0x3670) = uVar2;
  ...
  lVar12 = FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),"icons");
  ...
  *(uint32_t *)(lVar14 + 0x20) = 0xffffffff;
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3668),SMBLevelPortalBigLevelButtonPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3670),SMBLevelPortalUnknownPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3660),SMBLevelPortalFeaturedPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  pEVar6 = (EditorButton *)AddEditorButton(pFVar3,*(uint64_t *)(self + 8),"webbutton");
  *(EditorButton **)(self + 0x3760) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalWebButtonPress,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0);
  iVar1 = 0;
  local_a8 = self;
  do {
    ...
    *(EditorButton **)(local_a8 + 0x1bc0) = pEVar6;
    EditorButton__SetButtonProps
              (pEVar6,SMBLevelPortalLevelPress,self + lVar14 + 0x1bb8,(_func_void_void_ptr *)0x0,
               (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
    pFVar7 = (FlashLibraryInstance *)
             FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),local_48);
    pFVar8 = (FlashMovieClip *)
  ...
  do {
    ...
    *(EditorButton **)(local_a0 + 0x2908) = pEVar6;
    EditorButton__SetButtonProps
              (pEVar6,SMBLevelPortalLevelPress,self + lVar14 + 0x2900,(_func_void_void_ptr *)0x0,
               (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
    pFVar7 = (FlashLibraryInstance *)
             FlashAnimationLibrary__GetMovieClip__005731d0(*(FlashAnimationLibrary **)(self + 8),local_48);
    pFVar8 = (FlashMovieClip *)
  ...
  uVar10 = FlashAnimationLibrary__GetLibraryEntry
                     (*(FlashAnimationLibrary **)(self + 8),
  ...
  *(uint64_t *)(self + 0x3688) = uVar2;
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3680),SMBLevelPortalBigLevelButtonPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3688),SMBLevelPortalUnknownPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  EditorButton__SetButtonProps
            (*(EditorButton **)(self + 0x3678),SMBLevelPortalFeaturedPress,(void *)0x0,
             (_func_void_void_ptr *)0x0,(void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  ...
  *(EditorButton **)(self + 0x3708) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalUnknownDifficultyPress,(void *)0x0,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  Sprint("difbar%i",local_88,2);
  pEVar6 = (EditorButton *)AddEditorButton(uVar10,*(uint64_t *)(self + 8),local_88);
  *(EditorButton **)(self + 0x3710) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalUnknownDifficultyPress,(void *)0x1,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  Sprint("difbar%i",local_88,3);
  pEVar6 = (EditorButton *)AddEditorButton(uVar10,*(uint64_t *)(self + 8),local_88);
  *(EditorButton **)(self + 0x3718) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalUnknownDifficultyPress,(void *)0x2,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  Sprint("difbar%i",local_88,4);
  pEVar6 = (EditorButton *)AddEditorButton(uVar10,*(uint64_t *)(self + 8),local_88);
  *(EditorButton **)(self + 0x3720) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalUnknownDifficultyPress,(void *)0x3,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  Sprint("difbar%i",local_88,5);
  pEVar6 = (EditorButton *)AddEditorButton(uVar10,*(uint64_t *)(self + 8),local_88);
  *(EditorButton **)(self + 0x3728) = pEVar6;
  EditorButton__SetButtonProps
            (pEVar6,SMBLevelPortalUnknownDifficultyPress,(void *)0x4,(_func_void_void_ptr *)0x0,
             (void *)0x0,(_func_void_void_ptr *)0x0,(void *)0x0);
  FlashAnimationLibrary__SetTextFieldText
            (*(char **)(self + 8),"difficulty1","I\'m Too young to die");
  FlashAnimationLibrary__SetTextFieldText(*(char **)(self + 8),"difficulty2","Hey, not too rough");
