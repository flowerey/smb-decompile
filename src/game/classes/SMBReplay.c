  ...
  if (*(int *)(self + ((long)*(int *)(self + 0x38) + 4) * 0x10 + 8) < 0x870) {
    if ((((4 < *(int *)(self + 0x2d8)) || (arg1 == 1)) ||
      ...
      *(int *)(self + ((long)iVar6 + 4) * 0x10 + 8) =
      ...
      if (arg1 == 1) {
        lVar2 =
            *(long *)(self + ((long)iVar6 + 4) * 0x10 + 0x10) + (long)*(int *)(self + 0x18) * 0xc;
...
void __thiscall SMBReplay__GetReplayFrameByIndex(SMBReplay *self, int arg1, SMBReplayFrame *arg2,
                                                 int arg3)

{
  ...
  *(ushort *)arg2 = *(ushort *)arg2 & 0xf87f | (ushort)*puVar1 & 0x780;
  ...
  arg2[1] = (SMBReplayFrame)((byte)SVar2 & 0x87 | bVar3 | bVar4 | bVar5 |
                             *(byte *)((long)puVar1 + 1) & 0x40);
  *(uint *)arg2 = *(uint *)arg2 & 0xfffc7fff | *puVar1 & 0x38000;
  arg2[2] = (SMBReplayFrame)((byte)arg2[2] & 0xe3 | *(byte *)((long)puVar1 + 2) & 0x1c);
  *(ushort *)(arg2 + 2) = *(ushort *)(arg2 + 2) & 0xfe1f | *(ushort *)((long)puVar1 + 2) & 0x1e0;
  SVar2 = arg2[3];
  ...
  arg2[3] = (SMBReplayFrame)((byte)SVar2 & 1 | bVar3 | bVar4 | bVar5 | bVar6 |
                             *(byte *)((long)puVar1 + 3) & 0x80);
...

{
  ...
  iVar3 = *arg2;
  if ((int)(*(ushort *)(*(long *)(self + ((long)arg1 + 4) * 0x10 + 0x10) + (long)*arg3 * 0xc + 2) >>
                5 &
            0xf) <= iVar3) {
    *arg2 = 0;
    *arg3 = *arg3 + 1;
  ...
  if (0 < (int)uVar7) {
    ...
    if ((uVar7 < 7) || (uVar18 == 0)) {
      ...
      do {
        ...
        iVar21 = iVar21 + *(int *)pSVar2 * _DAT_005c89f0 /* R:1.6815581571897805e-44f */ +
                 _DAT_005c5d50 /* R:5.605193857299268e-45f */;
        iVar22 = iVar22 + *(int *)pSVar1 * _UNK_005c89f4 + _UNK_005c5d54;
        iVar23 =
            iVar23 + (int)((auVar20._8_8_ & 0xffffffff) * (ulong)_UNK_005c89f8) + _UNK_005c5d58;
...
void __thiscall SMBReplay__GetReplayFileHeader(SMBReplay *self, SMBReplayFileCreate *arg1, int arg2,
                                               File *arg3, File *arg4, SystemFileTime *arg5)
