...

{
  ...
  if (*(int *)(SuperMeatBoy + 0x2c) != 2) {
    ...
    Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_c8,
                          (Vector2 *)&local_98, 0.0);
    TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(SuperMeatBoy + 0x40), (Vector2 *)&local_c8,
                                      local_a8, (int *)local_78, (int *)local_48);
    local_88 = 0x3f800000;
    local_84 = 0x3f800000;
    ...
    TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(SuperMeatBoy + 0x40), (Vector2 *)&local_c8,
                                      local_a8, (int *)local_68, (int *)local_58);
              ...
              if ((int)plVar4[0x10] != 0) {
                if (*plVar4 != 0) {
                  ...
                  *(int *)(*(long *)(*(long *)(self + 0x28) + lVar2) + 0x40) =
                  ...
                  pFVar5 = (FlashLibraryEntry *)FlashAnimationLibrary__GetLibraryEntry(
                      *(FlashAnimationLibrary **)(*(long *)(*(long *)(self + 0x28) + lVar2) + 0x28),
                      *(int *)(*(long *)(*(long *)(self + 0x28) + lVar2) + 0x20));
                  fVar9 = (float)FlashLibraryEntry__GetDuration(pFVar5);
                  fVar10 =
                      *(float *)(Engine + 0x38) + *(float *)(*(long *)(self + 0x28) + lVar2 + 0x18);
                  if (fVar10 <= fVar9) {
                    fVar9 = fVar10;
                  }
                ...
                if (plVar4[4] != 0) {
                  ...
                  *(uint32_t *)(*(long *)(*(long *)(self + 0x28) + lVar2 + 0x20) + 0x40) =
                  ...
                  pFVar5 = (FlashLibraryEntry *)FlashAnimationLibrary__GetLibraryEntry(
                      *(FlashAnimationLibrary **)(lVar1 + 0x28), *(int *)(lVar1 + 0x20));
                  fVar9 = (float)FlashLibraryEntry__GetDuration(pFVar5);
                  fVar10 =
                      *(float *)(Engine + 0x38) + *(float *)(*(long *)(self + 0x28) + lVar2 + 0x38);
                  if (fVar10 <= fVar9) {
                    fVar9 = fVar10;
                  }
                ...
                if (plVar4[8] != 0) {
                  ...
                  *(uint32_t *)(*(long *)(*(long *)(self + 0x28) + lVar2 + 0x40) + 0x40) =
                  ...
                  fVar9 = (float)FlashLibraryEntry__GetDuration(pFVar5);
                  fVar10 =
                      *(float *)(Engine + 0x38) + *(float *)(*(long *)(self + 0x28) + lVar2 + 0x58);
                  if (fVar10 <= fVar9) {
                    fVar9 = fVar10;
                  }
                ...
                if (plVar4[0xc] != 0) {
                  ...
                  *(uint32_t *)(*(long *)(*(long *)(self + 0x28) + lVar2 + 0x60) + 0x40) =
                  ...
                  fVar9 = (float)FlashLibraryEntry__GetDuration(pFVar5);
                  fVar10 =
                      *(float *)(Engine + 0x38) + *(float *)(lVar2 + *(long *)(self + 0x28) + 0x78);
                  if (fVar10 <= fVar9) {
                    fVar9 = fVar10;
                  }
...
void __thiscall BloodyTiles__AddBloodyTile(BloodyTiles *self, GRIDBLOCK *arg1, int arg3,
                                           Vector2 *arg4, int arg5, uint64_t arg6)
      ...
      if (iVar3 == 1) {
        ...
        LAB_00463ecb:
          ...
          if (arg3 != 8)
            goto LAB_00463b64;
        LAB_00463cc6:
          local_68 = (float)((uint)TileLevel__fLevelGridWH ^ DAT_005be6f0 /* R:u32=2147483648 */) *
