...

{
  ...
  if (*(int *)(self + 0x70) == -0x5eef3582) {
      ...
      *(void **)(self + 0x60) = pvVar4;
      if (pvVar1 != (void *)0x0) {
        ...
        *(void **)(self + 0x68) = pvVar4;
        if (uVar8 <= uVar3) goto LAB_0057c7f7;
        while( true ) {
          uVar12 = (ulong)uVar3;
          uVar3 = uVar3 + 1;
    ...
    *(uint32_t *)(self + 0x58) = 0;
    ...
    if (pvVar4 != (void *)0x0) {
      puVar14 = (uint64_t *)
                ((long)pvVar4 + 0x10U + (uVar12 - ((long)pvVar4 + 0x10U) % uVar12) % uVar12);
      puVar14[-2] = 0x2a8;
      puVar14[-1] = pvVar4;
    }
...
LAB_0057c809:
  ...
  *(BaseResource **)
   ((ulong)*(ushort *)(*(long *)(pRVar15 + 0x40) + lVar9) * 0x88 + *(long *)(pRVar15 + 0x38) + 0x80)
       = arg1;
...
LAB_0057cc69:
  ...
  if ((BaseResource *)puVar9[0x10] == arg1) {
    ...
    do {
      puVar8 = puVar3 + 0x11;
      uVar4 = uVar4 + 1;
      if (uVar4 == uVar12) goto LAB_0057cc69;
      plVar1 = puVar3 + 0x21;
      puVar3 = puVar8;
  ...
  if (*(int *)(self + 0x58) == 1) {
    ...
    if (*(ushort *)(self + 0x52) == 0) goto LAB_0057cc8e;
    uVar11 = 0xffffffff;
    uVar10 = 0xffffffff;
    uVar6 = 0;
    do {
...
uint64_t __thiscall
ResourcePool__SetCacheName(ResourcePool *self,BaseResource *arg1,char *arg2)
        ...
        if (uVar16 != 0) {
          ...
          if (plVar3 == (long *)puVar13[0x10]) {
            ...
            do {
              puVar11 = puVar4 + 0x11;
              uVar6 = uVar6 + 1;
              if (uVar6 == uVar16) goto LAB_0057cf69;
              puVar1 = puVar4 + 0x21;
              puVar4 = puVar11;
          ...
          if (*(int *)(pCVar5 + 0x58) == 1) {
            ...
            if (*(ushort *)(pCVar5 + 0x52) == 0) goto LAB_0057cfdf;
            uVar15 = 0xffffffff;
            uVar14 = 0xffffffff;
            uVar10 = 0;
            do {
