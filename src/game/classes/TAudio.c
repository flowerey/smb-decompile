...
LAB_00578818:
        ...
        if ((int)(uint)*(ushort *)(self + 0x90) <= (int)(uVar11 + 1)) goto LAB_005788ff;
      }
      lVar19 = *(long *)(self + 0xa0);
      puVar14 = *(uint64_t **)(lVar19 + uVar12 * 8);
      if ((*(byte *)(puVar14 + 1) & 1) == 0) goto LAB_00578818;
      ...
      if ((uVar11 + 1 < (uint)uVar17) && ((int)uVar11 < (int)(uVar17 - 1))) {
        ...
        while( true ) {
          ...
          *puVar1 = *(uint64_t *)(lVar19 + lVar8);
          uVar17 = *(ushort *)(self + 0x90);
          if ((int)(uVar17 - 1) <= (int)uVar10) break;
          lVar19 = *(long *)(self + 0xa0);
        }
      }
        ...
        do {
          while( true ) {
            ...
            *puVar2 = 0xffff;
            ...
            uVar17 = uVar17 + 1;
            if (uVar18 <= uVar17) goto LAB_005789ea;
          }
        ...
        *plVar4 = 0;
        if (pMusicInstances._40_2_ != 0) {
          ...
          if (plVar4 == *(long **)pMusicInstances._56_8_) {
            ...
            do {
              uVar17 = uVar17 + 1;
              if (uVar17 == pMusicInstances._40_2_) goto LAB_00578b15;
              puVar14 = puVar14 + 1;
  ...
  if (plVar4 != (long *)0x0) {
    if ((*(int *)((long)plVar4 + 0x1c) == 0) &&
      ...
      if (((*plVar4 != 0) && (*(int *)(self + 100) == 1)) && (pfVar5 != (float *)0xffffffff)) {
        ...
        uVar15 = (uint)((DAT_005be894 /* R:1.0f */ -
                        ((*(float *)(self + 0x54) - pfVar5[1]) *
                         (*(float *)(self + 0x54) - pfVar5[1]) +
                         (*(float *)(self + 0x50) - *pfVar5) * (*(float *)(self + 0x50) - *pfVar5) +
                         (*(float *)(self + 0x58) - pfVar5[2]) *
                         (*(float *)(self + 0x58) - pfVar5[2]) +
                        (*(float *)(self + 0x5c) - pfVar5[3]) *
                        (*(float *)(self + 0x5c) - pfVar5[3])) / *(float *)(self + 0x60)) *
                       (float)uVar11);
        if ((int)uVar15 < 0) {
          uVar15 = 0;
        }
...
LAB_00578a8b:
  ...
  uVar10 = uVar10 + 1;
  if ((int)uVar11 <= (int)uVar10) goto LAB_0057890e;
  pbVar13 = *(byte **)(self + 0x38);
  goto LAB_00578a60;
}
...
LAB_00578db3:
    ...
    if (*plVar1 == 0) goto LAB_00578dba;
    *(uint *)(plVar1 + 1) = arg1;
    if ((int)plVar1[4] != 0) goto LAB_00578db3;
    uVar3 = uVar3 + 1;
      ...
      if (arg1 == 0) {
        ...
        while( true ) {
          ...
          if (((((*pbVar1 & 1) != 0) && (plVar11 != (long *)0x0)) &&
              (*(int *)((long)plVar11 + 0x1c) == 0)) && (plVar11[2] != 0xffffffff)) break;
          uVar6 = (int)uVar10 + 1;
          uVar10 = (ulong)uVar6;
          if ((int)uVar12 <= (int)uVar6) goto LAB_00578f70;
        }
      }
        ...
        *plVar11 = 0;
        if (pMusicInstances._40_2_ != 0) {
          ...
          if (plVar11 == *(long **)pMusicInstances._56_8_) {
            ...
            do {
              uVar4 = uVar4 + 1;
              if (uVar4 == pMusicInstances._40_2_) goto LAB_00578ec5;
              puVar8 = puVar8 + 1;
            ...
            do {
              while( true ) {
                ...
                *puVar2 = 0xffff;
                uVar13 = uVar13 + 1;
                uVar4 = pMusicInstances._42_2_;
                if ((ushort)pMusicInstances._42_2_ <= uVar13) goto LAB_00579037;
              }
        ...
        do {
          while( true ) {
            ...
            *puVar2 = 0xffff;
            ...
            uVar4 = uVar4 + 1;
            if (uVar13 <= uVar4) goto LAB_005790af;
          }
            ...
            *plVar4 = 0;
            if (pMusicInstances._40_2_ != 0) {
              ...
              if (plVar4 == *(long **)pMusicInstances._56_8_) {
                ...
                do {
                  uVar7 = uVar7 + 1;
                  if (uVar7 == pMusicInstances._40_2_) goto LAB_00579245;
                  puVar11 = puVar11 + 1;
          ...
          do {
            while( true ) {
              ...
              *puVar1 = 0xffff;
              ...
              uVar7 = uVar7 + 1;
              if (uVar15 <= uVar7) goto LAB_00579347;
            }
            ...
            *plVar3 = 0;
            if (pMusicInstances._40_2_ != 0) {
              ...
              if (plVar3 == *(long **)pMusicInstances._56_8_) {
                ...
                do {
                  uVar6 = uVar6 + 1;
                  if (uVar6 == pMusicInstances._40_2_) goto LAB_00579535;
                  puVar10 = puVar10 + 1;
          ...
          do {
            while( true ) {
              ...
              *puVar1 = 0xffff;
              ...
              uVar6 = uVar6 + 1;
              if (uVar14 <= uVar6) goto LAB_00579624;
            }
      ...
      *(void **)(self + 0xa0) = pvVar3;
      if (pvVar1 != (void *)0x0) {
        ...
        *(void **)(self + 0xa8) = pvVar3;
        if (uVar8 <= uVar2) goto LAB_00579818;
        while( true ) {
          uVar6 = (ulong)uVar2;
          uVar2 = uVar2 + 1;
...
LAB_00579818:
  if ((*(int *)(self + 0x98) == 1) && (*(short *)(self + 0x92) != 0)) {
    ...
    while (uVar8 != 0xffff) {
      puVar4 = puVar4 + 1;
      sVar7 = sVar7 + 1;
      if (sVar7 == *(short *)(self + 0x92)) goto LAB_00579821;
      uVar8 = *puVar4;
    }
    *puVar4 = uVar2;
    uVar2 = *(ushort *)(self + 0x90);
    ...
    *(uint64_t *)arg1 = 0;
    if (pMusicInstances._40_2_ != 0) {
      ...
      if (*(TAudioInstance **)pMusicInstances._56_8_ == arg1) {
        ...
        do {
          uVar4 = uVar4 + 1;
          if (uVar4 == pMusicInstances._40_2_) goto LAB_00579b01;
          plVar8 = plVar8 + 1;
...

{
  ...
  if (*(int *)(self + 0x48) == -0x5eef3582) {
      ...
      *(void **)(self + 0x38) = pvVar4;
      if (pvVar2 != (void *)0x0) {
        ...
        *(void **)(self + 0x40) = pvVar4;
        if (uVar8 <= uVar12) goto LAB_00579d04;
        while( true ) {
          uVar9 = (ulong)uVar12;
          uVar12 = uVar12 + 1;
    ...
    *(uint32_t *)(self + 0x30) = 0;
    ...
    if (pvVar4 != (void *)0x0) {
      puVar11 = (uint64_t *)
                ((long)pvVar4 + 0x10U + (uVar9 - ((long)pvVar4 + 0x10U) % uVar9) % uVar9);
      puVar11[-2] = 0x50;
      puVar11[-1] = pvVar4;
    }
...
joined_r0x00579ea7:
  if ((iVar1 == 1) && (*(short *)(self + 0x2a) != 0)) {
    ...
    while (uVar8 != 0xffff) {
      puVar10 = puVar10 + 1;
      if (sVar3 == *(short *)(self + 0x2a)) goto LAB_00579d0e;
      sVar3 = sVar3 + 1;
      uVar8 = *puVar10;
    }
    *puVar10 = uVar12;
  ...
  if (arg1 != (TAudioInstance *)0x0) {
    ...
    while (sVar5 != 0) {
      ...
      while( true ) {
        ...
        if ((int)(uint)*(ushort *)(self + 0x90) <= (int)(uVar9 + 1)) goto LAB_00579fc0;
      }
    ...
    if (uVar6 != 0) {
      ...
      do {
        while (arg1 !=
          ...
          uVar9 = uVar9 + 1;
          if ((int)(uint)uVar6 <= (int)uVar9) goto LAB_0057a008;
        }
        *(uint64_t *)arg1 = 0;
        uVar6 = *(ushort *)(self + 0x28);
        uVar9 = uVar9 + 1;
...
void __thiscall
TAudio__DecodeConsoleADPCMData
          (TAudio *self,AudioFile *arg1,uchar **arg2,TWAVEFORMATEX *arg3,uint *arg4,
          uint *arg5)
