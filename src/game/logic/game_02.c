...

{
  ...
  self = SMBMenu;
  *(uint32_t *)(SuperMeatBoyPortal + 0x1c) =
       *(uint32_t *)(pUnknownDifficulty + (long)arg1 * 4);
  ...
  *(uint64_t *)(self + 0x68) = 0xffffffffffffffff;
  ...
  if (iVar1 == 1) {
    ...
    *(uint32_t *)(puVar3 + 0x15) = 0xffffffff;
    ...
    SQLResultSet__GetString(local_d8,(SQLFieldName *)&local_68,(char **)(puVar3 + 0x14),(uint *)0x0)
    ;
...
void SMBReplay__GetReplayFileHeader
               (SMBReplayFileCreate *arg1,int arg2,File *arg3,File *arg4,
               SystemFileTime *arg5)
...

{
  if ((((arg1 == (tagButtonProps *)0x0) ||
      ...
      (*(int *)(SuperMeatBoy + 0x2c) != 9)) && (*(int *)(SuperMeatBoy + 0x3a0) == 0)) {
...

{
  ...
  if ((1 < *(int *)(SuperMeatBoy + 0x294)) && (*(int *)(SuperMeatBoy + 0x294) != 3)) {
    SMBChapter__ShowLivesScreen
              ((SMBChapter *)(SuperMeatBoy + 0x90),*(int *)(*(long *)(SuperMeatBoy + 0x48) + 0x7f8))
    ;
    self = SMBHUD;
    *(uint32_t *)(SuperMeatBoy + 0x2c) = 0;
    GMeatHUD__ShowInGameHud(self);
...

{
  ...
  if (*(int *)(*(long *)(SuperMeatBoy + 0x48) + 0xa54) != 7) {
    ...
    if ((((iVar6 != 1) && (*(int *)(*(long *)(SuperMeatBoy + 0x48) + 0xa54) != 0xe)) &&
        (*(int *)(SuperMeatBoy + 0x290) != 9)) && (DAT_005be6e4 /* R:0.5f */ < *(float *)(SMBHUD + 0x418))) {
...

{
  ...
  self = (Joystick *)TPlayer__GetJoystick((TPlayer *)Players__Player);
  Joystick__RestoreCallbacks
            (self,(InputCallback **)&pPrePauseButtonCallbacks,
             (InputCallback **)&pPrePausePOVCallbacks);
  if (Keyboard != (TKeyboard *)0x0) {
    TKeyboard__RestoreCallbacks(Keyboard,(InputCallback **)&pPrePauseKeyboardCallbacks);
  }
...
void FlashLibraryInstance__TimelineRender
               (float arg1,float arg2,ColorTemplate *arg3,ColorTemplate *arg4,
               FlashLibraryInstance *arg5)
...
LAB_00573726:
  ...
  if ((*(long *)(arg3 + 0x88) == 0) || (arg2 <= DAT_005bf760 /* R:0.0f */)) {
    ...
    Matrix4x4__Transformation2DSkew
              (pMVar9,(Vector2 *)(arg3 + 0x40),(Vector2 *)(arg3 + 0x48),(Vector2 *)0x0);
    pMVar9 = (Matrix4x4 *)TGraphics__GetMatrix(Graphics,0);
    ...
    *(uint32_t *)(pMVar9 + 0x2c) = *(uint32_t *)(arg3 + 0x38);
    ...
    uStack_b0 = CONCAT44((float)((ulong)*(uint64_t *)(arg3 + 0x7c) >> 0x20) *
                         ...
                         (float)*(uint64_t *)(arg3 + 0x7c) *
                         (float)*(uint64_t *)(arg5 + 8));
    ...
    *(float *)(pMVar9 + 0x2c) = fVar6 * fVar10 + fVar2 * arg2;
    ...
    local_b8 = CONCAT44((*(float *)(arg3 + 0x78) * fVar10 + *(float *)(lVar7 + 0x78) * arg2) *
                        *(float *)(arg5 + 4),
                        (*(float *)(arg3 + 0x74) * fVar10 + *(float *)(lVar7 + 0x74) * arg2) *
                        *(float *)arg5);
  ...
  plVar8 = *(long **)(*(long *)(*(long *)(arg3 + 0x28) + 0x48) +
                     (ulong)*(ushort *)(arg3 + 0x20) * 8);
...

{
  ...
  local_28 = 0;
  local_40 = 0x10;
  local_48 = (ulong)*(ushort *)((long)arg1 + 0x38) * (ulong)*(ushort *)((long)arg1 + 0x3a) *
             0x60;
  ...
  *puVar3 = uVar8;
  if (lVar14 != -1) {
    ...
    if (uVar11 != 0) {
      ...
      if (uVar8 == uVar11) goto LAB_0058f740;
    }
    ...
    if (uVar6 != 0) {
      ...
      if (uVar8 - uVar11 == uVar6 * 4) goto LAB_0058f740;
    }
    lVar9 = 0;
    do {
  ...
  if (arg1 != 0) {
    ...
    do {
      *(uint32_t *)(*(long *)self + lVar14 * 4) = 1;
      ...
      lVar14 = lVar14 + 1;
      *(uint32_t *)
       (*(long *)self + (long)(int)((uint)*(ushort *)(self + 0x38) * (uVar15 - 1) + iVar16) * 4) = 1
      ;
...

{
  ...
  local_11c = arg3;
  pvVar4 = operator_new__((long)(int)((uint)*(ushort *)(arg1 + 0x38) *
                                      (uint)*(ushort *)(arg1 + 0x3a) * 3) << 2);
  lVar12 = 0;
    ...
    if (iVar7 != 0) {
      ...
      do {
        while ((piVar1[lVar5] == iVar9 && (uVar11 < 0x3ff))) {
          lVar5 = lVar5 + 1;
          uVar11 = uVar11 + 1;
          if (iVar7 <= (int)lVar5) goto LAB_0058fb61;
        }
...

{
  ...
  *(uint32_t *)(this_00 + 0x19a0) = 1;
  ...
  uVar18 = (ulong)(int)((uint)*(ushort *)(this_00 + 0x38) * (uint)*(ushort *)(this_00 + 0x3a) * 3);
  ...
  *puVar6 = uVar18;
  ...
  if (lVar21 != -1) {
    ...
    if (uVar9 != 0) {
      ...
      if (uVar18 == uVar9) goto LAB_00590910;
    }
    ...
    if (uVar13 != 0) {
      ...
      if (uVar18 - uVar9 == uVar13 * 4) goto LAB_00590910;
    }
    lVar15 = 0;
    do {
...
LAB_00590910:
  ...
  *(uint32_t *)(this_00 + 0x19a0) = 1;
  puVar2 = (uint32_t *)
           ((long)puVar6 +
           (long)(int)((uint)*(ushort *)(this_00 + 0x38) * (uint)*(ushort *)(this_00 + 0x3a)) * 4);
...
LAB_00590c56:
            ...
            if (uVar23 != 0) {
              ...
              uVar4 = uVar4 + uVar26;
              if (uVar24 - uVar25 == uVar26) goto LAB_00590cbe;
            }
            ...
            if (uVar23 != uVar25) goto LAB_00590c56;
          }
LAB_00590cbe:
          iVar3 = iVar3 + uVar24;
        }
...

{
  ...
  if (local_98[0] + 0xabb3cfcfU < 2) {
    ...
    if (local_98[0] == 0x544c3032) {
      ...
      uVar3 = 0;
      if (local_78[0] != 0x54454e44) goto LAB_00591881;
  ...
  if (local_48[0] == 0xff) {
    ...
    if ((local_68[0] < 0x1f5) && (local_58[0] < 0x1f5)) {
      ...
      puVar4 = &local_b8;
      do {
        if ((uint)local_68[0] * (uint)local_58[0] < *puVar4) goto LAB_00592020;
        if (0 < (int)*puVar4) {
          iVar2 = 0;
          do {
            File__ReadVariable(local_118,local_78,4);
                  ...
                  if (local_d0 < 0x191) {
                    ...
                    if (local_cc < 0x191) {
                      ...
                      do {
                        if (0 < *piVar5) {
                          uVar3 = 0;
                          if (400 < iVar2) goto LAB_00591881;
                          while( true ) {
                            local_1c0 = 0;
                            local_1b8 = 0;
                    ...
                    /* try { // try from 00591df0 to 00591df4 has its CatchHandler @ 005920e2 */
                            ...
                            if (*piVar5 <= (int)uVar3) break;
                            if (iVar2 == 0x191) goto LAB_00592020;
                          }
                        }
                        piVar5 = piVar5 + 1;
  ...
  if (arg2 != 0) {
    ...
    while( true ) {
      *(uint *)(lVar1 + 0x2c + lVar2) = arg3;
      lVar2 = lVar2 + 0x30;
      if (lVar2 == ((ulong)(arg2 - 1) * 3 + 3) * 0x10) break;
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 != '\0') {
      ...
      lVar4 = (**(code **)(*plVar3 + 0xe0))
                        (plVar3,*(uint64_t *)CONCAT71(in_register_00000031,arg2),uVar7,iVar5,
                         iVar6);
