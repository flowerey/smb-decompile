 ...
 */
void failf(uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint64_t arg5, uint64_t arg6,
           uint64_t arg7, uint64_t arg8, uint32_t *arg9, uint64_t arg10, uint64_t arg11,
...

{
  ...
  if (*arg1 == 0) {
    ...
    if (*arg1 != 0)
      goto LAB_0052063c;
    local_98 =
        (uint64_t *)(**(code **)(arg1 + 2))((long)arg1[0xec] * 0x18, *(uint64_t *)(arg1 + 6));
    ...
    for (lVar7 = *(long *)(arg1 + 0x116); lVar7 != 0; lVar7 = *(long *)(lVar7 + 0x20)) {
      if ((*(int *)(lVar7 + 0x18) != 0) &&
          (lVar19 = (**(code **)(*(long *)(arg1 + 0x32) + 0x60))(arg1, *(uint32_t *)(lVar7 + 4),
                                                                 *(uint32_t *)(lVar7 + 8)),
           lVar19 != 0)) {
        *puVar14 = 0;
            ...
            do {
              ...
              LAB_00520d80:
                ...
                LAB_00520d8d:
                  *puVar17 = puVar10[2];
                  puVar17[1] = puVar10[3];
                  uVar9 = (**(code **)(*(long *)(arg1 + 0x32) + 0x58))(arg1, *puVar10, puVar10[1]);
                  local_b0 = local_b0 + 1;
                ...
                do {
                  if ((*puVar17 < 10) && ((1L << ((byte)*puVar17 & 0x3f) & 0x370U) != 0)) {
                    *puVar15 = puVar17[2];
                    puVar15[1] = puVar17[3];
                    uVar9 =
                        (**(code **)(*(long *)(arg1 + 0x32) + 0x58))(arg1, *puVar17, puVar17[1]);
                    local_9c = local_9c + 1;
  ...
  if (puVar10 != (uint *)0x0) {
    if (local_9c != 0) {
      ...
      do {
        lVar3 = lVar19 + 8;
        lVar19 = lVar19 + 0x10;
        (**(code **)(arg1 + 4))(*(uint64_t *)((long)puVar10 + lVar3), *(uint64_t *)(arg1 + 6));
...

{
  ...
  *arg9 = 1;
  if (arg9[1] == 0) {
    ...
    local_98 = arg13;
    local_90 = arg14;
    errorlist_add_va(*(uint64_t *)(arg9 + 0xc), *(uint64_t *)(arg9 + 8), arg9[10], arg10,
                     &local_d0);
  }
  return;
}
 ...
 */
uint32_t errorlist_add_va(long arg1, char *arg2, uint32_t arg3, char *arg4, uint64_t *arg5)
...

{
  ...
  puVar3 = (uint64_t *)0x0;
  if ((*(int *)(arg1 + 0x28) != 0) &&
      (puVar3 = (uint64_t *)(**(code **)(arg1 + 0x30))(*(int *)(arg1 + 0x28) * 0x18,
                                                       *(uint64_t *)(arg1 + 0x40)),
       puVar3 != (uint64_t *)0x0)) {
 ...
 */
void buffer_append_fmt(uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint64_t arg5,
 ...
 */
void close_define_include(uint64_t arg1, uint64_t arg2, code *UNRECOVERED_JUMPTABLE, uint64_t arg4)
 ...
 */
void failf(uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint64_t arg5, uint64_t arg6,
           uint64_t arg7, uint64_t arg8, uint32_t *arg9, char *arg10, uint64_t arg11,
           uint64_t arg12, uint64_t arg13, uint64_t arg14)
...

{
  ...
  LAB_0053927e:
    ...
    if (!bVar9) {
      ...
      if (bVar9) {
        (**(code **)(arg1 + 0x968))(*(uint64_t *)(*(long *)(arg1 + 0x940) + 8),
                                    *(uint64_t *)(arg1 + 0x970));
    ...
    if (!bVar9)
      goto LAB_0053927e;
    (**(code **)(arg1 + 0x968))(*(uint64_t *)(*(long *)(arg1 + 0x938) + 8),
                                *(uint64_t *)(arg1 + 0x970));
  ...
  if (pActiveCues._40_2_ != 0) {
    do {
      ...
      if (pvVar3 != (void *)0x0) {
        ...
        if ((piVar11 != (int *)0x0) &&
            (iVar12 = *piVar11, *piVar11 = iVar12 + -1, iVar12 + -1 == 0)) {
        ...
        do {
          while (true) {
            ...
            *puVar2 = 0xffff;
            uVar9 = uVar9 + 1;
            uVar13 = pActiveCues._42_2_;
            if ((ushort)pActiveCues._42_2_ <= uVar9)
              goto LAB_0053e515;
          }
          uVar8 = *puVar2 - 1;
          if (uVar8 < 0xfffe) {
      ...
      if (0 < local_48[2]) {
        ...
        if ((*puVar3 & 1) == 0) {
          ...
          do {
            local_50 = 0;
            local_58 = (void *)0x0;
            AudioFile__GetStreamingData(*(AudioFile **)(*(long *)(puVar3 + 2) + 0x20),
  ...
  *puVar3 = *(uint32_t *)arg1;
  ...
  if (pActiveCues._72_4_ == -0x5eef3582) {
    if ((ushort)pActiveCues._42_2_ <= (ushort)pActiveCues._40_2_) {
      ...
      if (pvVar9 != (void *)0x0) {
        pvVar4 =
            (void *)((long)pvVar9 + 0x10U + (uVar12 - ((long)pvVar9 + 0x10U) % uVar12) % uVar12);
    ...
    if (pvVar4 != (void *)0x0) {
      puVar14 =
          (uint64_t *)((long)pvVar4 + 0x10U + (uVar13 - ((long)pvVar4 + 0x10U) % uVar13) % uVar13);
      puVar14[-2] = 0x28;
      puVar14[-1] = pvVar4;
    }
        ...
        do {
          while (true) {
            ...
            *puVar1 = 0xffff;
            uVar10 = uVar10 + 1;
            uVar7 = pActiveCues._42_2_;
            if ((ushort)pActiveCues._42_2_ <= uVar10)
              goto LAB_0053ee83;
          }
      ...
      if ((&pVoices)[lVar5 * 8] == 0) {
        ...
        if ((iVar3 == 0) && (iVar3 = (&pVoices)[lVar5 * 8], iVar3 != 0)) {
          ...
          if ((*arg1 & 1) == 0) {
            ...
            AudioFile__GetStreamingData(*(AudioFile **)(*(long *)(arg1 + 8) + 0x20),
                                        (AudioStreamData *)&local_58);
          ...
          alSourcef((float)arg2 * DAT_005c07b0 /* R:0.009999999776482582f */, (&pVoices)[lVar5 * 8],
                    0x100a);
    ...
    if (2 < uVar14) {
      ...
      *(uint *)(arg1 + 0xe) =
          ((uint) * (byte *)(arg1[10] + (ulong)(*(uint *)((long)arg1 + 0x9c) + 1)) ^
           uVar11 << ((byte)(int)arg1[0x10] & 0x1f)) &
          *(uint *)((long)arg1 + 0x7c);
      if (0x105 < uVar14) {
        return;
      }
  ...
  LAB_00566718:
    ...
    if ((iVar15 != 0) && (iVar13 == 0)) {
      ...
      do {
        ...
        *arg1 = lVar5 + 1;
        iVar10 = iVar11;
        if ((iVar15 == 1) || (iVar15 = iVar15 + -1, iVar10 = iVar13, iVar11 != 0))
          break;
      } while (true);
    }
  }
    ...
    if (lVar24 == 0) {
      ...
      do {
        ...
        if (iVar21 <= iVar14) {
          ...
          *(long *)(arg1 + 0x1710) =
              *(long *)(arg1 + 0x1710) +
              (long)(int)(iVar25 + (uint) * (ushort *)(lVar24 + 2 + (long)iVar21 * 4)) *
                  (ulong)uVar6;
        }
        iVar28 = iVar28 + 1;
      } while (iVar28 != 0x23d);
...
void convert_samples_short(int arg1, short **arg2, int arg3, int arg4, float **arg5, int arg6,
                           int arg7)

{
  ...
  if (((arg1 == arg4) || (2 < arg1)) || (6 < arg4)) {
    ...
    do {
      ...
      uVar3 = *(uint *)(convert_samples_short(int, short **, int, int, float **, int,
...
void convert_channels_short_interleaved(int arg1, short *arg2, int arg3, float **arg4, int arg5,
                                        int arg6)
              ...
              do {
                while (bVar12 = channel_position[lVar14 + (long)arg3 * 6] & 6, bVar12 != 6) {
                  if (bVar12 == 2) {
                    ...
                    lVar15 = 0;
                    do {
                      local_b8[lVar15 * 2 + 1] = *(float *)((long)pfVar22 + lVar15 * 4 + lVar25) +
                                                 local_b8[lVar15 * 2 + 1];
                      lVar15 = lVar15 + 1;
                    } while ((int)lVar15 < (int)uVar23);
                  }
                ...
                do {
                  uVar21 = uVar21 + 1;
                  local_b8[iVar16] = local_b8[iVar16] +
