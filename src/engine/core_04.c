...

{
  ...
  if (*(uint *)(arg2 + 0xa4c) == 0xffffffff) {
    pFVar6 = *(FlashLibraryInstance **)(*(long *)(arg1 + lVar1 + 0x40) +
                                        (ulong) * (ushort *)(arg1 + lVar1 + 0x58) * 8);
  } else {
    pFVar6 = *(FlashLibraryInstance **)(*(long *)(arg1 + lVar1 + 0x40) +
                                        (ulong)(*(uint *)(arg2 + 0xa4c) & 0xffff) * 8);
  }
  *(uint32_t *)(pFVar6 + 0x58) = *(uint32_t *)(arg2 + 0xa50);
  ...
  if (uVar4 == 0xffffffff) {
    ...
    pFVar6 =
        *(FlashLibraryInstance **)(*(long *)(arg1 + lVar1 + 0x40) + (ulong)(uVar4 & 0xffff) * 8);
  }
  *(uint32_t *)(pFVar6 + 0x58) = uVar5;
  ...
  if (((((byte)arg2[0x7d9] & 2) == 0) || (iVar3 == 0x15)) || (iVar3 == 0x14)) {
    *(uint32_t *)(arg2 + 0xd8) = 0;
    Vector2__operator_mul_assign__005be220((Vector2 *)&local_38,
                                           (Vector2 *)(arg2 + (long)iVar3 * 8 + 0x8d4));
  } else if ((*(ushort *)(arg2 + 0x7da) & 0x7ff) == 0) {
    Matrix4x4__ConvertToRotationMatrix(local_78, DAT_005c07ac /* R:0.7853981852531433f */);
    Matrix4x4__TransformVector2((Vector2 *)&local_38,
                                (Vector2 *)(arg2 + (long)*(int *)(arg2 + 0x7d4) * 8 + 0x8d4),
                                local_78, 1);
...

{
  ...
  LAB_004a6600:
    ...
    if ((*(int *)arg1 == 1) && (local_38[0] != (Light *)0x0)) {
      ...
      TileLevelLightMap__CreateLight(*(TileLevelLightMap **)(SuperMeatBoy + 0x390),
                                     (Light *)&local_68);
      uVar5 = TileLevelLightMap__CreateLight(*(TileLevelLightMap **)(SuperMeatBoy + 0x390),
                                             (Light *)&local_68);
...

{
  ...
  LAB_004a7a08:
    if ((PlaceCameraItems(tagButtonProps_const *, void *)::vStartWorldPos == '\0') &&
        (iVar3 =
             __cxa_guard_acquire(&PlaceCameraItems(tagButtonProps_const *, void *)::vStartWorldPos),
         iVar3 != 0)) {
      ...
      __cxa_atexit(FPUVector__FPUVector,
                   &PlaceCameraItems(tagButtonProps_const *, void *)::vStartWorldPos,
                   &__dso_handle);
    }
    ...
    if (*(int *)arg1 == 1) {
      ...
      if (bVar5) {
        Vector2__operator_assign(
            (Vector2 *)(*(long *)(SuperMeatBoy + 0x40) + 0x22bc),
            (Vector2 *)&PlaceCameraItems(tagButtonProps_const *, void *)::vStartWorldPos);
        Vector2__operator_assign(
            (Vector2 *)(*(long *)(SuperMeatBoy + 0x40) + 0x22b4),
            (Vector2 *)&PlaceCameraItems(tagButtonProps_const *, void *)::vStartWorldPos);
      } else {
        local_b8 = 0;
        local_b4 = 0;
        local_b0 = 0;
        local_ac = 0;
        Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_b8,
                              (Vector2 *)&local_88, 0.0);
        local_e0 = 0xc3fa0000;
        local_d0 = 0;
        local_78 = local_b8;
        ...
        local_74 = local_b4;
        local_d8 = 0;
        TileLevel__SnapPositionToCenter(*(TileLevel **)(SuperMeatBoy + 0x40), (Vector2 *)&local_78,
                                        DAT_005be894 /* R:1.0f */);
        local_e8 = local_78;
        local_e4 = local_74;
        SMBCamera__AddWayPoint(*(SMBCamera **)(SuperMeatBoy + 0x38),
                               (SMBCameraWayPoint *)&local_e8);
      }
    } else if (*(int *)arg1 == 2) {
      if (!bVar5) {
        local_98 = 0;
        ...
        local_38 = local_88;
        local_34 = local_84;
        Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_98,
                              (Vector2 *)&local_38, 0.0);
        return;
      }
      local_a8 = 0.0;
      ...
      local_48 = local_88;
      local_44 = local_84;
      Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_a8,
...

{
  ...
  LAB_004a88c8:
    if (*(int *)arg1 == 1) {
      ...
      Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_a8,
                            (Vector2 *)&local_88, 0.0);
      Matrix4x4__Transformation2DRot(local_128, (Vector2 *)(vTileScale + (long)iSelectedScale * 8),
                                     (float *)(fTileRotations + (long)iSelectedRotation * 4),
                                     (Vector2 *)&local_a8);
      ...
      if (pCopiedBlocks._40_2_ != 0) {
        ...
        do {
          ...
          LAB_004a8b5f:
            ...
            cVar3 = '\0';
            if ((local_12c != 0.0) &&
                (cVar3 = '\x01', local_12c != DAT_005c1408 /* R:1.5707963705062866f */)) {
              if (local_12c == DAT_005c4898 /* R:3.1415927410125732f */)
                goto LAB_004a8b5f;
          ...
          uVar4 = uVar4 + 1;
          local_38._0_2_ = CONCAT11(
              bVar1 | bVar2 << 6 | (cVar3 + (char)iSelectedRotation & 3U) << 4, (uint8_t)local_38);
          Matrix4x4__TransformVector2(local_58, (Vector2 *)(pCopiedBlocks._56_8_ + lVar8),
                                      local_128, 1);
          TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(SuperMeatBoy + 0x40), local_58,
                                            local_68, &local_30, local_2c);
          TileLevel__GetGridBlock(*(TileLevel **)(SuperMeatBoy + 0x40), local_30, local_2c[0],
                                  *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
          TileLevel__PlaceTile(*(TileLevel **)(SuperMeatBoy + 0x40), local_30, local_2c[0],
                               &local_38, *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
...

{
  ...
  LAB_004a8d62:
    if (bSetPieceWayPointMode != 1) {
      AutoLockSection__AutoLockSection(local_48,
      ...
      if (*(int *)arg1 == 1) {
        ...
        if (pCopiedSetPieces._40_2_ != 0) {
          ...
          do {
            ...
            TileLevel__PlaceSetPiece(*(TileLevel **)(SuperMeatBoy + 0x40), aTStack_c8,
                                     *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
...
LAB_004a91ea:
  if ((iVar4 == 0 && iVar5 == 0) && !bVar2) {
    if ((*(int *)arg1 == 1) && (bSetPieceWayPointMode == 1)) {
      this = (SetPieceWayPointGroup *)GSetPieceWayPoints__GetWayPointGroup(
          SetPieceWayPoints, (TileLevelSetPiece *)**(uint64_t **)(SuperMeatBoyEditor + 0xa8));
      ...
      AutoLockSection__AutoLockSection(aAStack_58,
                                       (CriticalSection *)RenderLayers__MasterRenderSection);
        ...
        if (*(short *)(SuperMeatBoyEditor + 0x98) != 0) {
          ...
          do {
            ...
            GSetPieceWayPoints__ClearWayPointGroup(
                SetPieceWayPoints,
                *(TileLevelSetPiece **)(*(long *)(lVar3 + 0xa8) + (ulong)(uVar8 & 0xffff) * 8));
...

{
  ...
  LAB_004a96a2:
    if (((iVar2 == 0 && iVar3 == 0) && !bVar1) && (*(int *)(SuperMeatBoy + 0x2c) == 1)) {
      ...
      Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_58,
                            (Vector2 *)&local_38, 0.0);
      TileLevel__GetGridIndex__0058dd90(*(TileLevel **)(SuperMeatBoy + 0x40), (Vector2 *)&local_58,
                                        local_48, &local_20, &local_1c);
      ...
      if (uVar5 != 0) {
        ...
        while (true) {
          if ((*(uint *)(pSelectionIDX + ((long)((int)lVar3 * iVar6) + (uVar9 >> 2)) * 4) &
               1 << ((byte)uVar9 & 0x1f)) != 0) {
            pGVar4 = (GRIDBLOCK *)TileLevel__GetGridBlock(pTVar8, uVar9 & 0xffffffff, iVar6,
                                                          *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
...

{
  ...
  if ((iVar4 == 1) || ((iVar4 = TKeyboard__GetExclusiveState(Keyboard, 0x7f),
                        iVar4 == 2 && (0x32 < *(uint *)(Keyboard + 0x608))))) {
  ...
  if ((iVar4 == 2) || ((iVar4 = TKeyboard__GetExclusiveState(Keyboard, 0x1f),
                        iVar4 == 2 && (0x32 < *(uint *)(Keyboard + 0x188))))) {
    local_1c = fVar7;
  }
  ...
  if (iVar4 != 2) {
    ...
    iVar4 = TKeyboard__GetExclusiveState(Keyboard, 0x6d);
    local_20 = 0.0;
    if ((iVar4 != 2) || (*(uint *)(Keyboard + 0x530) < 0x33))
      goto LAB_004aa4e0;
  }
  fVar7 = 0.0;
...
LAB_004aa4e0:
  ...
  if ((iVar4 == 2) || ((iVar4 = TKeyboard__GetExclusiveState(Keyboard, 0x41),
                        iVar4 == 2 && (0x32 < *(uint *)(Keyboard + 800))))) {
    local_20 = fVar7;
  }
  lVar3 = SuperMeatBoyEditor;
  ...
  LAB_004b1b28:
    ...
    if (bSetPieceWayPointMode == 1) {
      if (iVar13 == 1) {
        ...
        this_00 = (SetPieceWayPointGroup *)GSetPieceWayPoints__GetWayPointGroup(SetPieceWayPoints,
                                                                                pTVar5);
        if ((((*(int *)(Keyboard + 0x334) != 2) && (*(int *)(Keyboard + 0x544) != 2)) &&
             (*(int *)(Keyboard + 0x310) != 2)) &&
            (*(int *)(Keyboard + 0x514) != 2)) {
          if (this_00 == (SetPieceWayPointGroup *)0x0) {
            this_00 = (SetPieceWayPointGroup *)GSetPieceWayPoints__CreateNewWayPointGroup(
                SetPieceWayPoints, pTVar5, 1);
          }
          SetPieceWayPointGroup__AddWayPoint__0059c660(
              this_00, (FPUVector *)(SuperMeatBoyEditor + 0x2c),
              (Vector2 *)(SuperMeatBoyEditor + 0x3c), *(float *)(SuperMeatBoyEditor + 0x44), 0.0);
          return;
        }
        if (this_00 == (SetPieceWayPointGroup *)0x0) {
          return;
      ...
      if (((*(int *)(Keyboard + 0x334) != 2) && (*(int *)(Keyboard + 0x544) != 2)) &&
        ...
        TileLevel__PlaceSetPiece(*(TileLevel **)(SuperMeatBoy + 0x40), local_198,
                                 *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
        ...
        if ((((iVar13 != 0) && (bSetPieceWayPointMode != 1)) &&
              ...
              *(int *)pSVar1 == 1)) &&
            (uVar10 = *(ushort *)(pSVar7 + 0x9a), uVar10 != 0)) {
          lVar15 = 0;
          do {
      ...
      local_120 = 0;
      local_11c = 0;
      Camera__ScreenToWorld(*(Camera **)(SuperMeatBoy + 0x38), (FPUVector *)&local_128,
        ...
        do {
          if (*(long *)(pTVar28 + 0x60) != 0) {
            ...
            if ((((byte)TVar3 & 2) == 0) && (lVar15 == *(long *)(pTVar28 + 0x18))) {
              if (iVar4 == 4) {
                if (((byte)TVar3 & 0x30) == 0x10)
                  goto LAB_004b253a;
              } else if (iVar4 == 5) {
                if (((byte)TVar3 & 0x30) == 0x30)
                  goto LAB_004b253a;
              } else if (iVar4 == 2) {
                if (((byte)TVar3 & 1) == 0) {
                LAB_004b253a:
                  ...
                  local_104 =
                      *(float *)(pTVar5 + (long)(pTVar28 + (0x38 - (long)pTVar5))) * local_a4 +
                      local_b4;
                  ...
                  if ((((fVar34 < fVar36) && (*(float *)(this + 0x108) <= fVar34 &&
                                              fVar34 != *(float *)(this + 0x108))) &&
                       (local_98 < *(float *)(Mouse + 0xc))) &&
                      (((fVar35 =
                             (float)(*(uint *)(Mouse + 0x10) ^ DAT_005be6f0 /* R:u32=2147483648 */),
                         local_94 < fVar35 && (*(float *)(Mouse + 0xc) < local_88)) &&
                        (fVar35 < local_84)))) {
                    fVar36 = fVar34;
                    local_c8[0] = pTVar28;
                  }
                }
              } else if ((iVar4 == 1) && (((byte)TVar3 & 1) != 0))
                goto LAB_004b253a;
            }
          }
    ...
    if (iVar13 == 2) {
      if (((*(int *)(Keyboard + 0x334) == 2) || (*(int *)(Keyboard + 0x544) == 2)) ||
        ...
        Camera__WorldToScreen(*(Camera **)(SuperMeatBoy + 0x38), (Vector2 *)&local_68,
                              (FPUVector *)&local_e8);
            ...
            if (*(long *)(lVar15 + 0x60) != 0) {
              ...
              if (((bVar2 & 2) == 0) && (lVar18 == *(long *)(lVar15 + 0x18))) {
                if (iVar4 == 4) {
                  ...
                  if ((bVar2 & 1) == 0) {
                  LAB_004b2400:
                    Camera__WorldToScreen(*(Camera **)(SuperMeatBoy + 0x38), (Vector2 *)&local_58,
                    ...
                    if ((((local_68 < local_58) && (local_58 < fVar36)) ||
                        ...
                        (((local_64 < local_54 && (local_54 < fVar34)) ||
                          (((float)(DAT_005be6f0 /* R:u32=2147483648 */ ^ uVar11) < local_54 &&
                            (local_54 < local_64)))))) {
                      if ((*(int *)(Keyboard + 0x334) == 2) || (*(int *)(Keyboard + 0x544) == 2)) {
                        if (pTempSetSelection._40_2_ == 0) {
                        LAB_004b28f0:
                          if (pTempSetSelection._72_4_ == -0x5eef3582) {
                            if ((ushort)pTempSetSelection._42_2_ <=
                                (ushort)pTempSetSelection._40_2_) {
                              ...
                              if (pvVar20 != (void *)0x0) {
                                pvVar14 =
                                    (void *)((long)pvVar20 + 0x10U +
                                             (uVar17 - ((long)pvVar20 + 0x10U) % uVar17) % uVar17);
                            ...
                            if (pvVar14 != (void *)0x0) {
                              puVar25 = (uint64_t *)((uVar31 - ((long)pvVar14 + 0x10U) % uVar31) %
                                                         uVar31 +
                                                     (long)pvVar14 + 0x10U);
                              puVar25[-1] = pvVar14;
                              puVar25[-2] = 0x28;
                          ...
                          if ((pTempSetSelection._48_4_ == 1) && (pTempSetSelection._42_2_ != 0)) {
                            ...
                            while (sVar9 != -1) {
                              psVar29 = psVar29 + 1;
                              if (sVar22 == pTempSetSelection._42_2_)
                                goto LAB_004b29ae;
                              sVar22 = sVar22 + 1;
                              sVar9 = *psVar29;
                            }
                        ...
                        LAB_004b29ae:
                          *(long *)(pTempSetSelection._56_8_ +
                          ...
                          while (lVar15 != lVar19) {
                            sVar9 = sVar9 + 1;
                            if (sVar9 == pTempSetSelection._40_2_)
                              goto LAB_004b28f0;
                            plVar23 = plVar23 + 1;
                            lVar19 = *plVar23;
                          }
          ...
          LAB_004b1bbd:
            if (*(int *)(SuperMeatBoyEditor + 0xb8) == -0x5eef3582) {
              if (*(ushort *)(SuperMeatBoyEditor + 0x9a) <= uVar21) {
                uVar10 =
                    *(ushort *)(SuperMeatBoyEditor + 0x9a) + *(short *)(SuperMeatBoyEditor + 0xa4);
              ...
              *(uint32_t *)(SuperMeatBoyEditor + 0xa0) = 0;
              ...
              puVar25 = (uint64_t *)0x0;
              if (pvVar14 != (void *)0x0) {
                puVar25 = (uint64_t *)((uVar17 - ((long)pvVar14 + 0x10U) % uVar17) % uVar17 +
                                       (long)pvVar14 + 0x10U);
                puVar25[-2] = 0x28;
                puVar25[-1] = pvVar14;
              }
          ...
          LAB_004b1c7a:
            ...
            *(short *)(pSVar7 + 0x98) = *(short *)(pSVar7 + 0x98) + 1;
            ...
            if (((*(int *)(SuperMeatBoyEditor + 0xa0) == 1) &&
              ...
              lVar15 = 0;
              do {
                if (lVar15 == (ulong)(*(ushort *)(SuperMeatBoyEditor + 0x9a) - 1) * 2)
                  break;
                lVar15 = lVar15 + 2;
              } while (uVar8 !=
                       *(ushort *)((long)*(ushort **)(SuperMeatBoyEditor + 0xb0) + lVar15));
            }
          }
          uVar11 = (int)uVar31 + 1;
          uVar31 = (ulong)uVar11;
...

{
  ...
  if ((bVar5 & 2) != 0) {
    ...
    (**(code **)(**(long **)(*(long *)(arg1 + 0x40) + (ulong) * (byte *)(lVar15 + 0x20) * 8) +
                 0x10))();
  ...
  LAB_004ddaa1:
    ...
    Matrix4x4__Transformation3D(pMVar11, (FPUVector *)&local_198, (TQuaternion *)&local_188,
                                (FPUVector *)(lVar15 + 0x24));
    ...
    local_170 = 0;
    local_16c = 0;
    local_174 = DAT_005c72c4 /* R:-101.0f */ *
                *(float *)(*(long *)(*(long *)(arg1 + 0x38) + lVar17 * 8) + 0xf4);
    local_15c = 0;
    local_168[0] = DAT_005be894 /* R:1.0f */;
    local_168[2] = DAT_005be894 /* R:1.0f */;
    pMVar11 = (Matrix4x4 *)TGraphics__GetMatrix(Graphics, 0);
    Matrix4x4__Transformation3D(pMVar11, (FPUVector *)local_168, (TQuaternion *)0x0,
                                (FPUVector *)&local_178);
    TGraphics__PushMatrix(Graphics, 0);
    local_128 = 0;
    lVar13 = *(long *)(*(long *)(*(long *)(arg1 + 0x38) + lVar17 * 8) + 0x118);
    ...
    Matrix4x4__Transformation2DRot(local_1f8, (Vector2 *)&local_118, (float *)0x0,
                                   (Vector2 *)&local_128);
    ...
    *pbVar1 = *pbVar1 | 4;
    ...
    if ((lVar13 == 0) && (*(int *)(SuperMeatBoy + 0x2c) == 1)) {
      lVar13 = TileLevel__getLevelLayer(*(TileLevel **)(SuperMeatBoy + 0x40),
                                        *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
  ...
  if ((bVar5 & 0x10) == 0) {
    ...
    TGraphics__SetRenderState(Graphics, '\x01', 7);
    IndexTexture__GetTextureWAndH(*(IndexTexture **)(arg1 + 0x70), (uint) * (byte *)(lVar15 + 0x20),
                                  (float *)&local_48, local_3c);
    bVar5 = *(byte *)(lVar15 + 0x21) >> 2;
    bVar6 = bVar5 & 3;
    local_158 = DAT_005c07a4 /* R:-1.0f */;
    local_154 = DAT_005be894 /* R:1.0f */;
    if (((bVar6 != 1) && (local_158 = DAT_005be894 /* R:1.0f */,
                          local_154 = DAT_005c07a4 /* R:-1.0f */, bVar6 != 2)) &&
        (local_158 = DAT_005be894 /* R:1.0f */, local_154 = DAT_005be894 /* R:1.0f */,
         (bVar5 & 3) != 0)) {
      local_158 = DAT_005c07a4 /* R:-1.0f */;
    ...
    local_13c = local_2a0;
    pMVar11 = (Matrix4x4 *)TGraphics__GetMatrix(Graphics, 0);
    Matrix4x4__Transformation3D(pMVar11, (FPUVector *)&local_158, (TQuaternion *)local_148,
                                (FPUVector *)(lVar15 + 0x24));
    uVar7 = IndexTexture__SetTexture(*(IndexTexture **)(arg1 + 0x70), 0xff,
                                     (uint) * (byte *)(lVar15 + 0x20), 0);
    TGraphics__SetRenderState(Graphics, '\b', 1);
    TGraphics__SetRenderState(Graphics, '\x05', 4);
    TGraphics__SetRenderState(Graphics, '\x06', 5);
    TGraphics__ResetPixelStages(Graphics);
  ...
  if (((((uVar9 == *(uint *)(arg1 + 0x4390)) || (uVar9 == *(uint *)(arg1 + 0x438c))) ||
    ...
    if (*(ushort *)(arg1 + 0x4008) != 0) {
      ...
      if (lVar15 == *plVar4) {
        ...
        do {
          uVar9 = uVar9 + 1;
          if ((int)(uint) * (ushort *)(arg1 + 0x4008) <= (int)uVar9)
            goto LAB_004de12a;
      ...
      LAB_004de899:
        if ((1 < iVar10 - 1U) && ((int)plVar19[2] != 1))
          goto LAB_004de12a;
      }
  ...
  *(uint32_t *)(plVar18 + 0xc) = *(uint32_t *)(lVar15 + 0x44);
  ...
  LAB_004deaff:
    *(float *)(plVar18 + 0xb) = fOneFrameTimeStep * *(float *)(lVar15 + 0x44) + fVar22;
    ...
    if ((*(byte *)(lVar15 + 0x21) & 0x20) != 0) {
    LAB_004dec42:
      iVar10 = IsBoundsTouchingBounds((Bounds *)(*(long *)(SuperMeatBoy + 0x38) + 0x140),
                                      (Bounds *)local_298);
      if (iVar10 != 1) {
  ...
  if (*(int *)(SuperMeatBoy + 0x2c) == 2) {
    *(float *)(lVar15 + 0x40) = fVar21;
    ...
    if ((((uint)bVar5 == *(uint *)(pPalProps + 0x3c)) ||
         ((uint)bVar5 == *(uint *)(pPalProps + 0x38))) ||
        ((uVar9 = (uint)bVar5,
          uVar9 == *(uint *)(pPalProps + 0x44) || ((uVar9 == *(uint *)(pPalProps + 0x34) ||
                                                    (uVar9 == *(uint *)(pPalProps + 0x40))))))) {
...
float FlashTextField__Render(float arg1, ColorTemplate *arg2, ColorTemplate *arg3,
...

{
  ...
  if (*(int *)(arg2 + 0x20) != 0) {
    ...
    Matrix4x4__Transformation2DRot(pMVar5, (Vector2 *)&local_48, (float *)0x0,
                                   (Vector2 *)&local_38);
    TGraphics__PushMatrix(Graphics, 0);
    ...
    *(float *)(lVar4 + 0x48) = fVar6 + fVar3;
    FontEmitter__SetFontSizeActualPixels(*(FontEmitter **)(arg2 + 0x18), *(float *)(in_RCX + 0x40));
...

{
  ...
  if (pAnimCallbacks._40_2_ != 0) {
    uVar5 = 0;
    do {
      while (*(FlashLibraryInstance **)(pAnimCallbacks._56_8_ + 0x10 +
                                        (ulong)(uVar5 & 0xffff) * 0x28) == arg1) {
...
void FlashTimeline__Render(float arg1, ColorTemplate *arg2, ColorTemplate *arg3,
                           FlashLibraryInstance *arg4)
  ...
  *(uint32_t *)(arg2 + 4) = 1;
  if (*(int *)arg2 == 1) {
    ...
    if (fVar12 <= arg1) {
      fVar13 = arg1 / fVar12;
      fVar14 = fVar13;
      if ((float)((uint)fVar13 & DAT_005be880 /* R:u32=2147483647 */) <
    ...
    *(uint32_t *)(arg2 + 4) = 0;
    arg1 = *(float *)(arg2 + 8) -
           DAT_005be894 /* R:1.0f */ / *(float *)(*(long *)(arg2 + 0x20) + 0x80);
  }
  iVar6 = *(int *)(arg2 + 0x14);
  if (iVar6 < 1) {
    return;
...
LAB_00575dc0:
        ...
        if ((bVar3) && (arg1 <= fVar12)) {
          if (pfVar10 != (float *)0x0) {
            ...
            if ((((*pbVar2 & 1) == 0) || (pfVar10[3] == -NAN)) ||
                ((bGlobalAnimationPause != 0 && (pbVar2[0x8c] != 1))))
              goto LAB_00575ed0;
            iVar6 = 0;
            fVar12 = 0.0;
            goto LAB_00575e83;
  ...
  FlashSoundLibrary__Play((FlashSoundLibrary *)(pbVar2 + 0x90), (int)pfVar10[3], (int)pfVar10[4],
                          (int)pfVar10[5], pAudioPosition);
LAB_00575ed0:
  local_44 = 0.0;
...
void FlashMovieClip__Render(float arg1, ColorTemplate *arg2, ColorTemplate *arg3,
                            FlashLibraryInstance *arg4)
  ...
  if (iVar3 < 1) {
    ...
    do {
      ...
      if (((iVar4 != -1) && (local_54 <= local_74)) && (local_50 <= local_70)) {
        if ((uVar1 == local_50) && (uVar5 == local_54))
          goto LAB_00582212;
...
{
  if ((DAT_00824bc0 /* R:1.1880522271401808e-38f */ != (code *)0x0) &&
      (DAT_00824be8 /* R:4.0283126953945516e-41f */ == 2)) {
...
{
  if ((DAT_00824bc8 /* R:3.363116314379561e-44f */ != (code *)0x0) &&
      (DAT_00824be8 /* R:4.0283126953945516e-41f */ == 2)) {
...
void CCallback < Achievements, UserStatsReceived_t,
    false__Run(void *arg1)
...
void CCallback < Achievements, UserStatsReceived_t,
    false__Run(void *arg1, bool arg2, ulonglong arg3)
...
void BroadcastString__RegisterBroadcastStringParamDB(BroadcastStringParamDatabase *arg1, int arg2)
...

{
  ...
  fVar3 = auVar4._0_4_;
  fVar2 =
      (fVar2 * fVar3 * fVar3 + _DAT_005dedb4 /* R:-3.0f */) * fVar3 * DAT_005c0e00 /* R:-0.5f */;
