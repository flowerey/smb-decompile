...

{
  ...
  if (*(int *)(arg1 + 0x130) == 0) {
    ...
    if (*(int *)(arg1 + 0x174) == 10) {
      if (*(int *)(arg1 + 0x170) != 0) goto LAB_0051d480;
      if (*(uint *)(arg1 + 0x2a8) < 3) goto LAB_0051d4a5;
...

{
  ...
  if ((((((int)uVar2 >> 2 ^ uVar2) & 3) == 0) && ((((int)uVar2 >> 2 ^ (int)uVar2 >> 4) & 3U) == 0))
...

{
  ...
  if (arg3 != (char *)0x0) {
    sVar1 = strlen(arg3);
    __dest_00 = (char *)(**(code **)(arg1 + 0x30))
                                  ((int)sVar1 + 1,*(uint64_t *)(arg1 + 0x40));
  }
  if (__dest == (char *)0x0) {
    uVar2 = 0xffffffff;
  }
 ...
 */
uint64_t
stringcache_fmt(uint64_t arg1,uint64_t arg2,uint64_t arg3,uint64_t arg4,
               uint64_t arg5,uint64_t arg6,uint64_t arg7,uint64_t arg8,
               long arg9,char *arg10,uint64_t arg11,uint64_t arg12,
 ...
 */
uint32_t
update_state(long arg1,int arg2,long arg3,uint8_t *arg4,uint32_t arg5)
        ...
        if (uVar2 == 0) {
          ...
          *(int *)(arg1 + 0x2c) = iVar6;
          if (*(short *)(arg1 + 0x24) != 0) {
            lVar10 = 0;
            do {
              *(uint16_t *)(lVar8 + uVar14 + lVar10 * 2) =
                   *(uint16_t *)(arg1 + lVar10 * 8 + 0x54);
              iVar6 = (int)lVar10;
              lVar10 = lVar10 + 1;
...
LAB_0053dcb9:
        ...
        if (iVar6 == 1) {
          ...
          if (*(short *)(arg1 + 0x24) != 0) {
            lVar10 = 0;
            do {
              *(uint16_t *)(uVar14 + lVar8 + lVar10 * 2) =
                   *(uint16_t *)(arg1 + lVar10 * 8 + 0x52);
              iVar6 = (int)lVar10;
              lVar10 = lVar10 + 1;
            } while (iVar6 + 1 < (int)(uint)*(ushort *)(arg1 + 0x24));
            goto LAB_0053dcb9;
          ...
          if (*(short *)(arg1 + 0x24) == 0) {
            ...
            if (uVar2 != 0) {
              ...
              do {
                lVar10 = lVar8 * 8;
                iVar6 = (int)*(short *)(arg1 + lVar10 + 0x54) *
                        (int)*(short *)(arg1 +
                                       ((ulong)(byte)arg1[lVar10 + 0x4e] + 0xc) * 4 + 4) +
                        (int)*(short *)(arg1 + lVar10 + 0x52) *
                        (int)*(short *)(arg1 +
                                       ((ulong)(byte)arg1[lVar10 + 0x4e] + 0xc) * 4 + 2);
                if (iVar6 < 0) {
                  iVar6 = iVar6 + 0xff;
                }
                if (*(int *)(arg1 + 0x60) == 0) {
                  ...
                  *(byte **)(arg1 + 8) = *(byte **)(arg1 + 8) + 1;
                  ...
                  iVar6 = (uint)*(ushort *)(arg1 + lVar10 + 0x50) *
                          *(int *)(do_adpcm_nibble(unsigned_char,ADPCMBLOCKHEADER*,int)::
                                   AdaptionTable + (long)(int)uVar15 * 4);
                }
                else {
                  *(uint32_t *)(arg1 + 0x60) = 0;
                  uVar15 = uVar13 & 0xf;
...

{
  ...
  if (uVar4 == 0) {
    ...
    *(uint *)(lVar1 + 0x34) = uVar4;
    ...
    if (uVar4 <= uVar3) goto LAB_0056a358;
  }
  else {
    uVar3 = arg2 - *(int *)(arg1 + 0x20);
    if (uVar4 <= uVar3) {
