...

{
  ...
  bVar14 = 0;
  local_30 = 0;
  puVar4 = (uint32_t *)TileLevel__GetGridBlock(
      *(TileLevel **)(SuperMeatBoy + 0x40), CONCAT44(in_register_00000034, arg2),
      CONCAT44(in_register_00000014, arg3), *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
  local_30 = *puVar4;
  if ((char)local_30 != '\0') {
    ...
    if (pCopiedBlocks._72_4_ == -0x5eef3582) {
      if ((ushort)pCopiedBlocks._42_2_ <= (ushort)pCopiedBlocks._40_2_) {
        ...
        if (pvVar7 != (void *)0x0) {
          pvVar5 =
              (void *)((long)pvVar7 + 0x10U + (uVar10 - ((long)pvVar7 + 0x10U) % uVar10) % uVar10);
      ...
      if (pvVar5 != (void *)0x0) {
        puVar11 = (uint64_t *)((long)pvVar5 + 0x10U +
...

{
  ...
  if (uVar17 != 0) {
    ...
    while (true) {
      ...
      if ((int)uVar17 <= iVar8)
        break;
      pLVar5 =
          *(LevelRenderLayer **)(pLayerColorTweens._56_8_ + 0x10 + (ulong)(ushort)iVar8 * 0x18);
    }
  }
  if (pLayerColorTweens._72_4_ != -0x5eef3582) {
    ...
    if (pvVar10 != (void *)0x0) {
      puVar18 = (uint64_t *)((long)pvVar10 + 0x10U +
                             (uVar16 - ((long)pvVar10 + 0x10U) % uVar16) % uVar16);
      puVar18[-2] = 0x78;
      puVar18[-1] = pvVar10;
    }
  ...
  if ((ushort)pLayerColorTweens._42_2_ <= (ushort)pLayerColorTweens._40_2_) {
    ...
    if (pvVar13 != (void *)0x0) {
      pvVar10 =
          (void *)((long)pvVar13 + 0x10U + (uVar16 - ((long)pvVar13 + 0x10U) % uVar16) % uVar16);
    ...
    if (pLayerColorTweens._64_8_ != 0) {
      ...
      if (pvVar13 != (void *)0x0) {
        pvVar10 =
            (void *)((long)pvVar13 + 0x10U + (uVar14 - ((long)pvVar13 + 0x10U) % uVar14) % uVar14);
        *(void **)((long)pvVar10 + -8) = pvVar13;
      ...
      if (uVar19 <= (ushort)pLayerColorTweens._40_2_)
        goto LAB_004a2ea2;
      do {
        uVar9 = uVar17 & 0xffff;
        uVar17 = uVar17 + 1;
...
LAB_004a2ea2:
  if ((pLayerColorTweens._48_4_ == 1) && (pLayerColorTweens._42_2_ != 0)) {
    ...
    while (sVar3 != -1) {
      psVar12 = psVar12 + 1;
      sVar15 = sVar15 + 1;
      if (sVar15 == pLayerColorTweens._42_2_)
        goto LAB_004a2d06;
      sVar3 = *psVar12;
    }
...
LAB_004a2d06:
  ...
  *puVar18 = 0;
  puVar18[1] = 0;
  puVar18[2] = 0;
  puVar18 = (uint64_t *)(pLayerColorTweens._56_8_ +
                         ((ulong)(ushort)pLayerColorTweens._40_2_ * 3 + -3) * 8);
  puVar18[2] = arg1;
...
uint64_t *AddEditorButton(FlashMovieClip *arg1, FlashAnimationLibrary *arg2, char *arg3, int arg4,
                          int arg5)
      ...
      if (pEditorButtons._72_4_ == -0x5eef3582) {
        if ((ushort)pEditorButtons._42_2_ <= (ushort)pEditorButtons._40_2_) {
          ...
          if (pEditorButtons._64_8_ != 0) {
            pEditorButtons._64_8_ = TMemory__AlignedReAlloc(
        ...
        if ((pEditorButtons._48_4_ == 1) && (pEditorButtons._42_2_ != 0)) {
          ...
          while (sVar1 != -1) {
            psVar7 = psVar7 + 1;
            sVar11 = sVar11 + 1;
            if (sVar11 == pEditorButtons._42_2_)
              goto LAB_004a417a;
            sVar1 = *psVar7;
          }
        ...
        if (pvVar6 != (void *)0x0) {
          puVar14 = (uint64_t *)((long)pvVar6 + 0x10U +
                                 (uVar13 - ((long)pvVar6 + 0x10U) % uVar13) % uVar13);
          puVar14[-2] = 0x28;
          puVar14[-1] = pvVar6;
        }
...

{
  ...
  if (*(short *)(SuperMeatBoyEditor + 0x98) != 0) {
    ...
    do {
      ...
      if (iVar10 != -1) {
        ...
        if (AdjustSetPieceLayering()::pObjectOrder._72_4_ == -0x5eef3582) {
          ...
          if ((ushort)AdjustSetPieceLayering()::pObjectOrder._42_2_ <=
            ...
            if (AdjustSetPieceLayering()::pObjectOrder._64_8_ != 0) {
              ...
              if (uVar8 <= (ushort)AdjustSetPieceLayering()::pObjectOrder._40_2_)
                goto LAB_004aa979;
              do {
        ...
        LAB_004aa979:
          if ((AdjustSetPieceLayering()::pObjectOrder._48_4_ == 1) &&
            ...
            while (sVar2 != -1) {
              psVar16 = psVar16 + 1;
              if (sVar7 == AdjustSetPieceLayering()::pObjectOrder._42_2_)
                goto LAB_004aa8a8;
              sVar7 = sVar7 + 1;
              sVar2 = *psVar16;
            }
          ...
          if (pvVar11 != (void *)0x0) {
            puVar15 = (uint64_t *)((uVar14 - ((long)pvVar11 + 0x10U) % uVar14) % uVar14 +
                                   (long)pvVar11 + 0x10U);
            puVar15[-2] = 0x50;
            puVar15[-1] = pvVar11;
          }
      ...
      uVar19 = (int)uVar18 + 1;
      uVar18 = (ulong)uVar19;
      if ((int)(uint) * (ushort *)(lVar12 + 0x98) <= (int)uVar19)
        goto LAB_004aabb0;
                  ...
                  if ((pRVar21 == pRVar24) || (uVar23 != 0)) {
                    if (uVar23 != 0) {
                      ...
                      RenderLayer__RemoveObject(
                          this,
                          *(RenderLayerObject **)(AdjustSetPieceLayering()::pObjectOrder._56_8_ +
                                                  8 + lVar12));
                    ...
                    RenderLayer__RemoveObject(
                        this,
                        *(RenderLayerObject **)(AdjustSetPieceLayering()::pObjectOrder._56_8_ + 8));
                    RenderLayer__InsertObjectAfter(
                        this,
                        *(RenderLayerObject **)(AdjustSetPieceLayering()::pObjectOrder._56_8_ + 8),
                        pRVar21);
...

{
  ...
  if (lVar1 != 0) {
    UITextField__SetDynamicText(pANIMALPROPgravityX, (double)*(float *)(lVar1 + 0x100),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    UITextField__SetDynamicText(pANIMALPROPgravityY, (double)*(float *)(lVar1 + 0x104),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    UITextField__SetDynamicText(pANIMALPROPvelocityX, (double)*(float *)(lVar1 + 0x108),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    UITextField__SetDynamicText(pANIMALPROPvelocityY, (double)*(float *)(lVar1 + 0x10c),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    return;
  }
  return;
...

{
  ...
  if (lVar1 != 0) {
    UITextField__SetDynamicText(pWAYPOINTPROPDuration, (double)*(float *)(lVar1 + 0x10),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    UITextField__SetDynamicText(pWAYPOINTPROPZoom, (double)*(float *)(lVar1 + 8),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    return;
  }
  return;
...

{
  ...
  UITextField__SetDynamicText(pSETPIECEPROPStartTime, (double)*(float *)(lVar1 + 0x48),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSETPIECEPROPSTimeMod, (double)*(float *)(lVar1 + 0x44),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSETPIECEPROPFloat1, (double)*(float *)(lVar1 + 0x4c),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSETPIECEPROPFloat2, (double)*(float *)(lVar1 + 0x50),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSETPIECEPROPInt1, &DAT_005c6660 /* R:5.184804318001823e-44f */,
                              (ulong) * (uint *)(lVar1 + 0x54));
  UITextField__SetDynamicText(pSETPIECEPROPInt2, &DAT_005c6660 /* R:5.184804318001823e-44f */,
                              (ulong) * (uint *)(lVar1 + 0x58));
  return;
}
...

{
  ...
  UITextField__SetDynamicText(pSMBPLAYEREFFECTFields, (double)*(float *)(lVar1 + 0x994),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ab88 /* R:6.659755029611553e-39f */,
                              (double)*(float *)(lVar1 + 0x998),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ab90 /* R:7.805232446289231e-43f */,
                              (double)*(float *)(lVar1 + 0x99c),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ab98 /* R:6.3184547756406e-42f */,
                              (double)*(float *)(lVar1 + 0x9a4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081aba0 /* R:8.457071650342278e-39f */,
                              (double)*(float *)(lVar1 + 0x9a8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081aba8 /* R:2.2420775429197073e-43f */,
                              (double)*(float *)(lVar1 + 0x9ac),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abb0 /* R:6.392723594249815e-42f */,
                              (double)*(float *)(lVar1 + 0x9b4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abb8 /* R:8.45729585809657e-39f */,
                              (double)*(float *)(lVar1 + 0x9b8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abc0 /* R:1.1210387714598537e-43f */,
                              (double)*(float *)(lVar1 + 0x9bc),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abc8 /* R:6.471196308252005e-42f */,
                              (double)*(float *)(lVar1 + 0x9c4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abd0 /* R:6.364854570391324e-39f */,
                              (double)*(float *)(lVar1 + 0x9c8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abd8 /* R:5.254869241218064e-43f */,
                              (double)*(float *)(lVar1 + 0x9cc),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abe0 /* R:2.766163168577189e-42f */,
                              (double)*(float *)(lVar1 + 0x9d4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abe8 /* R:1.1901171805572098e-38f */,
                              (double)*(float *)(lVar1 + 0x9d8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abf0 /* R:2.2420775429197073e-44f */,
                              (double)*(float *)(lVar1 + 0x9dc),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081abf8 /* R:2.781577451684762e-42f */,
                              (double)*(float *)(lVar1 + 0x9e4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac00 /* R:1.1901194226347528e-38f */,
                              (double)*(float *)(lVar1 + 0x9e8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac08 /* R:2.2420775429197073e-44f */,
                              (double)*(float *)(lVar1 + 0x9ec),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac10 /* R:2.796991734792335e-42f */,
                              (double)*(float *)(lVar1 + 0x9f4),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac18 /* R:1.1901216647122957e-38f */,
                              (double)*(float *)(lVar1 + 0x9f8),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac20 /* R:2.2420775429197073e-44f */,
                              (double)*(float *)(lVar1 + 0x9fc),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac28 /* R:2.8138073163642327e-42f */,
                              (double)*(float *)(lVar1 + 0xa04),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac30 /* R:1.1901239067898386e-38f */,
                              (double)*(float *)(lVar1 + 0xa08),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac38 /* R:2.2420775429197073e-44f */,
                              (double)*(float *)(lVar1 + 0xa0c),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac40 /* R:2.8306228979361305e-42f */,
                              (double)*(float *)(lVar1 + 0xa14),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac48 /* R:1.1901261488673815e-38f */,
                              (double)*(float *)(lVar1 + 0xa18),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(DAT_0081ac50 /* R:2.2420775429197073e-44f */,
                              (double)*(float *)(lVar1 + 0xa1c),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSMBPLAYEREFFECTWalkDelay, (double)*(float *)(lVar1 + 0xa2c),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSMBPLAYEREFFECTRunDelay, (double)*(float *)(lVar1 + 0xa24),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  UITextField__SetDynamicText(pSMBPLAYEREFFECTRunFastDelay, (double)*(float *)(lVar1 + 0xa28),
                              &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  return;
}
...

{
  ...
  do {
    ...
    iVar3 = iVar3 + 2;
    lVar6 = (long)iVar5 + 4;
    UITextField__SetDynamicText((wchar_t *)*puVar4, (double)*(float *)(lVar2 + 0x8b4 + lVar6 * 8),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
    puVar1 = puVar4 + 1;
    puVar4 = puVar4 + 2;
    UITextField__SetDynamicText((wchar_t *)*puVar1, (double)*(float *)(lVar2 + 0x8b8 + lVar6 * 8),
                                &DAT_005c48d0 /* R:5.184804318001823e-44f */);
  } while (iVar3 != 0x30);
  return;
}
...

{
  ...
  TileLevel__getLevelLayer(*(TileLevel **)(SuperMeatBoy + 0x40),
...

{
  ...
  lVar6 = TileLevel__getLevelLayer(*(TileLevel **)(SuperMeatBoy + 0x40),
                                   *(uint32_t *)(SuperMeatBoyEditor + 0xd0));
  iVar2 = StringToIntW(*(uint64_t *)(pSMBLAYERPROPRed + 0x40));
    ...
    if (*(ushort *)(arg1 + 0x2a) <= uVar5) {
      ...
      *(void **)(arg1 + 0x38) = pvVar12;
      if (pvVar6 != (void *)0x0) {
        ...
        if (pvVar7 != (void *)0x0) {
          pvVar12 =
              (void *)((long)pvVar7 + 0x10U + (uVar16 - ((long)pvVar7 + 0x10U) % uVar16) % uVar16);
          *(void **)((long)pvVar12 + -8) = pvVar7;
...

{
  ...
  if (*(int *)(arg1 + 0x48) == -0x5eef3582) {
    ...
    if (*(ushort *)(arg1 + 0x2a) <= *(ushort *)(arg1 + 0x28)) {
      ...
      *(void **)(arg1 + 0x38) = pvVar3;
      if (pvVar1 != (void *)0x0) {
        ...
        if (pvVar5 != (void *)0x0) {
          pvVar3 =
              (void *)((long)pvVar5 + 0x10U + (uVar7 - ((long)pvVar5 + 0x10U) % uVar7) % uVar7);
          *(void **)((long)pvVar3 + -8) = pvVar5;
          *(ulong *)((long)pvVar3 + -0x10) = uVar11;
          uVar7 = *(ulong *)((long)pvVar1 + -0x10);
          if (uVar11 <= *(ulong *)((long)pvVar1 + -0x10)) {
        ...
        *(void **)(arg1 + 0x40) = pvVar3;
        if (uVar12 <= *(ushort *)(arg1 + 0x28))
          goto LAB_004df478;
        while (true) {
          uVar2 = uVar9 & 0xffff;
          uVar9 = uVar9 + 1;
          *(uint16_t *)((long)pvVar3 + (ulong)uVar2 * 2) = 0xffff;
          if (uVar12 <= (ushort)uVar9)
            break;
    ...
    *(uint32_t *)(arg1 + 0x30) = 0;
    ...
    if (pvVar3 != (void *)0x0) {
      puVar4 =
          (uint64_t *)((long)pvVar3 + 0x10U + (uVar11 - ((long)pvVar3 + 0x10U) % uVar11) % uVar11);
      puVar4[-2] = 0xa0;
      puVar4[-1] = pvVar3;
    }
  ...
  if (uVar4 != 0) {
    ...
    do {
      while (true) {
        ...
        if (*(float *)(*plVar3 + 0x50) == 0.0)
          break;
        pVVar1 = (Vector2 *)(arg2 + 0xa0);
        iVar2 = TileLevel__TileLineOfSight(*(TileLevel **)(SuperMeatBoy + 0x40), pVVar1,
                                           (Vector2 *)&local_e8, local_d8);
        if (iVar2 != 0) {
          Vector2__operator_minus__005be180(local_c8, pVVar1);
          fVar9 =
              (float)Vector2__Dot((Vector2 *)(lVar8 + *(long *)(arg1 + 0x3fc8) + 0x20), local_c8);
          if (0.0 <= fVar9) {
            Vector2__operator_plus__005be140(local_b8,
                                             (Vector2 *)(lVar8 + *(long *)(arg1 + 0x3fc8) + 0x10));
            ...
            if (fVar9 < 0.0) {
              Vector2__operator_plus__005be140(
                  local_88, (Vector2 *)(lVar8 + *(long *)(arg1 + 0x3fc8) + 0x18));
              ...
              fVar9 =
                  (float)Vector2__Dot((Vector2 *)(lVar8 + *(long *)(arg1 + 0x3fc8) + 8), local_a8);
              if (fVar9 < 0.0) {
                ...
                if (0.0 < fVar9) {
                  uVar7 = 1;
                  Vector2__operator_mul__005be200(
                      local_58, *(float *)(*(long *)(lVar8 + *(long *)(arg1 + 0x3fc8)) + 0x4c));
...
LAB_004e8a57:
  if (*(short *)(arg1 + 0x41c0) != 0) {
    ...
    do {
      iVar2 =
          ApplyGravityOrbForce((SceneObject2D *)arg2,
...
void ApplyPlatformVelocity(SceneObject2D *arg1, SMBPlatform *arg2, TileCollisionInfo *arg3,
                           Vector2 *arg4)

{
  ...
  if (lVar1 != 0) {
    ...
    if ((float)(DAT_005be880 /* R:u32=2147483647 */ & (uint)fVar2) <
        (float)((uint)fVar3 & DAT_005be880 /* R:u32=2147483647 */)) {
      fVar2 = 0.0;
    } else {
      fVar3 = 0.0;
    }
...
short __thiscall ResizeableArray_SMBPlatform__Add(ResizeableArray<SMBPlatform> *this,
                                                  SMBPlatform *arg1, int arg2)

{
  ...
  if (*(int *)(this + 0x48) == -0x5eef3582) {
    ...
    *(uint32_t *)(this + 0x30) = 0;
    ...
    if (pvVar5 != (void *)0x0) {
      puVar11 =
          (uint64_t *)((long)pvVar5 + 0x10U + (uVar9 - ((long)pvVar5 + 0x10U) % uVar9) % uVar9);
      puVar11[-2] = 0x78;
      puVar11[-1] = pvVar5;
    }
    bVar13 = ((ulong)puVar11 & 1) != 0;
...
short __thiscall ResizeableArray_SMBPaletteEmitter__Add(ResizeableArray<SMBPaletteEmitter> *this,
                                                        SMBPaletteEmitter *arg1, int arg2)

{
  ...
  if (*(int *)(this + 0x48) == -0x5eef3582) {
    ...
    *(uint32_t *)(this + 0x30) = 0;
    ...
    if (pvVar2 != (void *)0x0) {
      puVar3 =
          (uint64_t *)((long)pvVar2 + 0x10U + (uVar8 - ((long)pvVar2 + 0x10U) % uVar8) % uVar8);
      puVar3[-2] = 0x50;
      puVar3[-1] = pvVar2;
    }
...
void AddPostLineRenderItem(char *arg1, FlashLibraryInstance *arg2, FlashMovieClip *arg3,
                           FlashMovieClip *arg4, FlashAnimationLibrary *arg5,
                           FlashLibraryInstance *arg6)
...

{
  ...
  puVar3[6] = fVar23;
  puVar3[7] = 0;
  if ((bVar21) && (iVar18 = __cxa_guard_acquire(
                       &ConvertSDLJoystickStateToJoyState(tagSDLJoystick *)::dwLastFrameTime),
                   iVar18 != 0)) {
...

{
  ...
  if (pAnimCallbacks._72_4_ != -0x5eef3582) {
    ...
    if (pvVar4 != (void *)0x0) {
      puVar11 =
          (uint64_t *)((long)pvVar4 + 0x10U + (uVar10 - ((long)pvVar4 + 0x10U) % uVar10) % uVar10);
      puVar11[-2] = 200;
      puVar11[-1] = pvVar4;
    }
    bVar13 = ((ulong)puVar11 & 1) != 0;
  ...
  if ((ushort)pAnimCallbacks._42_2_ <= (ushort)pAnimCallbacks._40_2_) {
    ...
    if (pAnimCallbacks._64_8_ != 0) {
      ...
      if (uVar12 <= (ushort)pAnimCallbacks._40_2_)
        goto LAB_00572405;
      do {
        uVar3 = uVar9 & 0xffff;
        uVar9 = uVar9 + 1;
...
LAB_00572405:
  if ((pAnimCallbacks._48_4_ == 1) && (pAnimCallbacks._42_2_ != 0)) {
    ...
    while (sVar1 != -1) {
      psVar5 = psVar5 + 1;
      sVar8 = sVar8 + 1;
      if (sVar8 == pAnimCallbacks._42_2_)
        goto LAB_00572378;
      sVar1 = *psVar5;
    }
    *psVar5 = (short)uVar9;
...

{
  ...
  if (pAudioCueCache._72_4_ == -0x5eef3582) {
    ...
    if ((pAudioCueCache._48_4_ == 1) && (pAudioCueCache._42_2_ != 0)) {
      ...
      while (sVar1 != -1) {
        psVar11 = psVar11 + 1;
        if (sVar4 == pAudioCueCache._42_2_)
          goto LAB_0057a742;
        sVar4 = sVar4 + 1;
        sVar1 = *psVar11;
      }
    ...
    if (pvVar5 != (void *)0x0) {
      puVar13 =
          (uint64_t *)((long)pvVar5 + 0x10U + (uVar12 - ((long)pvVar5 + 0x10U) % uVar12) % uVar12);
      puVar13[-2] = 0x2d0;
      puVar13[-1] = pvVar5;
    }
...
LAB_0057a742:
  ...
  uVar12 = 0x90;
  puVar13 =
      (uint64_t *)(((ulong)(ushort)pAudioCueCache._40_2_ * 9 + -9) * 0x10 + pAudioCueCache._56_8_);
  bVar14 = ((ulong)puVar13 & 1) != 0;
  if (bVar14) {
    *(uint8_t *)puVar13 = 0;
    uVar12 = 0x8f;
...

{
  ...
  if ((fVar3 <= fVar4) && (fVar4 = (float)(DAT_005be6f0 /* R:u32=2147483648 */ ^ *puVar2),
                           (float)(DAT_005be6f0 /* R:u32=2147483648 */ ^ *puVar2) <= fVar3)) {
    fVar4 = fVar3;
  }
...

{
  ...
  fVar9 = *(float *)(arg2 + 4);
  fVar19 = fVar9;
  if ((fVar18 <= fVar9) && (fVar19 = (float)((uint)fVar9 ^ DAT_005be6f0 /* R:u32=2147483648 */),
                            (float)((uint)fVar9 ^ DAT_005be6f0 /* R:u32=2147483648 */) <= fVar18)) {
    fVar19 = fVar18;
  }
  ...
  fVar21 = fVar12;
  if ((fVar20 <= fVar12) &&
      (fVar21 = (float)((uint)fVar12 ^ DAT_005be6f0 /* R:u32=2147483648 */),
       (float)((uint)fVar12 ^ DAT_005be6f0 /* R:u32=2147483648 */) <= fVar20)) {
    fVar21 = fVar20;
  }
  ...
  fVar15 = fVar1;
  if ((fVar16 <= fVar1) && (fVar15 = (float)((uint)fVar1 ^ DAT_005be6f0 /* R:u32=2147483648 */),
                            (float)((uint)fVar1 ^ DAT_005be6f0 /* R:u32=2147483648 */) <= fVar16)) {
    fVar15 = fVar16;
  }
...

{
  ...
  fVar18 = (fVar8 * fVar3 + fVar1) * fVar3 + (fVar1 * fVar8 + fVar5) * fVar1 +
           fVar6 * fVar8 * fVar6 + (fVar5 * fVar8 + fVar6) * fVar5;
  fVar13 = 0.0;
  ...
  if (fVar12 < 0.0) {
    ...
    local_64 =
        (local_30 * fVar11 + local_2c * fVar10 + local_24 * fVar9 + local_28 * fVar7) - local_4c;
  ...
  if (fVar14 < 0.0) {
    ...
    local_60 =
        (local_20 * fVar11 + local_1c * fVar10 + local_14 * fVar9 + local_18 * fVar7) - local_5c;
  ...
  if (fVar15 < 0.0) {
    ...
    fVar13 = (((fVar1 - fVar8 * fVar3) * local_4 + (fVar5 - fVar1 * fVar8) * local_8) -
              fVar6 * fVar8 * local_10) +
             (fVar6 - fVar5 * fVar8) * local_c;
...

{
  ...
  puVar1 = (uint32_t *)(pSelectableResolutions._56_8_ +
  ...
  if (*(int *)((long)arg1 + 0x2c) == 1) {
    do {
      ...
      uVar1 = File__Read(*(File **)((long)arg1 + 0x150),
                         *(void **)((long)arg1 + ((long)*(int *)((long)arg1 + 0x3c) + 4) * 0x10),
                         uVar1);
      if (0x19000 < uVar1) {
        uVar1 = 0x19000;
      }
...

{
  ...
  fVar5 = *(float *)(arg2 + 4) * *(float *)(arg2 + 4) + *(float *)(arg2 + 8) * *(float *)(arg2 + 8);
  *(float *)arg1 = DAT_005be894 /* R:1.0f */ - (fVar5 + fVar5);
  fVar5 = *(float *)(arg2 + 8) * *(float *)(arg2 + 0xc) + *(float *)(arg2 + 4) * *(float *)arg2;
  ...
  *(float *)(arg1 + 0x20) = fVar5 + fVar5;
  fVar5 = *(float *)(arg2 + 4) * *(float *)arg2 - *(float *)(arg2 + 8) * *(float *)(arg2 + 0xc);
  ...
  *(float *)(arg1 + 0x24) = fVar5 + fVar5;
  fVar5 = *(float *)(arg2 + 4) * *(float *)(arg2 + 0xc) + *(float *)(arg2 + 8) * *(float *)arg2;
  *(float *)(arg1 + 8) = fVar5 + fVar5;
  fVar5 = *(float *)(arg2 + 8) * *(float *)(arg2 + 4) - *(float *)arg2 * *(float *)(arg2 + 0xc);
...
Matrix4x4 *Matrix4x4__ConvertToPerspectiveMatrix(Matrix4x4 *arg1, float arg2, float arg3,
...
void Matrix4x4__ConvertToOrthoMatrix(Matrix4x4 *arg1, float arg2, float arg3, float arg4,
...
void Matrix4x4__ConvertToLookAtMatrix(Matrix4x4 *arg1, FPUVector *arg2, FPUVector *arg3,
                                      FPUVector *arg4)

{
  ...
  *(float *)(arg1 + 0x18) = fVar9;
  uVar1 = DAT_005be6f0 /* R:u32=2147483648 */;
  *(uint *)(arg1 + 0xc) =
      (uint)(fVar7 * *(float *)(arg2 + 4) + fVar6 * *(float *)arg2 + fVar5 * *(float *)(arg2 + 8)) ^
      DAT_005be6f0 /* R:u32=2147483648 */;
  *(uint *)(arg1 + 0x1c) = (uint)(*(float *)(arg2 + 4) * fVar11 + fVar10 * *(float *)arg2 +
                                  fVar9 * *(float *)(arg2 + 8)) ^
                           uVar1;
  fVar5 = *(float *)(arg2 + 4);
  fVar6 = *(float *)arg2;
...

{
  ...
  if (uVar11 != 0) {
    uVar3 = (uint)(sVar6 >> 4);
    uVar8 = uVar3 * 0x10;
    if ((uVar8 == 0) || (uVar11 < 0x10 || pcVar7 <= arg1 + uVar13 && arg1 <= pcVar7 + uVar13 * 4)) {
      uVar8 = 0;
    } else {
      lVar9 = 0;
      uVar12 = 0;
...

{
  ...
  if (uVar23 != 0) {
    uVar29 = uVar23 >> 4;
    uVar25 = uVar29 << 4;
    if ((uVar29 == 0) || (uVar23 < 0x10 || pwVar24 <= arg1 + uVar30 &&
                                               arg1 <= (wchar_t *)((long)pwVar24 + uVar30))) {
      uVar25 = 0;
    } else {
      lVar26 = 0;
      uVar28 = 0;
